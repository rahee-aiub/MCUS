...
/****** Object:  StoredProcedure [dbo].[SpM_STSupplierStatement]    Script Date: 6/23/2018 10:19:35 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SpM_STSupplierStatement](@CommonNo1 INT, @fDate VARCHAR(10), @tDate VARCHAR(10), @nFlag INT)
AS
