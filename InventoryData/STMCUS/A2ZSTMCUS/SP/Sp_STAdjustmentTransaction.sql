...
/****** Object:  StoredProcedure [dbo].[Sp_STAdjustmentTransaction]    Script Date: 6/23/2018 10:06:56 AM ******/
SET ANSI_NULLS ON
GO
	...
	BEGIN TRANSACTION
		...
		IF @TrnType = 1
			BEGIN	
				...
				0,0,'Internal Adj',@ItemTotalPrice,@ItemTotalPrice,0,@UserId)
			END		
		...
		IF @TrnType = 2
			BEGIN
				...
				@IssWarehouseNo,@IssWarehouseNo,@BoothName,@BoothName,@BoothName,@ItemUnitPrice,
				0,0,'Internal Adj',@ItemTotalPrice,0,@ItemTotalPrice,@UserId)
