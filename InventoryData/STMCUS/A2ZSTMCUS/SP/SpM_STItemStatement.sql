...
/****** Object:  StoredProcedure [dbo].[SpM_STItemStatement]    Script Date: 6/23/2018 10:19:26 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SpM_STItemStatement](@CommonNo1 INT,@CommonNo2 INT, @fDate VARCHAR(10), @tDate VARCHAR(10), @nFlag INT)
AS
