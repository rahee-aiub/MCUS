...
/****** Object:  StoredProcedure [dbo].[Sp_STSupplierPayment]    Script Date: 06/07/2018 2:28:06 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE  [dbo].[Sp_STSupplierPayment](@VchNo nvarchar(20), @SupplierNo INT, @SupplierName nvarchar(50), 
					  @TrnNote nvarchar(MAX) ,@FuncOpt INT, @FuncOptDesc nvarchar(50),@TrnBankCode int,
					  @TrnBankChqNo nvarchar(50), @TrnDate smalldatetime, @TrnType INT,@TrntypeDesc nvarchar(20), 
					  @UserId INT, @Amount Money, @TrnProcFlag INT,@TrnWarehouseNo INT)
...
BEGIN TRY
	...
	IF @FuncOpt = 61
		BEGIN
			...
			TrnBankCode,TrnBankChqNo,UserId) 

			VALUES(@TrnDate,@VchNo,@FuncOpt,@FuncOptDesc,0,0,@Amount,@Amount,@SupplierNo,@SupplierName,
			@TrnType,@TrntypeDesc,@TrnNote,@TrnProcFlag,@TrnBankCode,@TrnBankChqNo,@UserId);
	...
	IF @FuncOpt = 62
		BEGIN
			...
			VALUES(@TrnDate,@VchNo,@FuncOpt,@FuncOptDesc,@Amount,0,0,@Amount,@SupplierNo,@SupplierName,
			@TrnType,@TrntypeDesc,@TrnNote,@TrnProcFlag,@TrnBankCode,@TrnBankChqNo,@UserId);
	...
	IF @FuncOpt = 63
		BEGIN
			...
			VALUES(@TrnDate,@VchNo,@FuncOpt,@FuncOptDesc,0,@Amount,0,@Amount,@SupplierNo,@SupplierName,
			@TrnType,@TrntypeDesc,@TrnNote,@TrnProcFlag,@TrnBankCode,@TrnBankChqNo,@UserId);
