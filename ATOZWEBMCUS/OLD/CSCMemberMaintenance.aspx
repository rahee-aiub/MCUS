<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="CSCMemberMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSCMemberMaintenance"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
	    function ValidationBeforeSave()
	    {
	        ...
	        if (txtCULBMemNo == '' || txtCULBMemNo.length == 0)
    ...
    <div align="left">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtDateOfBirth" runat="server" CssClass="cls text" Width="140px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Height="25px" Font-Size="Large" AutoPostBack="True" OnTextChanged="txtDateOfBirth_TextChanged"></asp:TextBox><img
        ...
        <div style="background-color: Silver; border: 1px">
            <asp:Panel ID="pnlPreAddress" runat="server" Height="236px" Width="1215px">
                ...
                <td>
                    <asp:DropDownList ID="ddlDivision" runat="server" Height="25px" Width="250px" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge"
                    ...
                    <asp:DropDownList ID="ddlDistrict" runat="server" Height="25px" Width="250px" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge"
                    ...
                    <asp:DropDownList ID="ddlThana" runat="server" Height="25px" Width="250px" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge"
        ...
        <div style="background-color: InactiveCaption; border: 1px">
            <asp:Panel ID="pnlPermanent" runat="server" Height="236px" Width="1215px">
                ...
                <td>
                    <asp:DropDownList ID="ddlPerDivision" runat="server" Height="25px" Width="250px" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge"
                    ...
                    <asp:DropDownList ID="ddlPerDistrict" runat="server" Height="25px" Width="250px" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge"
                    ...
                    <asp:DropDownList ID="ddlPerThana" runat="server" Height="25px" Width="250px" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge"
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="BtnSubmit" runat="server" Text="Submit" Font-Size="Large" ForeColor="White"
                        Font-Bold="True" CssClass="button green" OnClientClick="return ValidationBeforeSave()"
