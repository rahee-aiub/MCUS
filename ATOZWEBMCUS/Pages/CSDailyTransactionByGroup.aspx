<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSDailyTransactionByGroup.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSDailyTransactionByGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div align="left" class="grid_scroll">
            <asp:Label ID="lblTotalAmt" runat="server" Font-Size="Medium" Text="Total Amount. :" ForeColor="Red"></asp:Label>
                                <asp:TextBox ID="txtTotalAmt" runat="server" CssClass="cls text" Width="182px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" Font-Size="Medium" onkeydown="return (event.keyCode !=13);" ></asp:TextBox>
    ...
    <asp:GridView ID="gvDetailInfo" runat="server" HeaderStyle-CssClass="FixedHeader" HeaderStyle-BackColor="YellowGreen"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Old A/c" HeaderStyle-Width="100px" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="Center">
                             ...
                             <asp:TemplateField HeaderText="Deposit" HeaderStyle-Width="100px" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                   <asp:TextBox ID="txtDeposit" runat="server" CssClass="cls text" Width="100px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" Font-Size="Medium" onkeydown="return (event.keyCode !=13);" ></asp:TextBox>                      
                                </ItemTemplate>
                            </asp:TemplateField>                      
                            <asp:TemplateField HeaderText="Int.Rate" HeaderStyle-Width="100px" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>

                                    <asp:TextBox ID="txtIntRate" runat="server" CssClass="cls text" Width="100px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" Font-Size="Medium" onkeydown="return (event.keyCode !=13);" ></asp:TextBox> 

                                </ItemTemplate>
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Penalty" HeaderStyle-Width="100px" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                <asp:TextBox ID="txtPenalAmt" runat="server" CssClass="cls text" Width="100px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" Font-Size="Medium" onkeydown="return (event.keyCode !=13);" ></asp:TextBox> 
                                </ItemTemplate>
                            </asp:TemplateField>
