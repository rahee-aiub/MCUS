...
{
    public partial class CSCreditUnionTypeReport : System.Web.UI.Page
    {
        ...
        protected void BtnProcess_Click(object sender, EventArgs e)
        {
            try
            {
                if(ddlCuType.SelectedIndex==0)
                {
                    ...
                    //{
                    //    String cstext1 = "alert('Please Choose Credit Union Type');";
                    //    cs.RegisterStartupScript(cstype, csname1, cstext1, true);
                    //}
                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Please Choose Credit Union Type');", true);
                    return;
                }


                if (chkAllCashCode.Checked == false && ddlCashCode.SelectedValue == "-Select-")
                {
                    //String csname1 = "PopupScript";
                    //Type cstype = GetType();
                    //ClientScriptManager cs = Page.ClientScript;
                    ...
                    //    cs.RegisterStartupScript(cstype, csname1, cstext1, true);
                    //}
                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Please Mark  All Cash Code Check Box / Select CashCode');", true);
                    return;
                }
                ...
                Int16 CuType = Converter.GetSmallInteger(ddlCuType.SelectedValue);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NO10, CuType);
                ...
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.REPORT_FILE_NAME_KEY, "rptCuTypeReport");
