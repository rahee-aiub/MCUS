<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSEditLoanApplication.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSEditLoanApplication" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
            ...
            <table class="style1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtLoanAppDate" runat="server" CssClass="cls text" Width="115px" Height="25px"
                            Font-Size="Large" ToolTip="Enter Date" img src="../Images/calender.png" OnTextChanged="txtLoanAppDate_TextChanged"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtLoanAppAmount" runat="server" CssClass="cls text" Width="199px"
                            Height="25px" Font-Size="Large" AutoPostBack="True" OnTextChanged="txtLoanAppAmount_TextChanged"
                            ></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtODPeriod" runat="server" Enabled="false" CssClass="cls text"
                            Width="100px" Height="25px"
        ...
        <asp:Panel ID="pnlDeposit" runat="server" Width="976px" Height="395px">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtDepositMemNo" runat="server" Width="96px" Height="25px" Font-Size="Large"
                            CssClass="cls text" AutoPostBack="true" TabIndex="4" OnTextChanged="DepositMemNo_TextChanged"></asp:TextBox>
                    </td>
                    <td>
                        <h3>
                        ...
                        <asp:TextBox ID="txtAccType" runat="server" Width="60px" Height="25px" Font-Size="Large"
                            CssClass="cls text" TabIndex="2" AutoPostBack="true" OnTextChanged="txtAccType_TextChanged"></asp:TextBox>
                    </td>
                    <td>
                        <h3>
                        ...
                        <asp:TextBox ID="txtAccNo" runat="server" Width="170px" Height="25px" Font-Size="Large"
                            CssClass="cls text" TabIndex="3" OnTextChanged="txtAccNo_TextChanged" AutoPostBack="true"></asp:TextBox>
                    </td>
                    <td>
                        <h3>
                        ...
                        <asp:TextBox ID="txtLionAmt" runat="server" Width="140px" Height="25px" Font-Size="Large"
                            CssClass="cls text" TabIndex="4" AutoPostBack="True" OnTextChanged="txtLionAmt_TextChanged"></asp:TextBox>
                    </td>
                    <td>
                        <h3>
                        ...
                        <asp:TextBox ID="txtTotalLienAmt" runat="server" Width="140px" Height="25px" Font-Size="Large"
                            CssClass="cls text" TabIndex="5" AutoPostBack="True"></asp:TextBox>
                    </td>
                    <td>
            ...
            <div align="center" class="grid_scroll">
                <asp:GridView ID="gvDetailInfo" runat="server" HeaderStyle-CssClass="FixedHeader2" HeaderStyle-BackColor="YellowGreen"
                    AutoGenerateColumns="False" AlternatingRowStyle-BackColor="WhiteSmoke" RowStyle-Height="10px" OnRowDataBound="gvDetailInfo_RowDataBound" EnableModelValidation="True" OnRowDeleting="gvDetailInfo_RowDeleting">
            ...
            <asp:Label ID="lblDepositRowType" runat="server" Visible="false" Text="1"></asp:Label>
            <asp:Label ID="lblDepositRowMode" runat="server" Visible="false" Text="VAL"></asp:Label>
            <asp:Label ID="lblDepositCuNo" runat="server" Visible="false"></asp:Label>
            <asp:Label ID="lblDepositDelValue" runat="server" Visible="true"></asp:Label>
        </asp:Panel>
    </div>
    <div style="background-color: ActiveCaption; border: 1px" align="center">
        <asp:Panel ID="pnlShare" runat="server" Height="395px">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtShareCuNo" runat="server" Width="96px" Height="25px" Font-Size="Large"
                            CssClass="cls text" TabIndex="3" AutoPostBack="true" OnTextChanged="txtShareCuNo_TextChanged"></asp:TextBox>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtShareCuName" runat="server" Width="504px" Height="25px" Font-Size="Large" Enabled="false"
                            CssClass="cls text" TabIndex="4" BorderStyle="None"></asp:TextBox>
                    </td>
                    <td>
                        <h3>
                        ...
                        <asp:TextBox ID="txtShareAccType" runat="server" Width="140px" Height="25px" Font-Size="Large"
                            CssClass="cls text" TabIndex="5"  Visible="false"></asp:TextBox>
                    </td>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtShareAmount" runat="server" Width="140px" Height="25px" Font-Size="Large"
                            CssClass="cls text" TabIndex="8" AutoPostBack="True"></asp:TextBox>
                    </td>
            ...
            <asp:Label ID="lblShareCType" runat="server" Visible="false"></asp:Label>
             <asp:Label ID="lblShareRowType" runat="server" Visible="false" Text="1"></asp:Label>
             <asp:Label ID="lblShareRowMode" runat="server" Visible="false" Text="0"></asp:Label>
            <asp:Label ID="lblShareCNo" runat="server" Visible="false"></asp:Label>
             <asp:Label ID="lblShareDelValue" runat="server" Visible="false"></asp:Label>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtProprertyAmt" runat="server" Width="140px" Height="25px" Font-Size="Large"
                            CssClass="cls text" TabIndex="5" AutoPostBack="True" OnTextChanged="txtProprertyAmt_TextChanged"></asp:TextBox>
                    </td>
    ...
    <asp:Label ID="lblInput" runat="server" Text="" Visible="false"></asp:Label>
    <asp:Label ID="lblInputDate" runat="server" Text="" Visible="false"></asp:Label>
   
    <asp:Label ID="lblApprove" runat="server" Text="" Visible="false"></asp:Label>
    <asp:Label ID="lblApproveDate" runat="server" Text="" Visible="false"></asp:Label>
     ...
     <asp:Label ID="lblSharAccNo" runat="server" Text="" Visible="false"></asp:Label>

    <asp:Label ID="hdnCashCode" runat="server" Text="" Visible="false"></asp:Label>
    <asp:Label ID="FromCashCode" runat="server" Text="" Visible="false"></asp:Label>
