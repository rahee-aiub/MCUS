...
{
    public partial class HREmpLeaveApplication : System.Web.UI.Page
    {
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (lblProcDate.Text != string.Empty)
            {
                DateTime Inpdate = DateTime.ParseExact(lblProcDate.Text, "dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture);
                dto.InputByDate = Inpdate;
            }
            else
            {
                string CheckInpDtNull = "";
                dto.NullInputByDate = CheckInpDtNull;
            }

            dto.InputBy = Converter.GetInteger(lblID.Text);
