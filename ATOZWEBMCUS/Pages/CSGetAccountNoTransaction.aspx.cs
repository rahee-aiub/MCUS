...
{
    public partial class CSGetAccountNoTransaction : System.Web.UI.Page
    {
        ...
        //    DateTime date = Converter.GetDateTime(lblTranDate.Text);

        //    string sqlquery3 = @"SELECT AccNo,CalPrincAmt,CalIntAmt,UptoDuePrincAmt,UptoDueIntAmt,PayablePrincAmt,PayableIntAmt,PayablePenalAmt,PaidPrincAmt,PaidIntAmt,PaidPenalAmt,CurrDuePrincAmt,CurrDueIntAmt,NoDueInstalment FROM A2ZLOANDEFAULTER WHERE MONTH(TrnDate) = '" + Month + "' AND YEAR(TrnDate) = '" + Year + "'";
        //    gvTransInfo = DataAccessLayer.BLL.CommonManager.Instance.FillGridViewList(sqlquery3, gvTransInfo, "A2ZCSMCUS");
        //}
        ...
        //protected void gvTransInfo_SelectedIndexChanged(object sender, EventArgs e)
        //{
        //}
