<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSPMemberMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSPMemberMaintenance" Title="Untitled Page" %>
    ...
    <div align="left">
        <table class="style1">
         <thead>
            ...
            <tr>
                <td class="style7">
                    <asp:Label ID="lblPMemNo" runat="server" Text="Member No:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtPMemNo" runat="server" CssClass="cls text" Width="118px" Height="25px"
                        Font-Size="Large" onkeypress="return functionx(event)"
                        AutoPostBack="True" ontextchanged="txtPMemNo_TextChanged"></asp:TextBox>
                    <asp:DropDownList ID="ddlPMemNo" runat="server" Height="25px" Width="250px" AutoPostBack="True"
                        Font-Size="Large" onselectedindexchanged="ddlPMemNo_SelectedIndexChanged">
                    ...
                    <asp:Label ID="lblMemType" runat="server" Text="Member Type" Font-Size="Large" 
                        ...
                        Font-Size="Large">
                        <asp:ListItem Value="0">-Select-</asp:ListItem>
                        <asp:ListItem Value="1">Share Holder</asp:ListItem>
                        <asp:ListItem Value="2">Non-Share Holder</asp:ListItem>
                    </asp:DropDownList>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>
            <tr>
                <td class="style7">
                    <asp:Label ID="lblPMemName" runat="server" Text="Member Name:" Font-Size="Large"
                        ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtPMemName" runat="server" CssClass="cls text" Width="366px"
                    ...
                    <asp:Label ID="lblSpouseName" runat="server" Text="Spouse Name:" Font-Size="Large"
                        ForeColor="Red"></asp:Label>
                    <asp:TextBox ID="txtSpouseName" runat="server" CssClass="cls text" Width="320px"
                        Height="25px" Font-Size="Large" ToolTip="Enter Name"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtFatherName" runat="server" CssClass="cls text" Width="366px"
                        Height="25px" Font-Size="Large" ToolTip="Enter Name"></asp:TextBox>
                    &nbsp;
                    <asp:Label ID="lblMotherName" runat="server" Text="Mother Name:" Font-Size="Large"
                        ForeColor="Red"></asp:Label>
                    <asp:TextBox ID="txtMotherName" runat="server" CssClass="cls text" Width="320px"
                        Height="25px" Font-Size="Large" ToolTip="Enter Name"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <asp:DropDownList ID="ddlNature" runat="server" Height="25px" Width="150px" CssClass="cls text"
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlGender" runat="server" Height="25px" Width="250px" CssClass="cls text"
                        Font-Size="Large">
                        <asp:ListItem Value="0">-Select-</asp:ListItem>
                    ...
                    <asp:Label ID="lblMaritalStatus" runat="server" Text="Marital Status:" Font-Size="Large"
                        ForeColor="Red"></asp:Label>
                    &nbsp;<asp:DropDownList ID="ddlMaritalStatus" runat="server" Height="25px" Width="150px"
                        CssClass="cls text" Font-Size="Large">
                        <asp:ListItem Value="0">-Select-</asp:ListItem>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtOpenDate" runat="server" CssClass="cls text" Width="140px" Height="25px"
                        Font-Size="Large" ></asp:TextBox><img src="../Images/calender.png" />
                    &nbsp;&nbsp;
                    <asp:Label ID="lblDateOfBirth" runat="server" Text="Date of Birth:" Font-Size="Large"
                        ForeColor="Red"></asp:Label>
                    &nbsp;
                    <asp:TextBox ID="txtDateOfBirth" runat="server" CssClass="cls text" Width="140px"
                        Height="25px" Font-Size="Large" ></asp:TextBox><img src="../Images/calender.png" />
                    &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="lblAge" runat="server" Text="Age:" Font-Size="Large" ForeColor="Red"></asp:Label>
                    <asp:TextBox ID="txtAge" runat="server" CssClass="cls text" Width="115px" Height="25px"
                        Font-Size="Large"></asp:TextBox>&nbsp; &nbsp;
                    <asp:Label ID="lblPlaceOfBirth" runat="server" Text="Place Of Birth:" Font-Size="Large"
                        ForeColor="Red"></asp:Label>
                    <asp:TextBox ID="txtPlaceOfBirth" runat="server" CssClass="cls text" Width="135px"
        ...
        <div style="background-color: Silver; border: 1px">
            <asp:Panel ID="pnlPreAddress" runat="server" Height="222px" Width="500px">
                <table>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtAddressL1" runat="server" CssClass="cls text" Width="360px" Height="25px"
                                Font-Size="Large"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtAddressL2" runat="server" CssClass="cls text" Width="360px" Height="25px"
                                Font-Size="Large"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtAddressL3" runat="server" CssClass="cls text" Width="359px" Height="25px"
                                Font-Size="Large"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtTelNo" runat="server" CssClass="cls text" Width="200px" Height="25px"
                                Font-Size="Large"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtMobileNo" runat="server" CssClass="cls text" Width="200px" Height="25px"
                                Font-Size="Large"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtEmail" runat="server" CssClass="cls text" Width="200px" Height="25px"
                                Font-Size="Large"></asp:TextBox>
                        </td>
                    </tr>
                </table>
        ...
        <div style="background-color: InactiveCaption; border: 1px">
            <asp:Panel ID="pnlPermanent" runat="server" Height="222px" Width="500px">
                <table>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtPerAddL1" runat="server" CssClass="cls text" Width="360px" Height="25px"
                                Font-Size="Large"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtPerAddL2" runat="server" CssClass="cls text" Width="360px" Height="25px"
                                Font-Size="Large"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtPerAddL3" runat="server" CssClass="cls text" Width="359px" Height="25px"
                                Font-Size="Large"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtPerTelNo" runat="server" CssClass="cls text" Width="200px" Height="25px"
                                Font-Size="Large"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtPerMobNo" runat="server" CssClass="cls text" Width="200px" Height="25px"
                                Font-Size="Large"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtPerEmail" runat="server" CssClass="cls text" Width="200px" Height="25px"
                                Font-Size="Large"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNationalID" runat="server" CssClass="cls text" Width="268px"
                                            Height="25px" Font-Size="Large"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPassportNo" runat="server" CssClass="cls text" Width="268px"
                                            Height="25px" Font-Size="Large"></asp:TextBox>&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPassportIssuePlace" runat="server" CssClass="cls text" Width="185px"
                                            Height="25px" Font-Size="Large"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTIN" runat="server" CssClass="cls text" Width="185px" Height="25px"
                                            Font-Size="Large"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPassportIssueDate" runat="server" CssClass="cls text" Width="185px"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPassportExpdate" runat="server" CssClass="cls text" Width="185px"
                                            Height="25px" Font-Size="Large" img src="../Images/calender.png"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtLastTaxPdate" runat="server" CssClass="cls text" Width="185px"
                                            Height="25px" Font-Size="Large" img src="../Images/calender.png"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtEmpName" runat="server" CssClass="cls text" Width="226px" Height="25px"
                                            Font-Size="Large"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtEmpAddress" runat="server" CssClass="cls text" Width="226px"
                                            Height="25px" Font-Size="Large"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtIntroducerMem1" runat="server" CssClass="cls text" Width="225px"
                                            Height="25px" Font-Size="Large"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtIntroducerName1" runat="server" CssClass="cls text" Width="226px"
                                            Height="25px" Font-Size="Large"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtIntroduceMem2" runat="server" CssClass="cls text" Width="226px"
                                            Height="25px" Font-Size="Large"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtIntroducerName2" runat="server" CssClass="cls text" Width="226px"
                                            Height="25px" Font-Size="Large"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
