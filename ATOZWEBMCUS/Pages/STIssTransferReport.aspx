<%@ Page Language="C#" MasterPageFile="~/MasterPages/INVMasterPage.Master" AutoEventWireup="true" CodeBehind="STIssTransferReport.aspx.cs" Inherits="ATOZWEBMCUS.Pages.STIssTransferReport" Title="Issue Transfer Report" %>
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">
                        <asp:Label ID="lblRcvPurchaseReport" runat="server" Text="Issue Transfer Report"></asp:Label>
                    </th>
                </tr>
