<%@ Page Language="C#" MasterPageFile="~/MasterPages/INVMasterPage.Master" AutoEventWireup="true" CodeBehind="STRcvTransferReport.aspx.cs" Inherits="ATOZWEBMCUS.Pages.STRcvTransferReport" Title="Rcv Transfer Report" %>
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">
                        <asp:Label ID="lblRcvPurchaseReport" runat="server" Text="Rcv Transfer Report"></asp:Label>
                    </th>
                </tr>
