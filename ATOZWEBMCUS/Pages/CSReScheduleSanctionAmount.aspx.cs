...
{
    public partial class CSReScheduleSanctionAmount : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ddlIAccType.Enabled = false;

                ddlIAccType.SelectedValue = "53";
                ...
                if (lblCtrlFlag.Text == "1" && viewflag != "1")
                {
                    ...
                    ItxtIncreaseSanctionAmount.Text = NSAmt;
            ...
            try
            {
                ...
                if (ItxtMemNo.Text != string.Empty && ItxtCreditUNo.Text != string.Empty)
                {
                    ...
                    if (getDTO.NoRecord > 0)
                    {
                        ...
                        ddlIAccType_SelectedIndexChanged(this, EventArgs.Empty);
        ...
        private void FindAccountNo()
        {
            ...
            string qry = "SELECT AccNo FROM A2ZACCOUNT where CuType='" + lblCuType.Text + "' and CuNo='" + lblCuNo.Text + "' and MemNo='" + ItxtMemNo.Text + "' and AccType='" + ddlIAccType.SelectedValue + "' AND AccStatus < 98 AND AccOpenDate > '" + "2017-06-30" + "'";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    string sqlquery = "SELECT Id,AccNo from A2ZACCOUNT WHERE CuType='" + lblCuType.Text + "' and CuNo='" + lblCuNo.Text + "' and MemNo='" + ItxtMemNo.Text + "' and AccType='" + ddlIAccType.SelectedValue + "' AND AccStatus < 98 ORDER BY AccNo";
        ...
        private void InvalidNoInstlMSG()
        {

            ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Invalid New No. Installment');", true);
            return;
        }
        ...
        protected void ClearInfo()
        {
            ...
            lblExDisbAmt.Text = string.Empty;
            lblExLoanBal.Text = string.Empty;
        ...
        protected void ItxtIncreaseSanctionAmount_TextChanged(object sender, EventArgs e)
        {
            ...
            lblNewLoanAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", Xamt));
        ...
        {
            Int16 RoundFlag = 0;
            double a = Converter.GetDouble(lblNewLoanAmt.Text);
        ...
        protected void BtnNewSanction_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ItxtNewNoInstal.Text == string.Empty || ItxtNewNoInstal.Text == "0")
                {
                    ItxtNewNoInstal.Text = string.Empty;
                    ItxtNewNoInstal.Focus();
                    InvalidNoInstlMSG();
                    return;
                }
                ...
                if (ItxtNewNoInstal.Text == string.Empty || ItxtNewNoInstal.Text == "0")
                {
                    ItxtNewNoInstal.Text = string.Empty;
                    ItxtNewNoInstal.Focus();
                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Invalid New No. of Installment');", true);
                    return;
                }
                ...
                if (result > 0)
                {
                    string strQuery = "UPDATE A2ZACCOUNT SET  AccLoanSancAmt = '" + lblNewSanctionAmt.Text + "', AccNoInstl= '" + ItxtNewNoInstal.Text + "', AccLoanInstlAmt= '" + ItxtNewInstalAmt.Text + "',AccLoanLastInstlAmt= '" + ItxtNewLastInstalAmt.Text + "' WHERE  CuType='" + lblCuType.Text + "' AND CuNo='" + lblCuNo.Text + "' AND MemNo='" + ItxtMemNo.Text + "' AND  AccType='" + ddlIAccType.SelectedValue + "' AND AccNo='" + ItxtAccNo.Text + "'";
 ...
 "click", @"<script>window.open('CSGetDepositorNo.aspx','_blank');</script>", false);
        ...
        protected void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            Session["SItxtNewSanctionAmount"] = ItxtIncreaseSanctionAmount.Text;
