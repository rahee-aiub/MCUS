...
{
    public partial class CSAccountBalanceTransfer : System.Web.UI.Page
    {
        ...
        protected void BtnTransfer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                prm[3] = opdate;
                prm[4] = txtVchNo.Text;
                prm[5] = lblCuType.Text;
                prm[6] = lblCuNo.Text;
                prm[7] = txtMemNo.Text;
                prm[8] = CtrlAccType.Text;
                prm[9] = txtAccNo.Text;
                prm[10] = lblTrnferCuType.Text;
                prm[11] = lblTrnferCuNo.Text;
                prm[12] = txtTrnMemNo.Text;
                prm[13] = CtrlTrnAccType.Text;
                prm[14] = txtTrnAccNo.Text;
                prm[15] = Converter.GetDouble(txtTrnAmount.Text);
                prm[16] = txtDescription.Text;
                prm[17] = hdnCashCode.Text;
                prm[18] = lblPayType.Text;
                prm[19] = lblTrnPayType.Text;

                if (lblTrnAtyClass.Text == "5" || lblTrnAtyClass.Text == "6")
                {
                    prm[20] = lblTrnAtyClass.Text;
                ...
                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("Sp_CSAddBalanceTransfer", prm, "A2ZCSMCUS"));
        ...
        protected void ClearScreen()
        {
            ...
            lblTrnCuName.Text = string.Empty;
            txtTrnMemNo.Text = string.Empty;
            lblTrnMemName.Text = string.Empty;
