<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="SYSDesignationCodeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.SYSDesignationCodeMaintenance" Title="DesignationCodeMaintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            ...
            <tr>
                <td>
                    <asp:Label ID="lblcode" runat="server" Text="Designation Code:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    ...
                    <asp:DropDownList ID="ddlDesignation" runat="server" Height="25px" 
 ...
 AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" Height="150px" OnRowDataBound="gvDetailInfo_RowDataBound">
            <RowStyle BackColor="#FFF7E7" ForeColor="#8C4510" />
            <Columns>
                 <asp:BoundField HeaderText="Code" DataField="DesigCode" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField HeaderText="Description" DataField="DesigDescription" HeaderStyle-Width="380px" ItemStyle-Width="380px" />    
              </Columns>
