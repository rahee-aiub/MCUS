<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="SYSUpzilaCodeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.SYSUpzilaCodeMaintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Upzila Code Maintenance
                    </th>
                </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:DropDownList ID="ddlUpzila" runat="server" Height="25px"
                        Width="316px" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large" OnSelectedIndexChanged="ddlUpzila_SelectedIndexChanged">
                        <%--<asp:ListItem Value="0">-Select-</asp:ListItem>--%>
                    </asp:DropDownList>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblUpzilaDescription" runat="server" Text="Description:" Font-Size="Large"
                        ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtUpzilaDescription" runat="server" CssClass="cls text" Width="421px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
 ...
 AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" RowStyle-Height="10px" OnRowDataBound="gvDetailInfo_RowDataBound">
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Upzila Code" DataField="UpzilaCode" HeaderStyle-Width="90px" ItemStyle-Width="90px" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField HeaderText="Description" DataField="UpzilaDescription" HeaderStyle-Width="250px" ItemStyle-Width="250px" />
