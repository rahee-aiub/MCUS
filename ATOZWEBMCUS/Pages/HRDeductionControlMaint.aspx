<%@ Page Language="C#" MasterPageFile="~/MasterPages/HRMasterPage.Master" AutoEventWireup="true"
    CodeBehind="HRDeductionControlMaint.aspx.cs" Inherits="ATOZWEBMCUS.Pages.HRDeductionControlMaint"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <thead>
                <tr>
                    <th colspan="3" style="color: Black" align="center">
                        <p align="center">
                            Deduction Control Maintenance
                        </p>
                    </th>
                </tr>
            </thead>
            <tr>
                <th class="auto-style1">Deduction Code
                </th>
                <td>:
                </td>
                <td>
                    <asp:DropDownList ID="ddlDeduction" runat="server" Font-Size="Medium" BorderColor="#1293D1" BorderStyle="Ridge" Height="25px" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddlDeduction_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
    ...
    <div align="center" class="grid_scroll">
        <asp:GridView ID="gvDetailInfo" runat="server" HeaderStyle-CssClass="FixedHeader" HeaderStyle-BackColor="YellowGreen"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Ded.Code" Visible="false" HeaderStyle-Width="100px" ItemStyle-Width="100px">
                    <ItemTemplate>
                        <asp:Label ID="lblDedCode" runat="server" Text='<%# Eval("DedCode") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderText="BaseGrade" Visible="false" HeaderStyle-Width="100px" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Left">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Grade" Visible="false" HeaderStyle-Width="100px" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Left">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Desig." Visible="false" HeaderStyle-Width="100px" ItemStyle-Width="100px">
                    <ItemTemplate>
                        <asp:Label ID="lblDesig" runat="server" Text='<%# Eval("DesignationCode") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderText="Desig." Visible="true" HeaderStyle-Width="100px" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Left">
                    <ItemTemplate>
                        <asp:Label ID="lblDesigDesc" runat="server" Text='<%# Eval("DesigDesc") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderText="Location" Visible="false" HeaderStyle-Width="100px" ItemStyle-Width="100px">
                    <ItemTemplate>
                        <asp:Label ID="lblLocation" runat="server" Text='<%# Eval("LocationCode") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderText="Location" Visible="true" HeaderStyle-Width="100px" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Left">
                    <ItemTemplate>
                        <asp:Label ID="lblLocationDesc" runat="server" Text='<%# Eval("LocationDesc") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderText="Service Type" Visible="false" HeaderStyle-Width="100px" ItemStyle-Width="100px">
                    <ItemTemplate>
                        <asp:Label ID="lblServType" runat="server" Text='<%# Eval("ServTypeCode") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderText="Service Type" Visible="true" HeaderStyle-Width="100px" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Left">
                    <ItemTemplate>
                        <asp:Label ID="lblServTypeDesc" runat="server" Text='<%# Eval("ServTypeDesc") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderText="Religion" Visible="false" HeaderStyle-Width="100px" ItemStyle-Width="100px">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Amount" Visible="true" HeaderStyle-Width="100px" ItemStyle-Width="100px" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" >
                    <ItemTemplate>
    ...
    <asp:Label ID="lblDeduction" runat="server" Text="" Visible="false"></asp:Label>
