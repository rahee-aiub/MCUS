...
namespace ATOZWEBMCUS.Pages
{
    public partial class CSLoanApplication : System.Web.UI.Page
    {
        ...
        {
            string sqlquery = "SELECT AccTypeCode,AccTypeDescription from A2ZACCTYPE where AccTypeClass IN (5,6,8) AND AccTypeMode !='2' ORDER BY AccTypeClass";
        ...
        {
            string sqlquery = "SELECT AccTypeCode,AccTypeDescription from A2ZACCTYPE where AccTypeClass IN (5,6,8) AND AccTypeMode !='1'";
            ddlAccType = DataAccessLayer.BLL.CommonManager.Instance.FillDropDownList(sqlquery, ddlAccType, "A2ZCSMCUS");
        }
        ...
        protected void ddlAccType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlAccType.SelectedValue != "-Select-")
            {
                ...
                hAccType.Value = ddlAccType.SelectedValue;
                ...
                if (lblTypeCls.Text == "5" || lblTypeCls.Text == "8")
                {
                    BtnShare.Visible = false;
                    BtnDeposit.Visible = true;
        ...
        protected void AccountOpenCheck()
        {
            ...
            if (lblAccFlag.Text == "1" || lblAccFlag.Text == "2")
            {
                ...
                if (lblTypeCls.Text == "8")
                {
                    ...
                    string strQuery = @"SELECT DBO.FNCheckLiquidityLoanAccount(" + lblCuType.Text + "," + lblCu.Text +
                            "," + txtLoanMemNo.Text + ",0)";

                    result = Converter.GetInteger(CommonManager.Instance.GetScalarValueByQuery(strQuery, "A2ZCSMCUS"));
                    ...
                    if (result == 1)
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Loan Balance Available');", true);
                        MsgFlag.Text = "1";
                        return;
                    }
                    if (result == 2)
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Interest Balance Available');", true);
                        MsgFlag.Text = "1";
                        return;
                    }
                }
        ...
        protected void txtNoInstallment_TextChanged(object sender, EventArgs e)
        {
            ...
            hInstallmentAmt.Value = txtLoanInstallmentAmount.Text;
        ...
        protected void txtLoanAppAmount_TextChanged(object sender, EventArgs e)
        {
            ...
            //=============== Check Loan Amount For Liquidity Account ===============

            if (lblTypeCls.Text == "8")
            {
                int result = 9;

                string strQuery = @"SELECT DBO.FNCheckLiquidityLoanAmount(" + lblCuType.Text + "," + lblCu.Text +
                        "," + txtLoanMemNo.Text + ",'" + txtLoanAppAmount.Text + "',0)";

                result = Converter.GetInteger(CommonManager.Instance.GetScalarValueByQuery(strQuery, "A2ZCSMCUS"));

                if (result == 1)
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Loan Amount > Total Deposit');", true);
                }
                if (result == 2)
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Loan Amount > Total Share + Savings Deposit');", true);
                }
                if (result == 3)
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Loan Amount > Total Share');", true);
                }

                if (result > 0)
                {
                    txtLoanAppAmount.Text = "0";
                }
                else
                {
                    txtNoInstallment.Text = txtODPeriod.Text;
                    txtNoInstallment_TextChanged(null, null);
                }

            }
            //=============== End of Check Loan Amount For Liquidity Account ===============            
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //=============== Check Share Guarantee Table ====================
                //if (lblTypeCls.Text == "8")
                //{
                //    strQuery = @"SELECT DBO.FNCountNoOfGuarantor(" + lblCuType.Text + "," + lblCu.Text +
                //            "," + txtLoanMemNo.Text + ",1)";

                //    result = Converter.GetInteger(CommonManager.Instance.GetScalarValueByQuery(strQuery, "A2ZCSMCUS"));
                //    if(result == 0)
                //    {
                //        ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Please Input Share Guarantor Information');", true);
                //        return;
                //    }
                //}
                //=============== End of Check Share Guarantee Table ====================

                //=============== Check Account Guarantee Table ====================
                //if (lblTypeCls.Text == "8")
                //{
                //    strQuery = @"SELECT DBO.FNCountNoOfGuarantor(" + lblCuType.Text + "," + lblCu.Text +
                //            "," + txtLoanMemNo.Text + ",2)";
                ...
                //    if (result < 2)
                //    {
                //        ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Please Input Account Guarantor Information (Must be Two Account)');", true);
                //        return;
                //    }
                //}
                //=============== End of Check Account Guarantee Table ====================


                if ((lblTypeCls.Text == "5" || lblTypeCls.Text == "8") && (lblTotalResult.Text == string.Empty || lblTotalResult.Text == "00.00"))
                {
                    GuarantorMSG();
                    return;
                }
            ...
            {
                string notifyMsg = @"?msg=" + ex.ToString() + "&PreviousMenu=CSLoanApplication.aspx";

                notifyMsg = String.Format(notifyMsg).Replace("\r\n", string.Empty);

                Response.Redirect("MessageDisplay.aspx" + notifyMsg, true);

                //ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Problem in Submit');", true);
                //throw ex;
        ...
        protected void txtAccType_TextChanged(object sender, EventArgs e)
        {
            ...
            if (ObjDTO.AccTypeCode > 0)
            {
                ...
                {
                    if (lblTypeCls.Text != "8" || txtAccType.Text == "11")
                    {
                        txtAccType.Text = string.Empty;
                        txtAccType.Focus();
                        return;
        ...
        protected void txtLoanInstallmentAmount_TextChanged(object sender, EventArgs e)
        {
            ...
            if(d < 0)
            {
                txtLoanInstallmentAmount.Text = hInstallmentAmt.Value;
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Installment Amount > Application Amount');", true);
                return;
            }
 ...
 "click", @"<script>window.open('CSGetDepositorNo.aspx','_blank');</script>", false);
        ...
        protected void txtLoanAppDate_TextChanged(object sender, EventArgs e)
        {
            ...
            txtODPeriod_TextChanged(null, null);
        }
