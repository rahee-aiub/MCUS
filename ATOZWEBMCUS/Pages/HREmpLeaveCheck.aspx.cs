...
{
    public partial class HREmpLeaveCheck : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    //else
                    {
                        ...
                        string CheckQuery = "SELECT EmpCode,A2ZEMPLEAVETYPE.EmpleaveName,LStartDate,LEndDate,LApplyDays,LBalance from A2ZEMPLEAVE inner join A2ZEMPLEAVETYPE on A2ZEMPLEAVETYPE.EmpleaveCode=A2ZEMPLEAVE.EmpleaveCode where LProcStat='1'";
                        ...
                        {
                            string notifyMsg = "?txtOne=" + Converter.GetString(SessionStore.GetValue(Params.SYS_USER_NAME)) +
                                               "&txtTwo=" + "No Record Found for Check" +
        ...
        protected void BtnApproved_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                A2ZCSPARAMETERDTO dto = A2ZCSPARAMETERDTO.GetParameterValue();
                Int16 CheckBy = Converter.GetSmallInteger(SessionStore.GetValue(Params.SYS_USER_ID));
                DateTime CheckByDate = Converter.GetDateTime(dto.ProcessDate);


                string CheckUp = "UPDATE A2ZEMPLEAVE SET LProcStat=2,CheckBy = '" + CheckBy + "',CheckByDate = '" + CheckByDate + "' where Id='" + CtrlId.Text + "'";
                ...
                if (rowEffect > 0)
                {
                    ...
                    gv1Verify();
                    string CheckQuery = "SELECT EmpCode from A2ZEMPLEAVE where LProcStat='1'";
