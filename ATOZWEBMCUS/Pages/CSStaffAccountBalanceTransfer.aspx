<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSStaffAccountBalanceTransfer.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSStaffAccountBalanceTransfer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function ValidationBeforeUpdate() {
            var txtStaffCode = document.getElementById('<%=txtStaffCode.ClientID%>').value;
          

            var txtAccNo = document.getElementById('<%=txtAccNo.ClientID%>').value;
            var txtTrnStaffCode = document.getElementById('<%=txtTrnStaffCode.ClientID%>').value;
           

            if (txtStaffCode == '' || txtStaffCode.length == 0)
                alert('Please Input From Staff Code');
            else
                    if (txtAccNo == '')
                        alert('Please Input Account No.');
                    else
                        if (txtTrnStaffCode == '' || txtTrnStaffCode.length == 0)
                            alert('Please Input To Staff Code');
                            else
                                return confirm('Are you sure you want to Transfer Staff Account Balance?');
            return false;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div align="center">
        <table class="style1">
            ...
            <thead>
                <tr>
                    <th colspan="3">Staff Account Balance Transfer From..........
                    </th>
                </tr>
            </thead>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblStaff" runat="server" Text="Staff Code :" Font-Size="Large"
                        ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtStaffCode" runat="server" CssClass="cls text" Width="115px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Medium" TabIndex="3"></asp:TextBox>

                    <asp:Label ID="lblStaffName" runat="server" Width="500px" Height="25px" Text=""></asp:Label>
        ...
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Staff Account Balance Transfer To..............
                    </th>
                </tr>
            </thead>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblTrnStaff" runat="server" Text="Staff Code :" Font-Size="Large"
                        ForeColor="Red"></asp:Label>

                </td>
                <td>
                    <asp:TextBox ID="txtTrnStaffCode" runat="server" CssClass="cls text" Width="115px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Medium" TabIndex="6"></asp:TextBox>
                    <asp:Label ID="lblTrnStaffName" runat="server" Width="500px" Height="25px" Text=""></asp:Label>
        ...
        <asp:Label ID="lblTrnPayType" runat="server" Text="" Visible="false"></asp:Label>
         ...
         <asp:Label ID="lblTrnAtyClass" runat="server" Text="" Visible="false"></asp:Label>
