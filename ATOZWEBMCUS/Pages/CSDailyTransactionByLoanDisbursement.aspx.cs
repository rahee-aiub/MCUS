...
{
    public partial class CSDailyTransactionByLoanDisbursement : System.Web.UI.Page
    {
        ...
        private void LoanDisbursementAmt()
        {
            try
            {
                ...
                if (Acctype == 53)
                {
                    if(DateTime.Parse( Converter.GetDateToYYYYMMDD(CtrlOpenDate.Text)) < DateTime.Parse("2017-07-01"))
                    {
                        AccDisbNotAllowForTeachersLoanMSG();
                        txtAccNo.Focus();
                        CtrlMsgFlag.Text = "1";
                        return;
                    }
        ...
        protected void AccDisbNotAllowForTeachersLoanMSG()
        {
            ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Account Open Before 01/07/2017 - Account Disbursed Not Allowed');", true);
            return;
        }
