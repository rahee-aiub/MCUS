...
{
    public partial class CSDailyTransactionByEncashment : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (lblflag.Text == string.Empty)
                    {
                        ...
                        chkAmt1.Visible = false;
                        chkAmt2.Visible = false;
                        chkAmt3.Visible = false;
                        chkAmt4.Visible = false;
        ...
        protected void GetGLAccBalance()
        {
            ...
            prm[2] = 0;
            //prm[3] = UId;
            DataTable dt = CommonManager.Instance.GetDataTableBySpWithParams("SpM_GlGenerateSingleAccountBalance", prm, "A2ZGLMCUS");
            if (dt.Rows.Count > 0)
            {
        ...
        protected void ReadOnlyTransControl()
        {
            CtrlTrnFlag1.Text = "0";
            CtrlTrnFlag2.Text = "0";
            CtrlTrnFlag3.Text = "0";
            ...
            if (txtAmount1.Text == "0" || txtAmount1.Text == "00.00" || txtAmount1.Text == string.Empty)
            {
                txtAmount1.Text = string.Empty;
                txtAmount1.ReadOnly = false;
                chkAmt1.Checked = false;
                chkAmt1.Visible = false;
            }
            else
            {
                if (txtAmount1.ReadOnly != true)
                {
                    txtAmount1.ReadOnly = true;
                    chkAmt1.Checked = false;
                    chkAmt1.Visible = true;
                }
                else
                {
                    chkAmt1.Visible = false;
            ...
            if (txtAmount2.Text == "0" || txtAmount2.Text == "00.00" || txtAmount2.Text == string.Empty)
            {
                txtAmount2.Text = string.Empty;
                txtAmount2.ReadOnly = false;
                chkAmt2.Checked = false;
                chkAmt2.Visible = false;
            }
            else
            {
                if (txtAmount2.ReadOnly != true)
                {
                    txtAmount2.ReadOnly = true;
                    chkAmt2.Checked = false;
                    chkAmt2.Visible = true;
                }
                else
                {
                    chkAmt2.Visible = false;
            ...
            if (txtAmount3.Text == "0" || txtAmount3.Text == "00.00" || txtAmount3.Text == string.Empty)
            {
                txtAmount3.Text = string.Empty;
                txtAmount3.ReadOnly = false;
                chkAmt3.Checked = false;
                chkAmt3.Visible = false;
            }
            else
            {
                if (txtAmount3.ReadOnly != true)
                {
                    txtAmount3.ReadOnly = true;
                    chkAmt3.Checked = false;
                    chkAmt3.Visible = true;
                }
                else
                {
                    chkAmt3.Visible = false;
            ...
            if (txtAmount4.Text == "0" || txtAmount4.Text == "00.00" || txtAmount4.Text == string.Empty)
            {
                txtAmount4.Text = string.Empty;
                txtAmount4.ReadOnly = false;
                chkAmt4.Checked = false;
                chkAmt4.Visible = false;
            }
            else
            {
                if (txtAmount4.ReadOnly != true)
                {
                    txtAmount4.ReadOnly = true;
                    chkAmt4.Checked = false;
                    chkAmt4.Visible = true;
                }
                else
                {
                    chkAmt4.Visible = false;
        ...
        protected void AddNormal()
        {
            try
            {
                ...
                if (CtrlRow.Text == "2")
                {
                    ...
                    if ((txtAmount4.Text == "0" || txtAmount4.Text == "00.00") && (lblFuncOpt.Text == "09" || lblFuncOpt.Text == "10"))
                    {
                        ProvisionSettlement();
                    }
                    else
        ...
        protected void txtAmount3_TextChanged(object sender, EventArgs e)
        {
            ...
            if (lblcls.Text == "2" && lblFuncOpt.Text == "09")
            {
                ...
                {
                    OrgMainAmt.Text = CtrlValidAmt1.Text;

                    CtrlRow.Text = "1";
                    VisibleTranAmt();

                    CtrlValidAmt1.Text = OrgMainAmt.Text;
                }
            }
        ...
        protected void txtAmount4_TextChanged(object sender, EventArgs e)
        {
            ...
            if (lblcls.Text == "4" && lblFuncOpt.Text == "09")
            {
                ...
                else
                {
                    ...
                    OrgMainAmt.Text = CtrlValidAmt2.Text;

                    CtrlRow.Text = "2";
                    VisibleTranAmt();
                    CtrlValidAmt2.Text = OrgMainAmt.Text;
                }
            }
        ...
        protected void BtnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ddlTrnType.SelectedValue == "-Select-")
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Please Select Transaction Type');", true);
                    return;
     ...
     "click", @"<script>window.open('CSGetStaffAccountNo.aspx','_blank');</script>", false);
        ...
        protected void chkAmt1_CheckedChanged(object sender, EventArgs e)
        {
            if (chkAmt1.Checked)
            {
                txtAmount1.ReadOnly = false;
            ...
            {
                txtAmount1.Text = CtrlValidAmt1.Text;
                txtAmount1.ReadOnly = true;
                CtrlTrnFlag1.Text = "0";
        ...
        protected void chkAmt2_CheckedChanged(object sender, EventArgs e)
        {
            if (chkAmt2.Checked)
            {
                txtAmount2.ReadOnly = false;
            ...
            {
                txtAmount2.Text = CtrlValidAmt2.Text;
                txtAmount2.ReadOnly = true;
                CtrlTrnFlag2.Text = "0";
        ...
        protected void chkAmt3_CheckedChanged(object sender, EventArgs e)
        {
            if (chkAmt3.Checked)
            {
                txtAmount3.ReadOnly = false;
            ...
            {
                txtAmount3.Text = CtrlValidAmt3.Text;
                txtAmount3.ReadOnly = true;
                CtrlTrnFlag3.Text = "0";
                txtAmount3_TextChanged(null, null);

                NetTotal();
            }
        }

        protected void chkAmt4_CheckedChanged(object sender, EventArgs e)
        {
            if (chkAmt4.Checked)
            {
                txtAmount4.ReadOnly = false;
            ...
            {
                txtAmount4.Text = CtrlValidAmt4.Text;
                txtAmount4.ReadOnly = true;
                CtrlTrnFlag4.Text = "0";
                txtAmount4_TextChanged(null, null);
