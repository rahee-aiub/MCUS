<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="SYSDivisionCodeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.SYSDivisionCodeMaintenance" Title="Division Maintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlDivision" runat="server" Height="25px" Width="316px" AutoPostBack="True"
 ...
 AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" RowStyle-Height="10px" OnRowDataBound="gvDetailInfo_RowDataBound">
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Code" DataField="DiviCode" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField HeaderText="Description" DataField="DiviDescription" HeaderStyle-Width="380px" ItemStyle-Width="380px" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Center"/>
