<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSReScheduleSanctionAmount.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSReScheduleSanctionAmount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div align="center">
        <asp:Panel ID="pnlLoanApplication" runat="server" Width="976px">
            <table class="style1">
                ...
                <thead>
                    <tr>
                        <th colspan="3">Teachers Loan New Sanction Amount
                        </th>
                    </tr>
                </thead>
                <tr>
    ...
    <div align="center">
        <table class="style1">
                ...
                <tr>
                    <td>
                        <asp:Label ID="IlblExDisbAmt" runat="server" Text="Disbursement Amt. :" Font-Size="Large"
                            ForeColor="Red"></asp:Label>
                    ...
                    <td>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="IlblNewLoanAmt" runat="server" Text="New Loan Amount :" Font-Size="Large"
                            ForeColor="Red"></asp:Label>
    ...
    <div align="center">
        <table class="style1">
            <tr>
                ...
                <td>
                    <asp:Label ID="IlblNewSanctionAmount" runat="server" Text="Increase Sanction Amount:" Font-Size="Large"
                        ForeColor="Red"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="ItxtNewInstalAmt" runat="server" CssClass="cls text" Enabled="false" Width="120px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Height="25px" Font-Size="Large" OnTextChanged="ItxtNewInstalAmt_TextChanged" AutoPostBack="True" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="ItxtNewInterestRate" runat="server" CssClass="cls text" Width="120px" Enabled="false" BorderColor="#1293D1" BorderStyle="Ridge"
