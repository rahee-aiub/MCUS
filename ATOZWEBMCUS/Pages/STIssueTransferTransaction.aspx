<%@ Page Language="C#" MasterPageFile="~/MasterPages/INVMasterPage.Master" AutoEventWireup="true" CodeBehind="STIssueTransferTransaction.aspx.cs" Inherits="ATOZWEBMCUS.Pages.STIssueTransferTransaction" Title="Issue Sell Maintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="4">Stock Transfer Transaction
                    </th>
                </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="Label8" runat="server" Text="Warehouse To:" Font-Size="Large"
                        ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtToWarehouse" runat="server" Width="100px" Height="25px" Font-Size="Large"
                            CssClass="cls text" TabIndex="2" AutoPostBack="true" OnTextChanged="txtToWarehouse_TextChanged"></asp:TextBox>
                    &nbsp;
                    <asp:DropDownList ID="ddlToWarehouse" runat="server" Height="30px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Width="350px" Font-Size="Large" AutoPostBack="true" OnSelectedIndexChanged="ddlToWarehouse_SelectedIndexChanged">
                    </asp:DropDownList>
        ...
        <asp:Panel ID="pnlProperty" runat="server" Height="300px">
            <table class="style1">
                <tr>
                      ...
                      <td>
                        <h3>
                            <asp:Label ID="Label14" runat="server" Text="Category" ForeColor="Red"></asp:Label></h3>
                    ...
                    <td>
                        <h3>
                            &nbsp;
                            <asp:Label ID="Label13" runat="server" Text="Qty.Trf." ForeColor="Red"></asp:Label></h3>
                    ...
                    <td>
                        <h3>
                            &nbsp;
                            <asp:Label ID="Label1" runat="server" Visible="false" Text="Unit Price" ForeColor="Red"></asp:Label></h3>
                        <asp:TextBox ID="txtUnitPrice" runat="server" Visible="false" Width="108px" Height="25px" Font-Size="Large" Style="text-align: Right" onkeypress="return IsDecimalKey(event)"
                            CssClass="cls text" TabIndex="5" ReadOnly="true"></asp:TextBox>
                    </td>
                    <td>
                        <h3>
                            &nbsp;
                            <asp:Label ID="Label2" runat="server" Visible="false" Text="Total Price" ForeColor="Red"></asp:Label></h3>
                        <asp:TextBox ID="txtTotalPrice" runat="server" Visible="false" Width="113px" Height="25px" Font-Size="Large" Style="text-align: Right"
                            CssClass="cls text" TabIndex="5" ReadOnly="True"></asp:TextBox>
                    </td>
            ...
            <div align="center" class="grid_scroll">
                <asp:GridView ID="gvItemDetails" runat="server" HeaderStyle-BackColor="YellowGreen" Width="1000px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ItemUnitPrice" Visible="false" DataFormatString="{0:0,0.00}" HeaderText="Unit Price">
                            <HeaderStyle Width="125px" />
                            <ItemStyle HorizontalAlign="Right" Width="125px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="ItemTotalPrice" Visible="false" DataFormatString="{0:0,0.00}" HeaderText="Total Price">
                            <HeaderStyle Width="125px" />
                            <ItemStyle HorizontalAlign="Right" Width="125px" />
                        </asp:BoundField>
    ...
    <div align="center">
        ...
        <table class="style1">
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="Label4" runat="server" Text="Total Trf. Qty:" Font-Size="Large"
                        ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtTrfQty" runat="server" CssClass="cls text" Width="150px" BorderColor="#1293D1" BorderStyle="Ridge"
