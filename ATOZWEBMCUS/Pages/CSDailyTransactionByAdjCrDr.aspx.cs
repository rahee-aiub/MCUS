...
{
    public partial class CSDailyTransactionByAdjCrDr : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        txtGLContraCode.Text = RtxtGLContraCode;
                        ...
                        {
                            lblSkipFlag.Text = "1";
                            SingleGLContraCodeDropdown();
                            ddlGLContraCode.SelectedValue = txtGLContraCode.Text;
                        }
                    ...
                    if (lblFuncOpt.Text == "01" && CtrlModule.Text != "04")
                    {
                        BtnNew.Visible = true;
                    }
                    else
                    ...
                    if (lblSkipFlag.Text == string.Empty)
                    {

                        if (lblFuncOpt.Text == "11" || lblFuncOpt.Text == "12")
                        {
                            HeaderDropdown();
                    ...
                    if (lblFuncOpt.Text == "03" || lblFuncOpt.Text == "04")
                    {
                    ...
                    if (lblFuncOpt.Text == "03" ||
                        lblFuncOpt.Text == "04" ||
                        lblFuncOpt.Text == "05" ||
                        lblFuncOpt.Text == "06" ||
                        //(lblFuncOpt.Text == "07" && CtrlModule.Text != "04") ||
                        lblFuncOpt.Text == "07" ||
                        lblFuncOpt.Text == "08" ||
                        lblFuncOpt.Text == "09" ||
                        lblFuncOpt.Text == "10")
                    {
                        ...
                        ddlTrnType.SelectedValue = "1";

                        lblBalance.Visible = true;
                        txtBalance.Visible = true;
                        lblGLCode.Text = lblCashCode.Text;
                    ...
                    ////if (CtrlModule.Text == "04" && lblFuncOpt.Text == "07")
                    ////{
                    ////    lblType.Text = "1";
                    ////    TrnTypeDropdown();
        ...
        protected void GetGLAccBalance()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                //txtBalance.Text = Converter.GetDecimal(dt.Rows[0]["GLOpBal"]).ToString();
                txtBalance.Text = Converter.GetString(String.Format("{0:0,0.00}", Converter.GetDecimal(dt.Rows[0]["GLOpBal"])));
            }

            //int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("SpM_GlAccountBalanceSingle", prm, "A2ZGLMCUS"));
        ...
        protected void HeaderDropdown()
        {
            ...
            string sqlQueryContra = @"SELECT GLHead, GLHeadDesc FROM A2ZCGLMST WHERE GLRecType = 1 AND Status=1 AND GLSubHead = 0 GROUP BY GLHead,GLHeadDesc ORDER BY GLHeadDesc ASC ";
        ...
        protected void FunctionName()
        {
            ...
            if ((lblFuncOpt.Text == "03" || lblFuncOpt.Text == "04") && CtrlModule.Text == "04")
            {
            ...
            if (lblFuncOpt.Text == "05" || lblFuncOpt.Text == "06")
            {
                lblTransFunction.Text = "Cash/Trf. Out Trans.- INT./BENEFIT WITHDRAWAL";
                lblFuncTitle.Text = "WITHDRAWAL";
                lblTotalAmt.Text = "NET AMOUNT PAID";
            }
            if (lblFuncOpt.Text == "07" || lblFuncOpt.Text == "08")
            {
        ...
        protected void TrnTypeDropdown()
        {
            string sqlquery = @"SELECT TrnType,TrnTypeDes from A2ZTRNTYPE where TrnType!= '" + lblType.Text + "'";
            ddlTrnType = DataAccessLayer.BLL.CommonManager.Instance.FillDropDownList(sqlquery, ddlTrnType, "A2ZCSMCUS");
        }
        ...
        protected void GLCashCodeDropdown()
        {
            ...
            string sqlquery = @"SELECT GLAccNo,+ CAST (GLAccNo AS VARCHAR(100))+ '-' + LTRIM(RTRIM(GLAccDesc)) from A2ZCGLMST where GLRecType = 2 AND GLAccMode !=1 AND Status=1 and GLSubHead = 10101000 ORDER BY GLAccDesc ASC";
        ...
        protected void GLBankCodeDropdown()
        {
            ...
            string sqlquery = @"SELECT GLAccNo,+ CAST (GLAccNo AS VARCHAR(100))+ '-' + LTRIM(RTRIM(GLAccDesc)) from A2ZCGLMST where GLRecType = 2 AND (GLSubHead = 10106000 OR GLSubHead = 20801000) ORDER BY GLAccDesc ASC";
        ...
        protected void GLContraCodeDropdown()
        {
            ...
            string sqlquery = @"SELECT GLAccNo,+ CAST (GLAccNo AS VARCHAR(100))+ '-' + LTRIM(RTRIM(GLAccDesc)) from A2ZCGLMST where GLRecType = 2 AND GLAccMode !=1 AND Status=1 ORDER BY GLAccDesc ASC";
            ddlGLContraCode = DataAccessLayer.BLL.CommonManager.Instance.FillDropDownList(sqlquery, ddlGLContraCode, "A2ZGLMCUS");

        }


        protected void SingleGLContraCodeDropdown()
        {

            string sqlquery = @"SELECT GLAccNo,+ CAST (GLAccNo AS VARCHAR(100))+ '-' + LTRIM(RTRIM(GLAccDesc)) from A2ZCGLMST where Status=1 AND GLAccNo = '" + txtGLContraCode.Text + "'";
            ddlGLContraCode = DataAccessLayer.BLL.CommonManager.Instance.FillDropDownList(sqlquery, ddlGLContraCode, "A2ZGLMCUS");
        ...
        protected void InitializedRecords()
        {
            ...
            if (ddlTrnType.SelectedValue != "2")
            {
                GLCashCodeDropdown();
                txtGLCashCode.Text = lblCashCode.Text;
                ddlGLCashCode.SelectedValue = Converter.GetString(lblCashCode.Text);
            }
        }
        ...
        protected void txtGLCashCode_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtGLCashCode.Text != string.Empty)
                {
                    ...
                    string input1 = Converter.GetString(txtGLCashCode.Text).Length.ToString();
                    if (input1 == "6")
                    {
                        GLCode = Converter.GetInteger(txtGLCashCode.Text);
                    ...
                    if (glObj.GLAccNo > 0)
                    {
                        ...
                        hdnGLSubHead.Text = Converter.GetString(glObj.GLSubHead);
                        ...
                        if (ddlTrnType.SelectedValue != "2" && hdnGLSubHead.Text != "10101000")
                        {
                            InvalidGlCashCode();
                            txtGLCashCode.Text = string.Empty;
                            txtGLCashCode.Focus();
                        ...
                        {
                            txtGLCashCode.Text = Converter.GetString(glObj.GLAccNo);
                            ddlGLCashCode.SelectedValue = Converter.GetString(glObj.GLAccNo);

                            lblBalance.Visible = true;
                            txtBalance.Visible = true;
                            lblBalance.Text = "GL Bank Balance :";
                            lblGLCode.Text = txtGLCashCode.Text;
                            GetGLAccBalance();
                            txtBalance.ReadOnly = true;
        ...
        private void ContraDropDown()
        {
            try
            {
                ...
                if (hdnContraHead1.Text == "0")
                {
                    ...
                    string sqlQueryContra = @"SELECT GLHead, GLHeadDesc FROM A2ZCGLMST WHERE GLRecType = 1 AND GLSubHead = 0 AND Status=1 GROUP BY GLHead,GLHeadDesc ORDER BY GLHeadDesc ASC ";
                    ddlGLContraCode = CommonManager.Instance.FillDropDownList(sqlQueryContra, ddlGLContraCode, "A2ZGLMCUS");
                    ddlGLContraCode.SelectedItem.Text = "-Select Header Code-";
                ...
                else if (hdnContraHead2.Text == "0")
                {
                    ...
                    string sqlquery1 = @"SELECT GLAccNo, GLAccDesc FROM A2ZCGLMST WHERE  GLPrtPos = 1 AND Status=1 AND GLAccType = '" + sub3 + "' GROUP BY GLAccNo,GLAccDesc ORDER BY GLAccDesc ASC";
                ...
                else if (hdnContraHead3.Text == "0")
                {
                    ...
                    string sqlquery1 = @"SELECT GLAccNo, GLAccDesc FROM A2ZCGLMST WHERE  GLPrtPos = 2 AND Status=1 AND GLAccType = '" + subMHead + "' AND LEFT(GLAccNo,3)='" + sub4 + "' GROUP BY GLAccNo,GLAccDesc ORDER BY GLAccDesc ASC ";
                    ddlGLContraCode = CommonManager.Instance.FillDropDownList(sqlquery1, ddlGLContraCode, "A2ZGLMCUS");
                ...
                else if (hdnContraHead4.Text == "0")
                {
                    ...
                    string sqlquery1 = @"SELECT GLAccNo, GLAccDesc FROM A2ZCGLMST WHERE  GLPrtPos = 6 AND Status=1 AND GLAccType = '" + subMHead + "' AND LEFT(GLAccNo,5)='" + sub4 + "' AND GLAccNo != '" + lblCashCode.Text + "' GROUP BY GLAccNo,GLAccDesc ORDER BY GLAccDesc ASC";
                    ddlGLContraCode = CommonManager.Instance.FillDropDownList(sqlquery1, ddlGLContraCode, "A2ZGLMCUS");
                ...
                else
                {
                    ...
                    if (glObj.GLAccNo > 0)
                    {
                        ...
                        else if (txtGLContraCode.Text == lblTrnCode.Text)
                        {
                            InvalidGlCode();
                            txtGLContraCode.Text = string.Empty;
                            txtGLContraCode.Focus();
                        ...
                        else if ((hdnGLSubHead.Text == "10106000" || hdnGLSubHead.Text == "20801000") && lblFuncOpt.Text != "12")
                        {
        ...
        protected void txtGLContraCode_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtGLContraCode.Text == lblCashCode.Text)
                {
                    InvalidCode();
                    txtGLContraCode.Text = string.Empty;
                    txtGLContraCode.Focus();
                ...
                if (txtGLContraCode.Text != string.Empty)
                {
                    ...
                    if (glObj.GLAccNo > 0)
                    {
                        ...
                        {
                            txtGLContraCode.Text = Converter.GetString(glObj.GLAccNo);
                            CtrlContraAType.Text = Converter.GetString(glObj.GLAccType);
                            ...
                            hdnContraCode.Text = Converter.GetString(txtGLContraCode.Text);
                            ContraDropDown();
        ...
        protected void ddlGLContraCode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            hdnContraCode.Text = Converter.GetString(ddlGLContraCode.SelectedValue);
        ...
        protected void AccGetInfo()
        {
            try
            {
                ...
                else
                {
                    ...
                    if ((lblcls.Text == "4" && lblFuncOpt.Text == "01") ||
                        (lblcls.Text == "2" && lblFuncOpt.Text == "05") ||
                        (lblcls.Text == "3" && lblFuncOpt.Text == "05"))
                    {
        ...
        protected void DisplayHistoryInfo()
        {
            ...
            if (CtrlAccAtyClass.Text == "1")
            {
                ...
                lblData2.Text = CtrlIntRate.Text;
                lblRec3.Text = "Last Transaction Date :";
                lblData3.Text = CtrlLastTrnDate.Text;
                lblRec4.Text = "Lien Amount :";
                lblData4.Text = CtrlLienAmt.Text;
            ...
            if (CtrlAccAtyClass.Text == "2")
            {
                lblBalRec.Text = "Ledger Balance :";
                lblBalData.Text = CtrlLadgerBalance.Text;

                if (CtrlRenwlDate.Text == string.Empty || CtrlRenwlDate.Text == "01/01/0001")
                {
                    lblRec1.Text = "Open Date  :";
                    lblData1.Text = CtrlOpenDate.Text;
                }
                ...
                {
                    lblRec1.Text = "Renewal Date  :";
                    lblData1.Text = CtrlRenwlDate.Text;
                }

                lblRec2.Text = "Maturity Date  :";
                lblData2.Text = CtrlMaturityDate.Text;
                lblRec3.Text = "Period(Month)  :";
                lblData3.Text = CtrlPeriod.Text;
                lblRec4.Text = "Orginal Amount :";
                lblData4.Text = CtrlOrgAmt.Text;
                lblRec5.Text = "Orginal Int. Rate :";
                lblData5.Text = CtrlIntRate.Text;
                lblRec11.Text = "Certificate No. :";
                lblData11.Text = CtrlCertNo.Text;
                ...
                //lblData11.Style.Add("visibility", "none");
                ...
                if (lblFuncOpt.Text == "05" || lblFuncOpt.Text == "06")
                {
                    ...
                    lblData6.Text = CtrlRenwlDate.Text;
                    lblRec7.Text = "Principal Amount :";
                    lblData7.Text = CtrlPrincipal.Text;
                    lblRec10.Text = "Renewal Amount :";
                    lblData10.Text = CtrlRenwlAmt.Text;
                ...
                if (lblFuncOpt.Text == "09" || lblFuncOpt.Text == "10")
                {
                    ...
                    lblData6.Text = hdnCalFDAmount.Text;
                    lblRec7.Text = "Cal.Int.Rate :";
                    lblData7.Text = hdnCalIntRate.Text;
                    lblRec8.Text = "Cal.Int.Amount :";
                    lblData8.Text = hdnCalOrgInt.Text;
                    lblRec9.Text = "Cal.From Date :";
                    lblData9.Text = hdnCalFDate.Text;
                    lblRec10.Text = "Cal.Period(Month) :";
                    lblData10.Text = hdnCalPeriod.Text;
            ...
            if (CtrlAccAtyClass.Text == "3")
            {
                ...
                lblData3.Text = CtrlOrgAmt.Text;
                lblRec4.Text = "No. of Benefit :";
                lblData4.Text = lblNoMonths.Text;
                lblRec11.Text = "Monthly Benefit :";
                lblData11.Text = CtrlFixedMthInt.Text;
                ...
                if (lblFuncOpt.Text == "09" || lblFuncOpt.Text == "10")
                {
                    lblRec5.Text = "Calculated Benefit :";
                    lblData5.Text = hdnCalOrgInt.Text;
                    lblRec6.Text = "Paid Benefit :";
                    lblData6.Text = hdnCalPaidInt.Text;
                    lblRec7.Text = "Available Benefit :";
                    lblData7.Text = hdnAvailBenefit.Text;

                    lblRec9.Text = "Available Prov.Benefit :";
                    lblData9.Text = CtrlProvBenefit.Text;
                    lblRec10.Text = "Adj.Prov.Benefit :";
                    lblData10.Text = hdnAdjProvBenefit.Text;
                ...
                {
                    lblRec5.Text = "Available Benefit :";
                    lblData5.Text = CtrlProvBenefit.Text;
                    //lblData5.Style.Add("visibility", "none");
            ...
            if (CtrlAccAtyClass.Text == "4")
            {
                ...
                lblRec3.Text = "Maturity Date :";
                lblData3.Text = CtrlMaturityDate.Text;

                lblRec4.Text = "Period :";
                lblData4.Text = CtrlPeriod.Text;


                lblRec5.Text = "Monthly Deposit Amt. :";
                lblData5.Text = CtrlMthDeposit.Text;
                lblRec9.Text = "Total Deposit Amt. :";
                lblData9.Text = CtrlTotalDeposit.Text;



                if (lblFuncOpt.Text != "09" && lblFuncOpt.Text != "10")
                {
                    lblRec10.Text = "Due Deposit Amt.:";
                    lblData10.Text = CtrlDueDepositAmt.Text;
                ...
                lblRec7.Text = "Upto Deposit :";

                lblData7.Text = lblUptoDate.Text;
                //lblData7.Style.Add("visibility", "none");
                lblData7.Visible = true;


                //if (lblUptoYear.Text != "0")
                //{
                //    lblData7.Text = lblUptoMonth.Text + "," + lblUptoYear.Text;
                //    lblData7.Visible = true;
                //}
                ...
                if (lblFuncOpt.Text == "09" || lblFuncOpt.Text == "10")
                {
                    lblRec6.Text = "Maturity Amt.:";
                    lblData6.Text = lblMatureAmt.Text;

                    //lblData6.Style.Add("visibility", "none");
                    lblData6.Visible = true;

                    lblRec11.Text = "Paid Period :";
                    lblData11.Text = hdnCalPeriod.Text;
            ...
            if (CtrlAccAtyClass.Text == "5")
            {
                ...
                lblData7.Text = CtrlCurrIntAmt.Text;

                lblRec8.Text = "Due Interest Amt. :";
                lblData8.Text = CtrlDueIntAmt.Text;
            }
        ...
        private void CalculateOdInterest()
        {
            if (CtrlPayType.Text == "355" || CtrlPayType.Text == "354")
            {
                ...
                prm[1] = lblCuNo.Text;
                prm[2] = txtMemNo.Text;
                prm[3] = lblAccountType.Text;
                prm[4] = txtAccNo.Text;
                prm[5] = Converter.GetDateToYYYYMMDD(CtrlProcDate.Text);
                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("Sp_CSCalculateODInterest", prm, "A2ZCSMCUS"));
                if (result == 0)
                {
                    string qry = "SELECT Id,ShowInt,GLAccNoDR,GLAccNoCR,TrnPayment,AccTypeMode FROM A2ZACCOUNT where AccNo='" + txtAccNo.Text + "'";
                    DataTable dt = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry, "A2ZCSMCUS");
                    if (dt.Rows.Count > 0)
                    {
                        lblCalInterest.Text = Converter.GetString(dt.Rows[0]["CalInterest"]);
        ...
        private void ReadTranLogic()
        {
            ...
            if (CtrlTrnLogic.Text == "1")
            {
                ShareMinAmt();
            }
            if (CtrlTrnLogic.Text == "2")
            {
                PensionAmount();
            }
            ...
            if (CtrlTrnLogic.Text == "4")
            {
                LoanDisbursementAmt();
            }
            if (CtrlTrnLogic.Text == "5")
            {
                ODLoanWithdrawal();
            }

            if (CtrlTrnLogic.Text == "6")
            {
                if (CtrlAccAtyClass.Text == "5")
                {
                    ODIntReturnAmt();
            ...
            if (CtrlTrnLogic.Text == "7")
            {
                if (CtrlAccAtyClass.Text == "6")
                {
                    LoanReturnAmt();
                }
                else
            ...
            if (CtrlTrnLogic.Text == "8")
            {
                IntWithdrawal();
            }
            if (CtrlTrnLogic.Text == "30")
            {
                BenefitAdjustmentCr();
            }
            if (CtrlTrnLogic.Text == "31")
            {
                BenefitAdjustmentDr();
            }
            if (CtrlTrnLogic.Text == "9")
            {
                BenefitWithdrawal();
            }
            if (CtrlTrnLogic.Text == "10")
            {
                InterestAmountFDR();
            }
            if (CtrlTrnLogic.Text == "11")
            {
                InterestAdjustmentFDR();
            }
            if (CtrlTrnLogic.Text == "12")
            {
                NetEncashmentIntFDR();
            }
            if (CtrlTrnLogic.Text == "13")
            {
                NetEncashmentPrincFDR();
            }
            if (CtrlTrnLogic.Text == "14")
            {
                InterestAmount6YR();
            }
            if (CtrlTrnLogic.Text == "15")
            {
                InterestAdjustment6YR();
            }
            if (CtrlTrnLogic.Text == "16")
            {
                NetEncashmentInt6YR();
            }
            if (CtrlTrnLogic.Text == "17")
            {
                NetEncashmentPrinc6YR();
            }
            if (CtrlTrnLogic.Text == "18")
            {
                BenefitAmountMSplus();
            }
            if (CtrlTrnLogic.Text == "19")
            {
                BenefitAdjustmentMSplus();
            }
            if (CtrlTrnLogic.Text == "20")
            {
                NetEncashmentBenefitMSplus();
            }

            if (CtrlTrnLogic.Text == "21")
            {
            ...
            if (CtrlTrnLogic.Text == "25")
            {
                PenalInterest();
            }
            if (CtrlTrnLogic.Text == "26")
            {
                AdjustmentIntCrPension();
            }
            if (CtrlTrnLogic.Text == "27")
            {
                AdjustmentIntDrPension();
            }
            if (CtrlTrnLogic.Text == "28")
            {
                ClosingFees();
            }
            if (CtrlTrnLogic.Text == "29")
            {
                NetEncashmentPesion();
            }
        }
        ...
        private void ShareMinAmt()
        {
            try
            {
                ...
                if (getDTO.NoRecord > 0)
                {
                    ...
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(0))));
                    VisibleTranAmt();
                }
            }
        ...
        private void PensionAmount()
        {
            try
            {
                ...
                if (getDTO.CuType > 0)
                {
                    CtrlCalDepositAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.CalDepositAmt))));
                    CtrlCalPenalAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.PayablePenalAmt))));

                    CtrlPrevDueDepositAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.UptoDueDepositAmt))));

                    CtrlPaidDepositAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.PaidDepositAmt))));

                    CtrlPaidPenalAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.PaidPenalAmt))));

                    CtrlDueDepositAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (getDTO.DueDepositAmt)));
                    CtrlCurrDueDepositAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (getDTO.CurrDueDepositAmt)));
                    double DepositAmt = Converter.GetDouble(CtrlCurrDueDepositAmt.Text);

                    lblUptoMonth.Text = Converter.GetString(getDTO.UptoMonth);
                    lblUptoYear.Text = Converter.GetString(getDTO.UptoYear);

                    lblUptoDate.Text = Converter.GetString(getDTO.UptoDate);

                    lblDepositFlag.Text = Converter.GetString(getDTO.DepositFlag);


                    if (DepositAmt > 0)
                    {
                        CtrlCurrDueDepositAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.CurrDueDepositAmt))));
                    }
                    else
                    {
                        CtrlCurrDueDepositAmt.Text = "0";
                    }

                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (CtrlCurrDueDepositAmt.Text)));
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (CtrlCurrDueDepositAmt.Text)));
        ...
        private void ODLoanWithdrawal()
        {
            try
            {
                ...
                Int64 AccNumber = Converter.GetLong(txtAccNo.Text);
                int MemNumber = Converter.GetInteger(txtMemNo.Text);
                String TrnDate = Converter.GetDateToYYYYMMDD(txtTranDate.Text);

                A2ZTRNLOGICDTO getDTO = (A2ZTRNLOGICDTO.GetODLoanWithdrawal(CuType, CuNo, MemNumber, Acctype, AccNumber, TrnDate));
                if (getDTO.NoRecord > 0)
                {
                    if (getDTO.NoMsg > 0)
                    {
                    ...
                    else
                    {
                        CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                        CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                        CtrlCurrIntAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.AccCurrIntAmt))));


                        TotalwithdrawalValue();
                        double TWV = Converter.GetDouble(TotalWithdrawal.Text);
                        double ValidAmt = Converter.GetDouble(CtrlValidAmt.Text);
                        ValidAmt = (ValidAmt - TWV);
                        CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", ValidAmt));
                        CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", ValidAmt));

                        CtrlHoldIntFlag.Text = "1";
        ...
        private void ODIntReturnAmt()
        {
            try
            {
                ...
                A2ZTRNLOGICDTO getDTO = (A2ZTRNLOGICDTO.GetODInterestAmt(CuType, CuNo, MemNumber, Acctype, AccNumber, TrnDate));
                if (getDTO.NoRecord > 0)
                {
                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                    CtrlCurrIntAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.AccCurrIntAmt))));
                    CtrlDueIntAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.AccDueIntAmt))));
        ...
        private void IntReturnAmt()
        {
            try
            {
                ...
                if (getDTO.CuType > 0)
                {
                    CtrlCalPrincAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.CalPrincAmt))));
                    CtrlCalIntAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.CalIntAmt))));
                    CtrlCalPenalAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.PayablePenalAmt))));

                    CtrlPrevDuePrincAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.UptoDuePrincAmt))));
                    CtrlPrevDueIntAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.UptoDueIntAmt))));

                    CtrlPaidPrincAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.PaidPrincAmt))));
                    CtrlPaidIntAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.PaidIntAmt))));
                    CtrlPaidPenalAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.PaidPenalAmt))));

                    CtrlDuePrincAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.CurrDuePrincAmt))));
                    CtrlDueIntAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.CurrDueIntAmt))));


                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (CtrlDueIntAmt.Text)));
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (CtrlDueIntAmt.Text)));
        ...
        private void LoanReturnAmt()
        {
            try
            {
                ...
                CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (CtrlDuePrincAmt.Text)));
                CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (CtrlDuePrincAmt.Text)));
                VisibleTranAmt();
        ...
        private void PenalInterest()
        {
            try
            {
                //if (CtrlCalPenalAmt.Text != "00.00" && CtrlPaidPenalAmt.Text == "00.00")
                if (CtrlPaidPenalAmt.Text == "00.00" || CtrlPaidPenalAmt.Text == string.Empty)
                {
                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (CtrlCalPenalAmt.Text)));
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (CtrlCalPenalAmt.Text)));
                    CtrlPenalFlag.Text = "1";
                    VisibleTranAmt();
                    return;
                }
                else
                {
                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (0)));
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (0)));
                    CtrlPenalFlag.Text = "1";
                    VisibleTranAmt();
                    return;
                }
        ...
        private void BenefitAdjustmentCr()
        {
            try
            {
                Int16 CuType = Converter.GetSmallInteger(lblCuType.Text);
                ...
                if (getDTO.NoRecord > 0)
                {
                    ...
                    //else
                    //{
                    CtrlFixedMthInt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.AccFixedMthInt))));
                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));

                    CtrlAdjBenefitCr.Text = Converter.GetString(String.Format("{0:0,0.00}", (getDTO.AdjBalAmount)));

                    double BenefitCr = Converter.GetDouble(CtrlAdjBenefitCr.Text);

                    if (BenefitCr == 0 || BenefitCr < 0)
                    {
                        CtrlLogicAmt.Text = "0";
                        CtrlValidAmt.Text = "0";
                    }
                    ...
                    {
                        CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.AdjBalAmount))));
                        CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.AdjBalAmount))));
                    }
                    CtrlBenefitFlag1.Text = "1";
                    lblBenefitMode.Text = "1";
                    VisibleTranAmt();
                    //}
                }
        ...
        private void BenefitAdjustmentDr()
        {
            try
            {
                Int16 CuType = Converter.GetSmallInteger(lblCuType.Text);
        ...
        private void BenefitWithdrawal()
        {
            try
            {
                ...
                if (getDTO.NoRecord > 0)
                {
                    ...
                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                    //CtrlProvBenefit.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));

                    DateTime dt1 = new DateTime();

                    dt1 = Converter.GetDateTime(getDTO.CalProvDate);
                    string date1 = dt1.ToString("dd/MM/yyyy");
                    CtrlCalProvDate.Text = date1;

                    if (CtrlCalProvDate.Text == "01/01/0001")
                    {
                        dt1 = Converter.GetDateTime(getDTO.BenefitDate);
                        string date2 = dt1.ToString("dd/MM/yyyy");
                        CtrlCalProvDate.Text = date2;
                    }


                    lblNoMonths.Text = Converter.GetString(getDTO.NoMonths);
                    lblCalFromDate.Text = dt1.AddMonths(-Converter.GetInteger(getDTO.NoMonths - 1)).ToString("dd/MM/yyyy");


                    DateTime dt2 = Converter.GetDateTime(Converter.GetDateToYYYYMMDD(lblCalFromDate.Text));
                    lblCalTillDate.Text = dt2.AddMonths(Converter.GetInteger(getDTO.NoMonths - 1)).ToString("dd/MM/yyyy");

                    lblTrnDesc.Text = ("Int.Benefit On" + " " + lblCalFromDate.Text + "-" + CtrlCalProvDate.Text);

                    //txtPayDesc3.Text = lblTrnDesc.Text;

                    CtrlBenefitFlag3.Text = "1";
                    VisibleTranAmt();
                    //}
                }
        ...
        private void InterestAmountFDR()
        {
            try
            {
                ...
                if (getDTO.NoRecord > 0)
                {
                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                    CtrlProvAdjCr.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.CalProvAdjCr))));
                    CtrlProvAdjDr.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.CalProvAdjDr))));

                    hdnCalIntRate.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.CalIntRate))));
                    hdnCalFDAmount.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.CalFDAmount))));
                    hdnCalOrgInt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.CalOrgInterest))));
                    hdnCalNofDays.Text = Converter.GetString(getDTO.CalNofDays);
                    hdnCalPeriod.Text = Converter.GetString(getDTO.CalPeriod);



                    DateTime dt = Converter.GetDateTime(getDTO.CalFDate);
                    string date = dt.ToString("dd/MM/yyyy");
                    hdnCalFDate.Text = date;
        ...
        private void NetEncashmentIntFDR()
        {
            try
            {
                ...
                {
                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                    CtrlMainAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                    VisibleTranAmt();
        ...
        private void BenefitAmountMSplus()
        {
            try
            {
                ...
                {
                    hdnCalOrgInt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.CalOrgInterest))));
                    hdnCalPaidInt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.CalPaidInterest))));
        ...
        private void NetEncashmentBenefitMSplus()
        {
            try
            {
                ...
                if (getDTO.NoRecord > 0)
                {
                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                    CtrlMainAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                    hdnAvailBenefit.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));

                    if (CtrlLogicAmt.Text == "0" || CtrlLogicAmt.Text == "00.00")
                    {
                        CashBenefitFlag.Text = "1";
                    }
        ...
        private void AdjustmentIntCrPension()
        {
            try
            {
                ...
                Int64 AccNumber = Converter.GetLong(txtAccNo.Text);
                int MemNumber = Converter.GetInteger(txtMemNo.Text);
                A2ZTRNLOGICDTO getDTO = (A2ZTRNLOGICDTO.GetInterestAdjCrPension(CuType, CuNo, MemNumber, Acctype, AccNumber));
                if (getDTO.NoRecord > 0)
                {
                    hdnCalPeriod.Text = Converter.GetString(getDTO.CalPeriod);
                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
        ...
        private void AdjustmentIntDrPension()
        {
            try
            {
                ...
                Int64 AccNumber = Converter.GetLong(txtAccNo.Text);
                int MemNumber = Converter.GetInteger(txtMemNo.Text);
                A2ZTRNLOGICDTO getDTO = (A2ZTRNLOGICDTO.GetInterestAdjDrPension(CuType, CuNo, MemNumber, Acctype, AccNumber));
                if (getDTO.NoRecord > 0)
                {
                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
        ...
        private void NetEncashmentPesion()
        {
            try
            {
                ...
                Int64 AccNumber = Converter.GetLong(txtAccNo.Text);
                int MemNumber = Converter.GetInteger(txtMemNo.Text);
                A2ZTRNLOGICDTO getDTO = (A2ZTRNLOGICDTO.GetNetEncashmentPension(CuType, CuNo, MemNumber, Acctype, AccNumber));
                if (getDTO.NoRecord > 0)
                {
                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(getDTO.LogicAmount))));
        ...
        private void ClosingFees()
        {
            try
            {
                Int16 AccType = Converter.GetSmallInteger(lblAccountType.Text);

                A2ZTRNLOGICDTO getDTO = (A2ZTRNLOGICDTO.GetClosingFees(AccType));
                if (getDTO.NoRecord > 0)
                {
                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", getDTO.LogicAmount));
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", getDTO.LogicAmount));
                    VisibleTranAmt();
                }
            }
        ...
        protected void ProvisionSettlement()
        {
            Decimal AdjProvAmt = 0;
            Decimal accProvAmount = Converter.GetDecimal(CtrlProvBenefit.Text);
            Decimal InterestAmt = Converter.GetDecimal(txtAmount1.Text);

            AdjProvAmt = Math.Round(InterestAmt - accProvAmount);

            if (AdjProvAmt == 0)
            {
                CtrlProvAdjCr.Text = "0";
                CtrlProvAdjDr.Text = "0";
            }

            if (AdjProvAmt > 0)
            {
                CtrlProvAdjCr.Text = Converter.GetString(AdjProvAmt);
                CtrlProvAdjDr.Text = "0";
            }
            ...
            {
                CtrlProvAdjCr.Text = "0";
                CtrlProvAdjDr.Text = Converter.GetString(Math.Abs(AdjProvAmt));
            }
        ...
        protected void AddNormal()
        {
            try
            {
                ...
                if (lblFuncOpt.Text == "11" || lblFuncOpt.Text == "12")
                {
                    if (hdnGLSubHead.Text == "10101000" || hdnGLSubHead.Text == "10106000" || hdnGLSubHead.Text == "20801000")
                    {
                        CtrlTrnType1.Text = "1";
                        txtTrnType1.Text = "Cash";
                ...
                if (CtrlRow.Text == "1")
                {
                    ...
                    if (CtrlHoldIntFlag.Text == "1")
                    {
                        CtrlDueIntAmt.Text = CtrlCurrIntAmt.Text;
                    }


                    if (CtrlBenefitFlag1.Text == "1" && lblBenefitMode.Text == string.Empty)
                    {
                        double Amount = Converter.GetDouble(txtAmount1.Text);
                        CtrlInterestAmt.Text = Converter.GetString(0 - Amount);

                    }
                    if (CtrlBenefitFlag1.Text == "1" && lblBenefitMode.Text == "1")
                    {
                        double Amount = Converter.GetDouble(txtAmount1.Text);
                        CtrlInterestAmt.Text = Converter.GetString(Amount);

                    }
                    else if (CtrlIntFlag.Text == "1" && (txtAmount2.Text == "00.00" || txtAmount2.Text == ""))
                    {
                    ...
                    if (CtrlAccAtyClass.Text == "4")
                    {
                        if (CtrlPenalFlag.Text == "1")
                        {
                            CtrlPenalAmt.Text = txtAmount2.Text;
                        }
                        else
                        {
                            CtrlPenalAmt.Text = "0";
                    ...
                    if (CtrlAccAtyClass.Text == "6")
                    {
                        if (CtrlPenalFlag.Text == "1" && (txtAmount2.Text == "00.00" || txtAmount2.Text == ""))
                        {
                            CtrlPenalAmt.Text = txtAmount3.Text;
                        }
                        else
                        {
                            CtrlPenalAmt.Text = "0";
                    ...
                    if (CtrlBenefitFlag1.Text == "1")
                    {
                        string sqlquery10 = "INSERT INTO  WF_Transaction(TrnDate,VchNo,TrnChqNo,CuType,CuNo,MemNo,AccType,AccNo,TrnCode,FuncOpt,FuncOptDes,TrnTypeCode,TrnTypeDes,TrnMode,PayTypeCode,PayTypeDes,TrnVchType,Credit,Debit,ShowInt,TrnInterestAmt,GLAccNoDR,GLAccNoCR,TrnCSGL,TrnFlag,GLAccNo,GLAmount,GLDebitAmt,GLCreditAmt,FromCashCode,TrnModule,ValueDate,TrnPayment,UserID,AccTypeMode)VALUES('" + opdate + "','" + txtVchNo.Text.Trim() + "','" + txtChqNo.Text.Trim() + "','" + lblCuType.Text + "','" + lblCuNo.Text + "','" + txtMemNo.Text + "','" + lblAccountType.Text + "','" + txtAccNo.Text + "','" + lblTrnCode.Text + "','" + lblFuncOpt.Text + "','" + lblTransFunction.Text + "','" + CtrlTrnType1.Text + "','" + txtTrnType1.Text + "','" + CtrlTrnMode1.Text + "','" + CtrlPayType1.Text + "','" + txtPayDesc1.Text + "','" + lblVchType.Text + "','" + "0" + "','" + "0" + "','" + CtrlShowInt.Text + "','" + CtrlInterestAmt.Text + "','" + CtrlGLAccNoDR.Text + "','" + CtrlGLAccNoCR.Text + "','" + CtrlTrnCSGL.Text + "','" + CtrlTrnFlag.Text + "','" + CtrlGLAccNo.Text + "','" + CtrlGLAmount.Text + "','" + CtrlGLDebitAmt.Text + "','" + CtrlGLCreditAmt.Text + "','" + lblCashCode.Text + "','" + CtrlModule.Text + "','" + valuedate + "','" + CtrlTrnPayment1.Text + "','" + lblID.Text + "','" + lblATypeMode.Text + "')";
                ...
                if (CtrlRow.Text == "2")
                {
                    ...
                    if (CtrlBenefitFlag2.Text == "1")
                    {
                        string sqlquery10 = "INSERT INTO  WF_Transaction(TrnDate,VchNo,TrnChqNo,CuType,CuNo,MemNo,AccType,AccNo,TrnCode,FuncOpt,FuncOptDes,TrnTypeCode,TrnTypeDes,TrnMode,PayTypeCode,PayTypeDes,TrnVchType,Credit,Debit,ShowInt,TrnInterestAmt,GLAccNoDR,GLAccNoCR,TrnCSGL,TrnFlag,GLAccNo,GLAmount,GLDebitAmt,GLCreditAmt,FromCashCode,TrnModule,ValueDate,TrnPayment,UserID,AccTypeMode)VALUES('" + opdate + "','" + txtVchNo.Text.Trim() + "','" + txtChqNo.Text.Trim() + "','" + lblCuType.Text + "','" + lblCuNo.Text + "','" + txtMemNo.Text + "','" + lblAccountType.Text + "','" + txtAccNo.Text + "','" + lblTrnCode.Text + "','" + lblFuncOpt.Text + "','" + lblTransFunction.Text + "','" + CtrlTrnType2.Text + "','" + txtTrnType2.Text + "','" + CtrlTrnMode2.Text + "','" + CtrlPayType2.Text + "','" + txtPayDesc2.Text + "','" + lblVchType.Text + "','" + "0" + "','" + "0" + "','" + CtrlShowInt.Text + "','" + CtrlInterestAmt.Text + "','" + CtrlGLAccNoDR.Text + "','" + CtrlGLAccNoCR.Text + "','" + CtrlTrnCSGL.Text + "','" + CtrlTrnFlag.Text + "','" + CtrlGLAccNo.Text + "','" + CtrlGLAmount.Text + "','" + CtrlGLDebitAmt.Text + "','" + CtrlGLCreditAmt.Text + "','" + lblCashCode.Text + "','" + CtrlModule.Text + "','" + valuedate + "','" + CtrlTrnPayment2.Text + "','" + lblID.Text + "','" + lblATypeMode.Text + "')";
                        int rowEffect10 = Converter.GetInteger(DataAccessLayer.BLL.CommonManager.Instance.ExecuteNonQuery(sqlquery10, "A2ZCSMCUS"));
                        if (rowEffect10 > 0)
                        {
                            //gvDetail();
                    ...
                    {
                        string sqlquery2 = "INSERT INTO  WF_Transaction(TrnDate,VchNo,TrnChqNo,CuType,CuNo,MemNo,AccType,AccNo,TrnCode,FuncOpt,FuncOptDes,TrnTypeCode,TrnTypeDes,TrnMode,PayTypeCode,PayTypeDes,TrnVchType,Credit,Debit,ShowInt,TrnInterestAmt,TrnPenalAmt,GLAccNoDR,GLAccNoCR,TrnCSGL,TrnFlag,GLAccNo,GLAmount,GLDebitAmt,GLCreditAmt,FromCashCode,TrnModule,TrnDueIntAmt,ValueDate,TrnPayment,UserID,CuName,MemName,AccTypeMode)VALUES('" + opdate + "','" + txtVchNo.Text.Trim() + "','" + txtChqNo.Text.Trim() + "','" + lblCuType.Text + "','" + lblCuNo.Text + "','" + txtMemNo.Text + "','" + lblAccountType.Text + "','" + txtAccNo.Text + "','" + lblTrnCode.Text + "','" + lblFuncOpt.Text + "','" + lblTransFunction.Text + "','" + CtrlTrnType2.Text + "','" + txtTrnType2.Text + "','" + CtrlTrnMode2.Text + "','" + CtrlPayType2.Text + "','" + txtPayDesc2.Text + "','" + lblVchType.Text + "','" + CtrlGLCreditAmt.Text + "','" + CtrlGLDebitAmt.Text + "','" + CtrlShowInt.Text + "','" + CtrlInterestAmt.Text + "','" + CtrlPenalAmt.Text + "','" + CtrlGLAccNoDR.Text + "','" + CtrlGLAccNoCR.Text + "','" + CtrlTrnCSGL.Text + "','" + CtrlTrnFlag.Text + "','" + CtrlGLAccNo.Text + "','" + CtrlGLAmount.Text + "','" + CtrlGLDebitAmt.Text + "','" + CtrlGLCreditAmt.Text + "','" + lblCashCode.Text + "','" + InputModule.Text + "','" + CtrlDueIntAmt.Text + "','" + valuedate + "','" + CtrlTrnPayment2.Text + "','" + lblID.Text + "','" + lblCuName.Text + "','" + lblMemName.Text + "','" + lblATypeMode.Text + "')";
                ...
                if (CtrlRow.Text == "3")
                {
                    ...
                    if (CtrlBenefitFlag3.Text == "1" && CashBenefitFlag.Text == "1")
                    {
                        CtrlGLAccNoDR.Text = "50107001";
                    }
                    ...
                    if (CtrlBenefitFlag3.Text == "1")
                    {
                        string sqlquery10 = "INSERT INTO  WF_Transaction(TrnDate,VchNo,TrnChqNo,CuType,CuNo,MemNo,AccType,AccNo,TrnCode,FuncOpt,FuncOptDes,TrnTypeCode,TrnTypeDes,TrnMode,PayTypeCode,PayTypeDes,TrnVchType,Credit,Debit,ShowInt,TrnInterestAmt,GLAccNoDR,GLAccNoCR,TrnCSGL,TrnFlag,GLAccNo,GLAmount,GLDebitAmt,GLCreditAmt,FromCashCode,TrnModule,ValueDate,TrnPayment,UserID,AccTypeMode)VALUES('" + opdate + "','" + txtVchNo.Text.Trim() + "','" + txtChqNo.Text.Trim() + "','" + lblCuType.Text + "','" + lblCuNo.Text + "','" + txtMemNo.Text + "','" + lblAccountType.Text + "','" + txtAccNo.Text + "','" + lblTrnCode.Text + "','" + lblFuncOpt.Text + "','" + lblTransFunction.Text + "','" + CtrlTrnType3.Text + "','" + txtTrnType3.Text + "','" + CtrlTrnMode3.Text + "','" + CtrlPayType3.Text + "','" + txtPayDesc3.Text + "','" + lblVchType.Text + "','" + "0" + "','" + "0" + "','" + CtrlShowInt.Text + "','" + CtrlInterestAmt.Text + "','" + CtrlGLAccNoDR.Text + "','" + CtrlGLAccNoCR.Text + "','" + CtrlTrnCSGL.Text + "','" + CtrlTrnFlag.Text + "','" + CtrlGLAccNo.Text + "','" + CtrlGLAmount.Text + "','" + CtrlGLDebitAmt.Text + "','" + CtrlGLCreditAmt.Text + "','" + lblCashCode.Text + "','" + CtrlModule.Text + "','" + valuedate + "','" + CtrlTrnPayment3.Text + "','" + lblID.Text + "','" + lblATypeMode.Text + "')";
                        int rowEffect10 = Converter.GetInteger(DataAccessLayer.BLL.CommonManager.Instance.ExecuteNonQuery(sqlquery10, "A2ZCSMCUS"));
                        if (rowEffect10 > 0)
                        {
                            //gvDetail();
                    ...
                    {
                        string sqlquery3 = "INSERT INTO  WF_Transaction(TrnDate,VchNo,TrnChqNo,CuType,CuNo,MemNo,AccType,AccNo,TrnCode,FuncOpt,FuncOptDes,TrnTypeCode,TrnTypeDes,TrnMode,PayTypeCode,PayTypeDes,TRnVchType,Credit,Debit,ShowInt,GLAccNoDR,GLAccNoCR,TrnCSGL,TrnFlag,GLAccNo,GLAmount,GLDebitAmt,GLCreditAmt,FromCashCode,TrnModule,ValueDate,TrnPayment,UserID,CuName,MemName,AccTypeMode)VALUES('" + opdate + "','" + txtVchNo.Text.Trim() + "','" + txtChqNo.Text.Trim() + "','" + lblCuType.Text + "','" + lblCuNo.Text + "','" + txtMemNo.Text + "','" + lblAccountType.Text + "','" + txtAccNo.Text + "','" + lblTrnCode.Text + "','" + lblFuncOpt.Text + "','" + lblTransFunction.Text + "','" + CtrlTrnType3.Text + "','" + txtTrnType3.Text + "','" + CtrlTrnMode3.Text + "','" + CtrlPayType3.Text + "','" + txtPayDesc3.Text + "','" + lblVchType.Text + "','" + CtrlGLCreditAmt.Text + "','" + CtrlGLDebitAmt.Text + "','" + CtrlShowInt.Text + "','" + CtrlGLAccNoDR.Text + "','" + CtrlGLAccNoCR.Text + "','" + CtrlTrnCSGL.Text + "','" + CtrlTrnFlag.Text + "','" + CtrlGLAccNo.Text + "','" + CtrlGLAmount.Text + "','" + CtrlGLDebitAmt.Text + "','" + CtrlGLCreditAmt.Text + "','" + lblCashCode.Text + "','" + InputModule.Text + "','" + valuedate + "','" + CtrlTrnPayment3.Text + "','" + lblID.Text + "','" + lblCuName.Text + "','" + lblMemName.Text + "','" + lblATypeMode.Text + "')";
                ...
                if (CtrlRow.Text == "4")
                {
                    ...
                    string sqlquery4 = "INSERT INTO  WF_Transaction(TrnDate,VchNo,TrnChqNo,CuType,CuNo,MemNo,AccType,AccNo,TrnCode,FuncOpt,FuncOptDes,TrnTypeCode,TrnTypeDes,TrnMode,PayTypeCode,PayTypeDes,TrnVchType,Credit,Debit,ShowInt,GLAccNoDR,GLAccNoCR,TrnCSGL,TrnFlag,GLAccNo,GLAmount,GLDebitAmt,GLCreditAmt,CalProvAdjCr,CalProvAdjDr,FromCashCode,TrnModule,ValueDate,TrnPayment,UserID,CuName,MemName,AccTypeMode)VALUES('" + opdate + "','" + txtVchNo.Text.Trim() + "','" + txtChqNo.Text.Trim() + "','" + lblCuType.Text + "','" + lblCuNo.Text + "','" + txtMemNo.Text + "','" + lblAccountType.Text + "','" + txtAccNo.Text + "','" + lblTrnCode.Text + "','" + lblFuncOpt.Text + "','" + lblTransFunction.Text + "','" + CtrlTrnType4.Text + "','" + txtTrnType4.Text + "','" + CtrlTrnMode4.Text + "','" + CtrlPayType4.Text + "','" + txtPayDesc4.Text + "','" + lblVchType.Text + "','" + CtrlGLCreditAmt.Text + "','" + CtrlGLDebitAmt.Text + "','" + CtrlShowInt.Text + "','" + CtrlGLAccNoDR.Text + "','" + CtrlGLAccNoCR.Text + "','" + CtrlTrnCSGL.Text + "','" + CtrlTrnFlag.Text + "','" + CtrlGLAccNo.Text + "','" + CtrlGLAmount.Text + "','" + CtrlGLDebitAmt.Text + "','" + CtrlGLCreditAmt.Text + "','" + CtrlProvAdjCr.Text + "','" + CtrlProvAdjDr.Text + "','" + lblCashCode.Text + "','" + InputModule.Text + "','" + valuedate + "','" + CtrlTrnPayment4.Text + "','" + lblID.Text + "','" + lblCuName.Text + "','" + lblMemName.Text + "','" + lblATypeMode.Text + "')";
        ...
        protected void txtAmount1_TextChanged(object sender, EventArgs e)
        {
            ...
            if (CtrlTrnLogic.Text == "4" || CtrlTrnLogic.Text == "5" || CtrlTrnLogic.Text == "8" || CtrlTrnLogic.Text == "9")
            {
                TrnValidity();
                if (CtrlFlag.Text == "1")
                {
                    AccessAmountMSG();
                    txtAmount1.Text = CtrlValidAmt.Text;
                    txtAmount1.Focus();
                }
            }
            ...
            if (CtrlTrnLogic.Text == "0" && (lblFuncOpt.Text == "03" && lblcls.Text != "7") || lblFuncOpt.Text == "04" || (lblFuncOpt.Text == "12" && lblcls.Text != "5" && lblcls.Text != "6"))
            {
                double Balance = Converter.GetDouble(CtrlAvailBal.Text);
                double LienAmt = Converter.GetDouble(CtrlLienAmt.Text);
                CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Balance - LienAmt)));
        ...
        protected void txtAmount3_TextChanged(object sender, EventArgs e)
        {
            ...
            if (lblcls.Text == "2" && lblFuncOpt.Text == "09")
            {
                double a = Converter.GetDouble(txtAmount3.Text);
                CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", a));
                CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(a))));
                txtAmount3.Text = Converter.GetString(String.Format("{0:0,0.00}", CtrlValidAmt.Text));
            ...
            if (lblcls.Text == "4" && lblFuncOpt.Text == "09")
            {
                double a = Converter.GetDouble(CtrlLadgerBalance.Text);
                double b = Converter.GetDouble(txtAmount1.Text);
                double c = Converter.GetDouble(txtAmount2.Text);
                double d = Converter.GetDouble(txtAmount3.Text);
                double g = ((a + b) - (c + d));

                txtAmount4.Text = Converter.GetString(String.Format("{0:0,0.00}", g));
            }

            if (lblcls.Text == "3" && lblFuncOpt.Text == "05")
            {
                double a = Converter.GetDouble(CtrlTranAmt.Text);
                double b = Converter.GetDouble(CtrlValidAmt.Text);

                if (a > b)
                {
                    ExcessBenefitWithdMSG();
                    txtAmount3.Text = CtrlValidAmt.Text;
                    txtAmount3.Focus();
                    return;
                }
        ...
        protected void txtAmount4_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                double a = Converter.GetDouble(CtrlLadgerBalance.Text);
                double b = Converter.GetDouble(txtAmount4.Text);
                double c = Converter.GetDouble(txtAmount3.Text);
                double d = ((a - b) - c);
                if (d < 0)
                {
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(d))));
                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(d))));
                ...
                {
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", d));
                    CtrlLogicAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", (Math.Abs(d))));
            ...
            if (lblcls.Text == "3" && lblFuncOpt.Text == "09")
            {
                double a = Converter.GetDouble(CtrlLadgerBalance.Text);
                double b = Converter.GetDouble(txtAmount4.Text);
                ...
                {
                    InvalidAmountMSG();
                    txtAmount4.Text = CtrlMainAmt.Text;
                    txtAmount4.Focus();
                    txtAmount4_TextChanged(null, null);
                }
                else
                {
                    CtrlValidAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", d));
        ...
        protected void BtnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtGLContraCode.Text == string.Empty && (lblFuncOpt.Text == "11" || lblFuncOpt.Text == "12"))
                {
                    txtGLContraCode.Focus();
                ...
                if ((ddlTrnType.SelectedValue == "2" && txtChqNo.Text.Trim() == string.Empty) || ((hdnGLSubHead.Text == "10106000" || hdnGLSubHead.Text == "20801000") && lblFuncOpt.Text != "12" && txtChqNo.Text.Trim() == string.Empty))
                {
                    txtChqNo.Focus();

                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Please Input Cheque No.');", true);
                    return;
                ...
                if (lblFuncOpt.Text == "03" || lblFuncOpt.Text == "05" || lblFuncOpt.Text == "07" || lblFuncOpt.Text == "09")
                {
                    CashGLAccBalance();
                    if (ErrMsg.Text == "1")
                    {
                ...
                if (ddlTrnType.Text == "2" || hdnGLSubHead.Text == "10106000" || hdnGLSubHead.Text == "20801000")
                {
                    lblVchType.Text = "C";
                }
                else
        ...
        protected void CashGLAccBalance()
        {
            ...
            {
                Code = Converter.GetInteger(lblCashCode.Text);
            }

            if (ddlTrnType.SelectedValue == "2")
            {
                Code = Converter.GetInteger(txtGLCashCode.Text);
            }
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                double InputAmt = Converter.GetDouble(txttotAmt.Text);
        ...
        protected void BtnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result == 0)
                {
                    ...
                    if (CtrlModule.Text != "06" && CtrlModule.Text != "07" && lblFuncOpt.Text != "11" && lblFuncOpt.Text != "12")
                    {
                        //GLCashCodeDropdown();
        ...
        protected void PrintTrnVoucher()
        {
            try
            {
                ...
                lblFuncOpt.Text == "09")
                {
                    ...
                    (hdnGLSubHead.Text == "10101000" || hdnGLSubHead.Text == "10106000" || hdnGLSubHead.Text == "20801000"))
                {
                    lblTrnTypeTitle.Text = "CASH";
                }
        ...
        protected void TrnDepositValidity()
        {
            ...
            if (CtrlAccAtyClass.Text == "4")
            {
                double b = Converter.GetDouble(CtrlMthDeposit.Text);
            ...
            if (CtrlAccAtyClass.Text == "4")
            {
                double MthDep = Converter.GetDouble(CtrlMthDeposit.Text);
                int Period = Converter.GetInteger(CtrlPeriod.Text);
                double TotDep = Converter.GetDouble(CtrlTotalDeposit.Text);
                double InpDep = Converter.GetDouble(CtrlTranAmt.Text);

                double TargetDepAmt = (MthDep * Period);
                double InputTotDep = (TotDep + InpDep);
                if (InputTotDep > TargetDepAmt)
                {
                    CtrlFlag.Text = "2";
                    return;
                }
        ...
        protected void TotalwithdrawalValue()
        {
            ...
            for (int i = 0; i < gvDetailInfo.Rows.Count; ++i)
            {
                ...
                Int16 Acctype = Converter.GetSmallInteger(lblAccountType);
                Int64 AccNumber = Converter.GetLong(txtAccNo.Text);
            ...
            TotalWithdrawal.Text = Convert.ToString(String.Format("{0:0,0.00}", TotWithdrawal));
        ...
        {
            CtrlFlag.Text = "0";
            double TrnAmt = Converter.GetDouble(CtrlTranAmt.Text);
        ...
        {
            if (lblFuncOpt.Text == "03" && ddlTrnType.SelectedValue == "3")
            {
                lblFuncOpt.Text = "04";
            }

            if (lblFuncOpt.Text == "04" && ddlTrnType.SelectedValue != "3")
            {
                lblFuncOpt.Text = "03";
            }

            if (lblFuncOpt.Text == "05" && ddlTrnType.SelectedValue == "3")
            {
                lblFuncOpt.Text = "06";
            }

            if (lblFuncOpt.Text == "06" && ddlTrnType.SelectedValue != "3")
            {
                lblFuncOpt.Text = "05";
            }

            if (lblFuncOpt.Text == "07" && ddlTrnType.SelectedValue == "3")
            {
                lblFuncOpt.Text = "08";
            }

            if (lblFuncOpt.Text == "08" && ddlTrnType.SelectedValue != "3")
            {
                lblFuncOpt.Text = "07";
            }

            if (lblFuncOpt.Text == "09" && ddlTrnType.SelectedValue == "3")
            {
                lblFuncOpt.Text = "10";
            }

            if (lblFuncOpt.Text == "10" && ddlTrnType.SelectedValue != "3")
            {
                lblFuncOpt.Text = "09";
            }
        ...
        protected void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            Session["StxtGLContraCode"] = txtGLContraCode.Text;
            Session["SddlGLContraCode"] = ddlGLContraCode.SelectedValue;
     ...
     "click", @"<script>window.open('CSGetStaffAccountNo.aspx','_blank');</script>", false);
        ...
        {
            txtChqNo.Text = Converter.GetString(txtChqNo.Text);
            txtGLCashCode.Focus();
        }
        ...
        protected void BtnCorrection_Click(object sender, EventArgs e)
        {
            ...
            BtnCBack.Visible = true;


            if (lblcls.Text == "4" && lblFuncOpt.Text == "01")
            {
                lblData1.ReadOnly = false;
                lblData2.ReadOnly = false;
                lblData4.ReadOnly = false;
                lblData5.ReadOnly = false;

                lblRmark1.Visible = true;
                lblRmark1.Text = "*";
                lblRmark2.Visible = true;
                lblRmark2.Text = "*";
                lblRmark4.Visible = true;
                lblRmark4.Text = "*";
                lblRmark5.Visible = true;
                lblRmark5.Text = "*";

                lblRmark1.ForeColor = Color.Green;
                lblRmark2.ForeColor = Color.Green;
                lblRmark4.ForeColor = Color.Green;
                lblRmark5.ForeColor = Color.Green;

                lblData1.BackColor = Color.LightGreen;
                lblData2.BackColor = Color.LightGreen;
                lblData4.BackColor = Color.LightGreen;
                lblData5.BackColor = Color.LightGreen;
            }
            ...
            if (lblcls.Text == "3" && lblFuncOpt.Text == "05")
            {
                ...
                lblData11.ReadOnly = false;
                lblRmark11.Visible = true;
                lblRmark11.Text = "*";
                lblRmark11.ForeColor = Color.Green;
                lblData11.BackColor = Color.LightGreen;
            }

            if (lblcls.Text == "2" && lblFuncOpt.Text == "05")
            {
                lblData7.ReadOnly = false;

                lblRmark7.Visible = true;
                lblRmark7.Text = "*";
                lblRmark7.ForeColor = Color.Green;
                lblData7.BackColor = Color.LightGreen;
            }
        }
        ...
        protected void DepositAmtValidity()
        {
            ...
            A = Converter.GetDouble(lblData5.Text);
            int TrnAmt = Converter.GetInteger(A);
        ...
        protected void PeriodSlab1()
        {
            try
            {
                ...
                double b = Converter.GetDouble(lblAccDepRoundingBy.Text);
                double depAmount = Converter.GetDouble(lblData5.Text);
                ...
                int accType = Converter.GetInteger(lblAccountType.Text);
                Int16 SlabFlag = Converter.GetSmallInteger(lblMemType.Text);

                Int16 period = Converter.GetSmallInteger(lblData4.Text);
                A2ZPENSIONDTO getDTO = (A2ZPENSIONDTO.GetInformation(accType, SlabFlag, depAmount, period));

                if (getDTO.NoRecord > 0)
                {
                    lblMatureAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", getDTO.MaturedAmount));

                    if (RoundingByFlag.Text == "1")
                    {
                        double NoRBy = Converter.GetDouble(NoRoundingBy.Text);
                        double MAmount = Converter.GetDouble(lblMatureAmt.Text);
                        double NMAmount = Converter.GetDouble(MAmount * NoRBy);
                        lblMatureAmt.Text = Converter.GetString(String.Format("{0:0,0.00}", NMAmount));
                    }
                }
                else
                {
        ...
        protected void BtnCUpdate_Click(object sender, EventArgs e)
        {
            if (lblcls.Text == "4" && lblFuncOpt.Text == "01")
            {
                string input1 = Converter.GetString(lblData1.Text).Length.ToString();
                if (input1 != "10")
                {
                    lblData1.Text = CtrlOpenDate.Text;
                    lblData1.Focus();
                ...
                string input2 = Converter.GetString(lblData2.Text).Length.ToString();
                if (input2 != "10")
                {
                    lblData2.Text = CtrlLastTrnDate.Text;
                    lblData2.Focus();
                ...
                var prm = new object[6];
                prm[0] = txtAccNo.Text;
                prm[1] = Converter.GetDateToYYYYMMDD(lblData1.Text);
                prm[2] = Converter.GetDateToYYYYMMDD(lblData2.Text);
                prm[3] = lblData4.Text;
                prm[4] = lblData5.Text;
                prm[5] = lblMatureAmt.Text;

                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("Sp_CSReUpdateAccountInfo", prm, "A2ZCSMCUS"));
                ...
                if (accgetDTO.a > 0)
                {
                    ...
                    lblRmark1.Visible = false;
                    lblRmark2.Visible = false;
                    lblRmark4.Visible = false;
                    lblRmark5.Visible = false;

                    lblData1.BackColor = Color.White;
                    lblData2.BackColor = Color.White;
                    lblData4.BackColor = Color.White;
                    lblData5.BackColor = Color.White;
            ...
            if (lblcls.Text == "2" && lblFuncOpt.Text == "05")
            {
                string strQuery = "UPDATE A2ZACCOUNT SET  AccPrincipal = '" + lblData7.Text + "' WHERE AccNo='" + txtAccNo.Text + "' ";
                ...
                lblData7.ReadOnly = true;
                lblRmark7.Visible = false;
                lblData7.BackColor = Color.White;
            ...
            if (lblcls.Text == "3" && lblFuncOpt.Text == "05")
            {
                ...
                prm[0] = txtAccNo.Text;
                prm[1] = lblData4.Text;
                prm[2] = lblData11.Text;
                prm[3] = lblData5.Text;

                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("Sp_CSReUpdateMSPAccountInfo", prm, "A2ZCSMCUS"));
                ...
                lblData11.ReadOnly = true;
                lblRmark11.Visible = false;
                lblData11.BackColor = Color.White;
        ...
        protected void BtnCBack_Click(object sender, EventArgs e)
        {
            if (lblcls.Text == "4")
            {
                Int64 AccNumber = Converter.GetLong(txtAccNo.Text);
                ...
                if (accgetDTO.a > 0)
                {
                    ...
                    lblData4.BackColor = Color.White;
                    lblData5.BackColor = Color.White;
                    lblData6.BackColor = Color.White;
                    lblData7.BackColor = Color.White;
        ...
        {
            if (lblBalData.Visible == true)
            {
                if (lblcls.Text == "2")
                {
                    lblRec1.Text = "Provision Balance :";
                    lblData1.Text = CtrlProvAmt.Text;

                    lblRec1.Style.Add("visibility", "none");
                    lblData1.Style.Add("visibility", "none");

                    lblBalData.Visible = false;

                    lblBalRec.Style.Add("visibility", "hidden");
                    lblBalData.Style.Add("visibility", "hidden");

                    lblUnPostCr.Style.Add("visibility", "hidden");
                    lblUnPostDataCr.Style.Add("visibility", "hidden");
                    lblUnPostDr.Style.Add("visibility", "hidden");
                    lblUnPostDataDr.Style.Add("visibility", "hidden");

                    lblRec2.Style.Add("visibility", "hidden");
                    lblData2.Style.Add("visibility", "hidden");
                    lblRec3.Style.Add("visibility", "hidden");
                    lblData3.Style.Add("visibility", "hidden");
                    lblRec4.Style.Add("visibility", "hidden");
                    lblData4.Style.Add("visibility", "hidden");
                    lblRec5.Style.Add("visibility", "hidden");
                    lblData5.Style.Add("visibility", "hidden");
                    lblRec6.Style.Add("visibility", "hidden");
                    lblData6.Style.Add("visibility", "hidden");
                    lblRec7.Style.Add("visibility", "hidden");
                    lblData7.Style.Add("visibility", "hidden");
                    lblRec8.Style.Add("visibility", "hidden");
                    lblData8.Style.Add("visibility", "hidden");
                    lblRec9.Style.Add("visibility", "hidden");
                    lblData9.Style.Add("visibility", "hidden");
                    lblRec10.Style.Add("visibility", "hidden");
                    lblData10.Style.Add("visibility", "hidden");
                    lblRec11.Style.Add("visibility", "hidden");
                    lblData11.Style.Add("visibility", "hidden");
                }
            }
            else
            {
                ...
                {
                    lblBalData.Visible = true;
                    lblBalRec.Style.Add("visibility", "none");
                    lblBalData.Style.Add("visibility", "none");

                    lblUnPostCr.Style.Add("visibility", "none");
                    lblUnPostDataCr.Style.Add("visibility", "none");
                    lblUnPostDr.Style.Add("visibility", "none");
                    lblUnPostDataDr.Style.Add("visibility", "none");

                    lblRec1.Style.Add("visibility", "none");
                    lblData1.Style.Add("visibility", "none");
                    lblRec2.Style.Add("visibility", "none");
                    lblData2.Style.Add("visibility", "none");
                    lblRec3.Style.Add("visibility", "none");
                    lblData3.Style.Add("visibility", "none");
                    lblRec4.Style.Add("visibility", "none");
                    lblData4.Style.Add("visibility", "none");
                    lblRec5.Style.Add("visibility", "none");
                    lblData5.Style.Add("visibility", "none");
                    lblRec6.Style.Add("visibility", "none");
                    lblData6.Style.Add("visibility", "none");
                    lblRec7.Style.Add("visibility", "none");
                    lblData7.Style.Add("visibility", "none");
                    lblRec8.Style.Add("visibility", "none");
                    lblData8.Style.Add("visibility", "none");
                    lblRec9.Style.Add("visibility", "none");
                    lblData9.Style.Add("visibility", "none");
                    lblRec10.Style.Add("visibility", "none");
                    lblData10.Style.Add("visibility", "none");
                    lblRec11.Style.Add("visibility", "none");
                    lblData11.Style.Add("visibility", "none");
