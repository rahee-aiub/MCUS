<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSAutoMonthlyBenefit.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSAutoMonthlyBenefit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Auto Monthly Benefit Processing
                    </th>
                </tr>
            </thead>
    ...
    <div align="left" class="grid_scroll">
        <asp:GridView ID="gvDetailInfo" runat="server" HeaderStyle-CssClass="FixedHeader" HeaderStyle-BackColor="YellowGreen"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Last Benefit" DataField="CalBenefitDate" HeaderStyle-Width="90px" ItemStyle-Width="90px" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center" DataFormatString="{0:dd/MM/yyyy}" />
                <asp:BoundField HeaderText="FD Amount" DataField="AccFixedAmt" DataFormatString="{0:0,0.00}" HeaderStyle-Width="140px" ItemStyle-Width="140px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right" />
                <asp:BoundField HeaderText="Benefit Amount" DataField="CalBenefit" DataFormatString="{0:0,0.00}" HeaderStyle-Width="140px" ItemStyle-Width="140px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right"/>
    ...
    <br />
     <div align="right" style="width: 1290px; height: 24px;">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="txtTotalBenfitAmt" runat="server" Font-Size="Medium" ForeColor="Black" Font-Bold="True"></asp:Label>
        &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
             &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
