<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/HRMasterPage.Master" AutoEventWireup="true" CodeBehind="HREmpLeaveCheck.aspx.cs" Inherits="ATOZWEBMCUS.Pages.HREmpLeaveCheck" %>
   ...
   <%-- <script language="javascript" type="text/javascript">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ApproveValidation() {
            return confirm('Do you want to Check Data?');
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <tr>
                <th colspan="4">
                    <p align="center" style="color: blue">
                        Check Emloyee's Leave Application
                    </p>
                </th>
            </tr>
        </table>
    ...
    <div id="Div1" runat="server" align="center">
        <table>
            <tr>
                <td colspan="6" align="center">
                    <asp:Button ID="btnApproved" runat="server" Text="Check" Font-Size="Large" ForeColor="#FFFFCC"
    ...
    <div align="center">
        <asp:Label ID="lblmsg1" runat="server" Text="All Record Check Successfully Completed" Font-Bold="True" Font-Size="XX-Large" ForeColor="#009933"></asp:Label><br />
        <asp:Label ID="lblmsg2" runat="server" Text="No More Record for Check" Font-Bold="True" Font-Size="XX-Large" ForeColor="#009933"></asp:Label>
    </div>
