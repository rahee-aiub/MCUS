<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/HRMasterPage.Master" AutoEventWireup="true" CodeBehind="HRBankAdviseReport.aspx.cs" Inherits="ATOZWEBMCUS.Pages.HRBankAdviseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3" class="auto-style1">Monthly Bank Advise
                    </th>
                </tr>
            </thead>
            ...
            <tr>
                ...
                <td class="auto-style1">
                    ...
                    <asp:Label ID="lblBank" runat="server" Text="Bank :" Font-Size="Large" ForeColor="Red"></asp:Label>

                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="ddlBank" runat="server" Height="25px" Width="300px" CssClass="cls text" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large">
                    </asp:DropDownList>
