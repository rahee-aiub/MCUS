<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSDailyTransaction.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSDailyTransaction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
                    ...
                    <table class="style1">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="txtOldCuNo" runat="server" CssClass="cls text" Width="100px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" Font-Size="Medium" AutoPostBack="True" OnTextChanged="txtOldCuNo_TextChanged" TabIndex="20"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                 <asp:TextBox ID="txtVchNo" runat="server" CssClass="cls text" Width="90px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" Font-Size="Medium" TabIndex="1"></asp:TextBox> 
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <asp:TextBox ID="txtOldMemNo" runat="server" CssClass="cls text" Width="100px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" Font-Size="Medium" AutoPostBack="True" OnTextChanged="txtOldMemNo_TextChanged" TabIndex="21" ></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtCreditUNo" runat="server" CssClass="cls text" Width="90px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Medium" AutoPostBack="true" ToolTip="Enter Code" OnTextChanged="txtCreditUNo_TextChanged" TabIndex="2"></asp:TextBox>
                                <asp:Label ID="lblCuName" runat="server" Text=""></asp:Label>
                                <asp:DropDownList ID="ddlCreditUNo" runat="server" Height="24px" Width="410px" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Medium" OnSelectedIndexChanged="ddlCreditUNo_SelectedIndexChanged">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtMemNo" runat="server" CssClass="cls text" Width="90px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    ...
                                    OnTextChanged="txtMemNo_TextChanged" TabIndex="3"></asp:TextBox>
                                <asp:Label ID="lblMemName" runat="server" Text=""></asp:Label>
                                <asp:DropDownList ID="ddlMemNo" runat="server" Height="24px" Width="410px" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Medium" OnSelectedIndexChanged="ddlMemNo_SelectedIndexChanged">
                                    <asp:ListItem Value="0">-Select-</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList
                                    ID="ddlTrnType" runat="server" Height="25px" Width="90px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Medium" OnSelectedIndexChanged="ddlTrnType_SelectedIndexChanged" AutoPostBack="True" TabIndex="4">
                                ...
                                <asp:TextBox ID="txtChqNo" runat="server" CssClass="cls text" Width="150px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Medium" TabIndex="5"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtGLCashCode" runat="server" CssClass="cls text" Width="90px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Medium" OnTextChanged="txtGLCashCode_TextChanged" AutoPostBack="True" TabIndex="6"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtGLContraCode" runat="server" CssClass="cls text" Width="90px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Medium" AutoPostBack="True" OnTextChanged="txtGLContraCode_TextChanged" TabIndex="7"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtTrnCode" runat="server" CssClass="cls text" Width="90px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Medium" AutoPostBack="true" ToolTip="Enter Code" OnTextChanged="txtTrnCode_TextChanged" TabIndex="8"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="txtAccNo" runat="server" CssClass="cls text" Width="150px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Medium" AutoPostBack="True" ToolTip="Enter Code" onkeypress="return functionx(event)" OnTextChanged="txtAccNo_TextChanged" TabIndex="9"></asp:TextBox>
            ...
            <td>
                <table class="style1">
                    <tr>
                        ...
                        <asp:TextBox ID="txtAmount1" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="110px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" OnTextChanged="txtAmount1_TextChanged" AutoPostBack="True"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                    ...
                    <asp:TextBox ID="txtPayDesc2" runat="server" Style="text-align: left" Font-Size="Medium" CssClass="cls text" Width="481px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"></asp:TextBox>
                                        ...
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="txtAmount2" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="110px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" AutoPostBack="True" OnTextChanged="txtAmount2_TextChanged"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                     ...
                     <asp:TextBox ID="txtPayDesc3" runat="server" Style="text-align: left" Font-Size="Medium" CssClass="cls text" Width="481px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"></asp:TextBox>
                                        ...
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="txtAmount3" runat="server" Style="text-align: right" Font-Size="Medium" Width="110px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" CssClass="cls text" AutoPostBack="True" OnTextChanged="txtAmount3_TextChanged"></asp:TextBox>
                                        </td>
                                    </tr>
    ...
    <asp:HiddenField ID="hdnGrpFlag" runat="server" />
    ...
    <asp:HiddenField ID="CtrlDueIntFlag" runat="server" />
    ...
    <asp:HiddenField ID="hdnTotRec" runat="server" />
    <asp:HiddenField ID="hdnID" runat="server" />
    <asp:HiddenField ID="hdnCashCode" runat="server" />

    <asp:HiddenField ID="hdnContraCode" runat="server" />

    <asp:HiddenField ID="hdnContraHead1" runat="server" />
    <asp:HiddenField ID="hdnContraHead2" runat="server" />
    <asp:HiddenField ID="hdnContraHead3" runat="server" />
    <asp:HiddenField ID="hdnContraHead4" runat="server" />

    <%--<asp:HiddenField ID="hdnCuNumber" runat="server" />--%>
    <asp:HiddenField ID="hdnAccMulty" runat="server" />
