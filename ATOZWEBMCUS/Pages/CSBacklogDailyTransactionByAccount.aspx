<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSBacklogDailyTransactionByAccount.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSBacklogDailyTransactionByAccount" %>
                ...
                <td>
                    <table class="style1">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtVchNo" runat="server" TabIndex="1" CssClass="cls text" Width="90px" Height="25px" onkeydown="return (event.keyCode !=13);" BorderColor="#1293D1" BorderStyle="Ridge" Font-Size="Medium"></asp:TextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="BtnNew" runat="server" Text="New" Font-Size="Medium" ForeColor="Red"
                                    Font-Bold="True" CssClass="button green" ToolTip="Open New Account No." OnClick="BtnNew_Click" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtGLContraCode" runat="server" TabIndex="8" CssClass="cls text" Width="90px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                    ...
                    <table class="style1">
                        ...
                        <tr>
                            ...
                            <td class="auto-style1">
                                <asp:TextBox ID="lblData1" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="115px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                            ...
                            <td>
                                <asp:TextBox ID="lblBalData" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="115px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    ForeColor="Black"></asp:TextBox>&nbsp;&nbsp;
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="auto-style1">
                                <asp:TextBox ID="lblData2" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="115px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    ForeColor="Black"></asp:TextBox>&nbsp;&nbsp;
                        ...
                        <tr>
                            ...
                            <td class="auto-style1">
                                <asp:TextBox ID="lblData3" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="115px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    ForeColor="Black"></asp:TextBox>&nbsp;&nbsp;
                        ...
                        <tr>
                            ...
                            <td class="auto-style1">
                                <asp:TextBox ID="lblData4" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="115px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    ForeColor="Black"></asp:TextBox>&nbsp;&nbsp;
                            ...
                            <td>
                                <asp:TextBox ID="lblData11" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="115px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    ForeColor="Black"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="auto-style3">
                                <asp:TextBox ID="lblData5" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="115px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    ForeColor="Black"></asp:TextBox>&nbsp;&nbsp;
                            ...
                            <td>
                                <asp:TextBox ID="lblData9" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="115px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    ForeColor="Black"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="auto-style1">
                                <asp:TextBox ID="lblData6" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="115px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    ForeColor="Black"></asp:TextBox>&nbsp;&nbsp;
                            ...
                            <td>
                                <asp:TextBox ID="lblData10" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="115px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    ForeColor="Black"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="auto-style1">
                                <asp:TextBox ID="lblData7" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="115px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    ForeColor="Black"></asp:TextBox>&nbsp;&nbsp;
                                <asp:Label ID="lblRec8" runat="server" Text="" Font-Size="Medium"
                                    ForeColor="Red"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="lblData8" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="115px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    ForeColor="Black"></asp:TextBox>
                    ...
                    <asp:Button ID="BtnCancel" runat="server" Text="Cancel" Font-Size="Medium" ForeColor="#FFFFCC"
                        ...
                        CssClass="button red" OnClick="BtnCancel_Click" />&nbsp;
                                            <asp:Button ID="BtnViewImage" runat="server" Text="View Image" Font-Bold="True" Font-Size="Medium"
                                                ForeColor="White" CssClass="button green" Height="27px" Width="120px" OnClick="BtnViewImage_Click" />
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
