<%@ Page Title="DeductionCodeMaintenance" Language="C#" MasterPageFile="~/MasterPages/HRMasterPage.Master" AutoEventWireup="true" CodeBehind="HRDeductionCodeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.HRDeductionCodeMaintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            ...
            <tr>
                <td>
                    <asp:Label ID="lblcode" runat="server" Text="Deduction Code:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    ...
                    <asp:DropDownList ID="ddlDeduction" runat="server" Height="25px" 
                        Width="316px" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large" OnSelectedIndexChanged="ddlDeduction_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
