...
{
    public partial class HREmpLeaveApprove : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    //else
                    {
                        ...
                        string CheckQuery = "SELECT EmpCode,A2ZEMPLEAVETYPE.EmpleaveName,LStartDate,LEndDate,LApplyDays,LBalance from A2ZEMPLEAVE inner join A2ZEMPLEAVETYPE on A2ZEMPLEAVETYPE.EmpleaveCode=A2ZEMPLEAVE.EmpleaveCode where LProcStat='3'";
        ...
        protected void BtnApproved_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string CheckUp = "UPDATE A2ZEMPLEAVE SET LProcStat=4,ApprovBy = '" + ApprovBy + "',ApprovByDate = '" + ApprovByDate + "' where Id='" + CtrlId.Text + "'";
                ...
                if (rowEffect > 0)
                {
                    ...
                    gv1Verify();
                    string CheckQuery = "SELECT EmpCode from A2ZEMPLEAVE where LProcStat='3'";
