<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSDailyTransactionByDeposit.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSDailyTransactionByDeposit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
                        ...
                        <tr>
                            ...
                            <td class="auto-style1">
                                <asp:TextBox ID="lblData1" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" Width="125px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    ForeColor="Black" AutoPostBack="true" OnTextChanged="lblData1_TextChanged"></asp:TextBox>&nbsp;&nbsp;
                ...
                <table>
                    <tr>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;
                                            ...
                                            <asp:TextBox ID="txtPayDesc1" runat="server" Style="text-align: left" Font-Size="Medium" CssClass="cls text" Width="450px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"></asp:TextBox>
                        ...
                        <asp:TextBox ID="txtAmount1" runat="server" Style="text-align: right" Font-Size="Medium" TabIndex="9" CssClass="cls text" Width="110px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" OnTextChanged="txtAmount1_TextChanged" AutoPostBack="True" onFocus="javascript:this.select();" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
                                            <asp:CheckBox ID="chkAmt1" runat="server" Font-Size="Medium" ForeColor="Red" Text="" OnTextChanged="chkAmt1_TextChanged" AutoPostBack="True" OnCheckedChanged="chkAmt1_CheckedChanged" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="txtPayDesc2" runat="server" Style="text-align: left" Font-Size="Medium" CssClass="cls text" Width="450px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"></asp:TextBox>
                    ...
                    <asp:TextBox ID="txtAmount2" runat="server" Style="text-align: right" Font-Size="Medium" CssClass="cls text" TabIndex="10" Width="110px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" AutoPostBack="True" OnTextChanged="txtAmount2_TextChanged" onFocus="javascript:this.select();" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
                                            <asp:CheckBox ID="chkAmt2" runat="server" Font-Size="Medium" ForeColor="Red" Text="" OnTextChanged="chkAmt2_TextChanged" AutoPostBack="True" OnCheckedChanged="chkAmt2_CheckedChanged" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;
                     <asp:TextBox ID="txtPayDesc3" runat="server" Style="text-align: left" Font-Size="Medium" CssClass="cls text" Width="450px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"></asp:TextBox>
                        ...
                        <asp:TextBox ID="txtAmount3" runat="server" Style="text-align: right" Font-Size="Medium" TabIndex="11" Width="110px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" CssClass="cls text" AutoPostBack="True" OnTextChanged="txtAmount3_TextChanged" onFocus="javascript:this.select();" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
                                            <asp:CheckBox ID="chkAmt3" runat="server" Font-Size="Medium" ForeColor="Red" Text="" OnTextChanged="chkAmt3_TextChanged" AutoPostBack="True" OnCheckedChanged="chkAmt3_CheckedChanged" />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="txtPayDesc4" runat="server" Style="text-align: left" Font-Size="Medium" CssClass="cls text" Width="450px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"></asp:TextBox>
                        ...
                        <asp:TextBox ID="txtAmount4" runat="server" Style="text-align: right" Font-Size="Medium" TabIndex="12" Width="110px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" CssClass="cls text" AutoPostBack="True" OnTextChanged="txtAmount4_TextChanged" onFocus="javascript:this.select();" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
                                            <asp:CheckBox ID="chkAmt4" runat="server" Font-Size="Medium" ForeColor="Red" Text="" OnTextChanged="chkAmt4_TextChanged" AutoPostBack="True" OnCheckedChanged="chkAmt4_CheckedChanged" />
                                        </td>
                                    </tr>
                ...
                <div align="left" class="grid_scroll">
                    <asp:GridView ID="gvDetailInfo" runat="server" HeaderStyle-CssClass="FixedHeader" HeaderStyle-BackColor="YellowGreen"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Description" DataField="PayTypeDes" HeaderStyle-Width="220px" ItemStyle-Width="280px" ItemStyle-HorizontalAlign="left" />
    ...
    <asp:Label ID="txtGLCashCode" runat="server" Text="" Visible="false"></asp:Label>

    <asp:Label ID="CtrlTrnFlag1" runat="server" Text="" Visible="false"></asp:Label>
    <asp:Label ID="CtrlTrnFlag2" runat="server" Text="" Visible="false"></asp:Label>
    <asp:Label ID="CtrlTrnFlag3" runat="server" Text="" Visible="false"></asp:Label>
    <asp:Label ID="CtrlTrnFlag4" runat="server" Text="" Visible="false"></asp:Label>

    <asp:Label ID="CtrlLastIntDate" runat="server" Text="" Visible="false"></asp:Label>
    <asp:Label ID="lblOrgOpenDate" runat="server" Text="" Visible="false"></asp:Label>
