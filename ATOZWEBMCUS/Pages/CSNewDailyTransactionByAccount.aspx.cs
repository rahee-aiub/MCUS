...
{
    public partial class CSNewDailyTransactionByAccount : System.Web.UI.Page
    {
        ...
        protected void AccGetInfo()
        {
            try
            {
                ...
                else
                {
                    ...
                    if (CtrlAccStatus.Text == "98" || CtrlAccStatus.Text == "99" || (CtrlAccStatus.Text == "50" && lblFuncOpt.Text != "01" && lblFuncOpt.Text != "05"))
                    {
     ...
     "click", @"<script>window.open('CSGetStaffAccountNo.aspx','_blank');</script>", false);
        ...
        protected void txtMemNo_TextChanged(object sender, EventArgs e)
        {
            ...
            if (chkOldMemNo.Checked == true)
            {
                int MemNumber = Converter.GetInteger(txtMemNo.Text);
                int CuNumber = Converter.GetInteger(txtCreditUNo.Text);
        ...
        protected void gvGroupAccInfo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtAccNo.Text = row.Cells[2].Text;
