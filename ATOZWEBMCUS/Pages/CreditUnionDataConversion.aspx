 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreditUnionDataConversion.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CreditUnionDataConversion" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="lblTbName" runat="server" Text=" Source Table Name:" Font-Size="X-Large"
                        ForeColor="Black"></asp:Label>
                    <asp:Label ID="lbltname" runat="server" Text="A2ZCRUNION" Font-Size="X-Large"
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:Label ID="Label3" runat="server" Text=" Convert Table Name:" Font-Size="X-Large"
                        ForeColor="Black"></asp:Label>
                    <asp:Label ID="Label4" runat="server" Text="A2ZCUNION" Font-Size="X-Large"
                        ForeColor="Red"></asp:Label>
                </td>
            </tr>
