<%@ Page Language="C#" MasterPageFile="~/MasterPages/INVMasterPage.Master" AutoEventWireup="true" CodeBehind="STIssueUsedTransaction.aspx.cs" Inherits="ATOZWEBMCUS.Pages.STIssueUsedTransaction" Title="Issue Used Maintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="4">Stock Use Transaction
                    </th>
                </tr>
            ...
            <table class="style1">
                <tr>
                    ...
                    <td>
                        <h3>
                            &nbsp;
                            <asp:Label ID="Label13" runat="server" Text="    Qty.Use" ForeColor="Red"></asp:Label></h3>
