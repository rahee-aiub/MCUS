...
namespace ATOZWEBMCUS.Pages
{
    public partial class CSTransactionList : System.Web.UI.Page
    {
        ...
        private void Func99dropdown()
        {
            ...
            gv99Func = DataAccessLayer.BLL.CommonManager.Instance.FillGridViewList(sqlquery, gv99Func, "A2ZCSMCUS");
        }
...
//====================  END OF NEW LOGIC ==============
                ...
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.ACCTYPE, accType);

                //SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.CUPTYE, 0);

                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_ACC_CLASS, 0);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_FUNC_99, 0);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_F_CASH_CODE, 0);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_TRN_TYPE, 0);

                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_TELLER, 0);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_TRN_MODE, 0);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_TRN_NATURE, 0);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_TRN_MODULE, 0);
        ...
        private void Update99FuncCode()
        {
            ...
            strQuery = "DELETE FROM WF99FUNC WHERE UserId = '" + lblID.Text  + "'";
            result = Converter.GetSmallInteger(DataAccessLayer.BLL.CommonManager.Instance.ExecuteNonQuery(strQuery, "A2ZCSMCUS"));


            i = 0;
            foreach (GridViewRow gv in gv99Func.Rows)
            {
                Boolean m = ((CheckBox)gv99Func.Rows[i].FindControl("chkSelect")).Checked;

                if (m)
                {
                    strQuery = "INSERT INTO WF99FUNC (Func99Code,UserId) VALUES ('" + gv99Func.Rows[i].Cells[1].Text + "','" + lblID.Text + "')";
                    result = Converter.GetSmallInteger(DataAccessLayer.BLL.CommonManager.Instance.ExecuteNonQuery(strQuery, "A2ZCSMCUS"));
                }
                i++;
            }
        ...
        protected void ShowMultiTransactionList()
        {
            ...
            if (ddlTrans.SelectedValue == "1")
            {
                ...
                {
                    lblAutoVchNo.Text = "ProvisionFDR";
                }
                else if (ddlSysTrans.SelectedValue == "3")
                {
                    lblAutoVchNo.Text = "Provision6YR";
            ...
            SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NO6, Converter.GetInteger(lblTrans.Text));
            ...
            if (txtAccType.Text == string.Empty)
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.ACCTYPE, 0);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NAME1, "All Account Type ");
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NO1, 0);
            }
            else
            {
                ...
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NAME1, ddlAcType.SelectedItem.Text);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NO1, Converter.GetSmallInteger(txtAccType.Text));
            }

            if (lblAccClass.Text == string.Empty)
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_ACC_CLASS, 0);    
            }
            else
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_ACC_CLASS, lblAccClass.Text);
            }

            if (txtAccType.Text == "99" && ChkAll99Func.Checked == true)
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_FUNC_99, 0);
            }
            else if (txtAccType.Text == "99" && ChkAll99Func.Checked == false)
            {
                Update99FuncCode();
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_FUNC_99, 1);
            }
            else
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_FUNC_99, 0);
            ...
            if (lblCuType.Text == string.Empty)
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.CUPTYE, 0);
            }
            else
            ...
            else
            {
                ...
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NAME2, ddlCreditUNo.SelectedItem.Text);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NO2, txtCreditUNo.Text);
            }

            if (txtFCashCode.Text == string.Empty)
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_F_CASH_CODE, Cashcode);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NAME3, "All");
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NO3, 0);
            }
            else
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_F_CASH_CODE, Cashcode);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NAME3, Cashcode);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NO3, Cashcode);
            }

            if (txtTrnType.Text == string.Empty)
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_TRN_TYPE, 0);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NAME4, "All ");
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NO4, 0);
            ...
            else
            {
                ...
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NAME4, txtTrnType.Text);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NO4, txtTrnType.Text);
            }
            ...
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_TELLER, txtTeller.Text);
            }

            if (txtTrnMode.Text == string.Empty)
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_TRN_MODE, 0);
            }
            else
            ...
            if (txtTrnNature.Text == string.Empty)
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_TRN_NATURE, 0);
            }
            else
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_TRN_NATURE, txtTrnNature.Text);
            }
            ...
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_TRN_MODULE, txtTrnMode.Text);
            }
            ...
            else if (ddlTrans.SelectedValue == "1")
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_TRAN_SW, 1);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NO7, ddlSysTrans.SelectedValue);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.VOUCHER_NO, lblAutoVchNo.Text);

            }
            else if (ddlTrans.SelectedValue == "2")
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_TRAN_SW, 2);
            ...
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_USER_ID, lblID.Text);
            }
            ...
            if (lblModule.Text != "4" && ChkValueDate.Checked == false && ChkVchWise.Checked == false)
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.REPORT_FILE_NAME_KEY, "rptMCSTransactionDetailList");
            }            

            if (lblModule.Text != "4" && ChkValueDate.Checked == false && ChkVchWise.Checked == true)
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.REPORT_FILE_NAME_KEY, "rptMCSTransactionDetailListByVch");
            }

            if (lblModule.Text != "4" && ChkValueDate.Checked == true && ChkVchWise.Checked == false)
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.REPORT_FILE_NAME_KEY, "rptMCSTransactionValueDtDetailList");
            }

            if (lblModule.Text == "4")
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.MU_TRN_MODULE, 4);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.REPORT_FILE_NAME_KEY, "rptMStaffTransactionDetailList");
            }
