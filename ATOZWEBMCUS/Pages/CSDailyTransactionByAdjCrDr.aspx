<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSDailyTransactionByAdjCrDr.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSDailyTransactionByAdjCrDr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:Label ID="lblCalInterest" runat="server" Text="" Visible="false"></asp:Label>
</asp:Content>
