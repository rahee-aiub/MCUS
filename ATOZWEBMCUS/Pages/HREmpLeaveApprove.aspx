<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/HRMasterPage.Master" AutoEventWireup="true" CodeBehind="HREmpLeaveApprove.aspx.cs" Inherits="ATOZWEBMCUS.Pages.HREmpLeaveApprove" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <tr>
                <th colspan="4">
                    <p align="center" style="color: blue">
                        Approve Employee's Leave Application
                    </p>
                </th>
            </tr>
        </table>
    ...
    <div id="Div1" runat="server" align="center">
        <table>
            <tr>
                <td colspan="6" align="center">
                    <asp:Button ID="btnApproved" runat="server" Text="Approve" Font-Size="Large" ForeColor="#FFFFCC"
