...
{
    public partial class HRDeductionControlMaint : System.Web.UI.Page
    {
        ...
        {
            string sqlquery = "SELECT Code,DEscription from A2ZDEDUCTION WHERE Status !=2";
            ddlDeduction = DataAccessLayer.BLL.CommonManager.Instance.FillDropDownListWithSelect(sqlquery, ddlDeduction, "A2ZHRMCUS");
        }


        private void gvDetail()
        {
            string sqlquery3 = "SELECT Id,DedCode,BaseGrade,BaseGradeDesc,GradeCode,GradeDesc,DesignationCode,DesigDesc,LocationCode,LocationDesc,ServTypeCode,ServTypeDesc,ReligionCode,ReligionDesc,Amount,Status from A2ZDEDCTRLDTL WHERE DedCode = '" + ddlDeduction.SelectedValue + "'";
        ...
        protected void ddlDeduction_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (ddlDeduction.SelectedValue != "-Select-")
                {
                    ...
                    A2ZDEDCTRLDTO getDTO = (A2ZDEDCTRLDTO.GetInformation(MainCode));
                    if (getDTO.DedCode > 0)
                    {
                        ddlDeduction.SelectedValue = Converter.GetString(getDTO.DedCode);
            ...
            {
                Page.ClientScript.RegisterStartupScript(this.GetType(), "scriptkey", "<script>alert('System Error.ddlDeduction_SelectedIndexChanged Problem');</script>");
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                A2ZDEDCTRLDTO objDTO = new A2ZDEDCTRLDTO();

                A2ZDEDCTRLDTLDTO obj1DTO = new A2ZDEDCTRLDTLDTO();

                objDTO.DedCode = Converter.GetInteger(ddlDeduction.SelectedValue);
                objDTO.DedDesc = Converter.GetString(ddlDeduction.SelectedItem);
                obj1DTO.DedCode = Converter.GetInteger(ddlDeduction.SelectedValue);
                obj1DTO.DedDesc = Converter.GetString(ddlDeduction.SelectedItem);
                ...
                {
                    int roweffect = A2ZDEDCTRLDTO.InsertInformation(objDTO);
                    if (roweffect > 0)
                    {
                        lblRecFlag.Text = "1";
                        ChkLocation.Enabled = false;
                ...
                int roweffect1 = A2ZDEDCTRLDTLDTO.InsertInformation(obj1DTO);
                if (roweffect1 > 0)
                {
                    EnableInputSection();
                    VisableColumn();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                A2ZDEDCTRLDTLDTO objDTO = new A2ZDEDCTRLDTLDTO();
                ...
                int roweffect1 = A2ZDEDCTRLDTLDTO.UpdateInformation(objDTO);
                if (roweffect1 > 0)
                {
                    EnableInputSection();
                    VisableColumn();
        ...
        protected void ddlColumn2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND BaseGrade='" + ddlColumn1.SelectedValue + "' AND GradeCode='" + ddlColumn2.SelectedValue + "'";
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND DesignationCode='" + ddlColumn2.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
        ...
        protected void ddlColumn3_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND BaseGrade='" + ddlColumn1.SelectedValue + "' AND GradeCode='" + ddlColumn2.SelectedValue + "' AND LocationCode='" + ddlColumn3.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND DesignationCode='" + ddlColumn2.SelectedValue + "' AND LocationCode='" + ddlColumn3.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
        ...
        protected void ddlColumn4_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND BaseGrade='" + ddlColumn1.SelectedValue + "' AND GradeCode='" + ddlColumn2.SelectedValue + "' AND LocationCode='" + ddlColumn3.SelectedValue + "' AND ServTypeCode='" + ddlColumn4.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND DesignationCode='" + ddlColumn2.SelectedValue + "' AND LocationCode='" + ddlColumn3.SelectedValue + "' AND ServTypeCode='" + ddlColumn4.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND BaseGrade='" + ddlColumn1.SelectedValue + "' AND GradeCode='" + ddlColumn2.SelectedValue + "' AND ServTypeCode='" + ddlColumn4.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND DesignationCode='" + ddlColumn2.SelectedValue + "' AND ServTypeCode='" + ddlColumn4.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
        ...
        protected void ddlColumn5_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND BaseGrade='" + ddlColumn1.SelectedValue + "' AND GradeCode='" + ddlColumn2.SelectedValue + "' AND LocationCode='" + ddlColumn3.SelectedValue + "' AND ServTypeCode='" + ddlColumn4.SelectedValue + "' AND ReligionCode='" + ddlColumn5.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND DesignationCode='" + ddlColumn2.SelectedValue + "' AND LocationCode='" + ddlColumn3.SelectedValue + "' AND ServTypeCode='" + ddlColumn4.SelectedValue + "' AND ReligionCode='" + ddlColumn5.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND BaseGrade='" + ddlColumn1.SelectedValue + "' AND GradeCode='" + ddlColumn2.SelectedValue + "' AND LocationCode='" + ddlColumn3.SelectedValue + "' AND ReligionCode='" + ddlColumn5.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND DesignationCode='" + ddlColumn2.SelectedValue + "' AND LocationCode='" + ddlColumn3.SelectedValue + "' AND ReligionCode='" + ddlColumn5.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND BaseGrade='" + ddlColumn1.SelectedValue + "' AND GradeCode='" + ddlColumn2.SelectedValue + "' AND ReligionCode='" + ddlColumn5.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND DesignationCode='" + ddlColumn2.SelectedValue + "' AND ReligionCode='" + ddlColumn5.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND BaseGrade='" + ddlColumn1.SelectedValue + "' AND GradeCode='" + ddlColumn2.SelectedValue + "' AND ServTypeCode='" + ddlColumn4.SelectedValue + "' AND ReligionCode='" + ddlColumn5.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
                ...
                {
                    string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "' AND DesignationCode='" + ddlColumn2.SelectedValue + "' AND ServTypeCode='" + ddlColumn4.SelectedValue + "' AND ReligionCode='" + ddlColumn5.SelectedValue + "'";
                    DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
                    if (dt1.Rows.Count > 0)
                    {
                        DuplicateMSG();
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            string strQuery1 = "DELETE FROM A2ZDEDCTRLDTL WHERE Id='" + ID + "'";
            int status1 = Converter.GetSmallInteger(DataAccessLayer.BLL.CommonManager.Instance.ExecuteNonQuery(strQuery1, "A2ZHRMCUS"));

            string qry1 = "SELECT Id FROM A2ZDEDCTRLDTL WHERE DedCode='" + ddlDeduction.SelectedValue + "'";
            DataTable dt1 = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(qry1, "A2ZHRMCUS");
            if (dt1.Rows.Count == 0)
            {
                string qry2 = "DELETE FROM A2ZDEDCTRL WHERE DedCode='" + ddlDeduction.SelectedValue + "'";
