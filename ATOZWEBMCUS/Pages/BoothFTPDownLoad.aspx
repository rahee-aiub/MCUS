<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="BoothFTPDownLoad.aspx.cs" Inherits="ATOZWEBMCUS.Pages.BoothFTPDownLoad" %>
    ...
    <div align="center">
        <table class="style1">
            ...
            Height="22px" OnClick="BtnSearch_Click"/>
                 ...
                 <asp:checkboxlist runat="server" ID="chklist" BackColor="Silver" BorderColor="#CC0000" BorderStyle="Double" ForeColor="Black"  Width="496px" ></asp:checkboxlist>
                 
                  
           </div>
                     <asp:ListBox ID="listfile" runat="server" Width="274px" Visible="False"></asp:ListBox>
                <br />
        
          <div id="divmsg" runat="server" style="border-style: none; color: #0000FF; font-style: italic; font-weight: normal; font-size: x-large;">
        File Download Processing Status<br />
        ...
        <br />
        <div align="center">
        <asp:Button ID="Btndownload" runat="server" Text="Download" Font-Bold="True" Font-Size="Medium"
            ForeColor="White" CssClass="button green" 
            Height="25px" OnClick="Btndownload_Click"/>
