<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="SYSReligionCodeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.SYSReligionCodeMaintenance" Title="ReligionCodeMaintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Religion Code Maintenance
                    </th>
                </tr>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblcode" runat="server" Text="Religion Code:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    ...
                    <asp:DropDownList ID="ddlReligion" runat="server" Height="25px" Width="316px" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large"
 ...
 AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" RowStyle-Height="10px">
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Code" DataField="RelegionCode" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField HeaderText="Description" DataField="RelegionDescription"  HeaderStyle-Width="380px" ItemStyle-Width="380px"/>
