...
{
    public partial class CSBoothNomineeMaint : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                lblmemno.Text = memno;
                string acno = (string)Session["AccNo"];
                lblAccNo.Text = acno;
                string acctype = (string)Session["TypeCode"];
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
           ...
           // objDTO.NomineeNo = Converter.GetInteger(txtNo.Text);
            ...
            objDTO.UserId = Converter.GetInteger(hdnID.Value);
        ...
        protected void BtnUpdate_Click(object sender, EventArgs e)
        {
           ...
           // UpDTO.NomineeNo = Converter.GetInteger(txtNo.Text);
            ...
            UpDTO.UserId = Converter.GetInteger(hdnID.Value);
        ...
        protected void txtNomSharePer_TextChanged(object sender, EventArgs e)
        {
            ...
            if (c > 100)
            {
                  String csname1 = "PopupScript";
                        ...
                        if (!cs.IsStartupScriptRegistered(cstype, csname1))
                        {
                            String cstext1 = "alert('Share Percentage should not over 100%');";
                            cs.RegisterStartupScript(cstype, csname1, cstext1, true);
                            txtNomSharePer.Text = string.Empty;
        ...
        protected void InvalidUpdate ()
        {
      
            {
                ...
                if (!cs.IsStartupScriptRegistered(cstype, csname1))
                {
                    String cstext1 = "alert('Invalid Data Submit');";
                    cs.RegisterStartupScript(cstype, csname1, cstext1, true);
                    txtNomSharePer.Text = string.Empty;
                    txtNomSharePer.Focus();
