<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/GLMasterPage.Master" AutoEventWireup="true" CodeBehind="GLDailyTransaction.aspx.cs" Inherits="ATOZWEBMCUS.Pages.GLDailyTransaction" %>
        ...
        <table class="style1">
            ...
            <tr>
                ...
                <td style="background-color: #fce7f9">
                    ...
                    <asp:TextBox ID="txtVchNo" runat="server" CssClass="cls text" Width="140px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" Font-Size="Large"></asp:TextBox>--%>
                    
                    
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;

                    <asp:Label ID="lblHoldDr" runat="server" Text="Hold Debit:" Font-Size="Large"
                        ForeColor="Red"></asp:Label>&nbsp;
                ...
                <asp:Label ID="lblHoldCr" runat="server" Text="Hold Credit:" Font-Size="Large"
                    ForeColor="Red"></asp:Label>&nbsp;
            ...
            <tr>
                ...
                <td style="background-color: #fce7f9">
                    <asp:TextBox ID="txtContra" runat="server" CssClass="cls text" BorderColor="#1293D1" BorderStyle="Ridge" Width="95px"
                        Height="25px" Font-Size="Large" ToolTip="Enter Name" AutoPostBack="True" OnTextChanged="txtContra_TextChanged"></asp:TextBox>
            ...
            <tr>
                ...
                <td style="background-color: #fce7f9">
                    <asp:TextBox ID="txtTrnsactionCode" runat="server" CssClass="cls text" BorderColor="#1293D1" BorderStyle="Ridge" Width="94px"
                        Height="25px" Font-Size="Large" ToolTip="Enter Name" AutoPostBack="True" OnTextChanged="txtTrnsactionCode_TextChanged"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    &nbsp;<asp:TextBox ID="txtDescription" runat="server" CssClass="cls text" BorderColor="#1293D1" BorderStyle="Ridge" Width="375px"
                        Height="25px" Font-Size="Large" AutoPostBack="True" OnTextChanged="txtDescription_TextChanged"></asp:TextBox>&nbsp;
                </td>
            </tr>
            <tr>
                <td style="background-color: #fce7f9">
                ...
                <td style="background-color: #fce7f9">
                    &nbsp;<asp:TextBox ID="txtAmount" Style="text-align: right" runat="server" CssClass="cls text" BorderColor="#1293D1" BorderStyle="Ridge" Width="115px" Height="25px"
                        Font-Size="Large" onchange="javascript:this.value=Comma(this.value);" AutoPostBack="True" OnTextChanged="txtAmount_TextChanged"></asp:TextBox>
                </td>
            </tr>
