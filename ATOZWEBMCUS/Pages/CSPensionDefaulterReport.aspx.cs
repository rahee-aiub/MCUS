...
{
    public partial class CSPensionDefaulterReport : System.Web.UI.Page
    {
        ...
        {
            string sqlquery = "SELECT AccTypeCode,AccTypeDescription from A2ZACCTYPE Where AccTypeClass='4' AND AccTypeMode = '1'";
        ...
        protected void ProcessLoanDefaulter()
        {
            try
            {
                ...
                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("Sp_rptPensionDefaulter", prm, "A2ZCSMCUS"));
                if (result == 0)
                {
                    hdnMsg.Text = "1";
                }
        ...
        protected void gvPreview()
        {
            try
            {
                ...
                string sqlquery3 = "SELECT CuType,CuNo,CuNumber,MemNo,AccType,AccNo,MemName,DueNoDeposit,DueDepositAmt,AccOpenDate,AccMatureDate,AccMonthlyDeposit,AccPeriod,AccBalance FROM WFPENSIONDEFAULTER";
                gvPensionDefaulter = DataAccessLayer.BLL.CommonManager.Instance.FillGridViewList(sqlquery3, gvPensionDefaulter, "A2ZCSMCUS");
        ...
        protected void gvPensionDefaulter_RowDataBound(object sender, GridViewRowEventArgs e)
        {
        ...
        protected void BtnSelect_Click(object sender, EventArgs e)
        {
            ...
            Label ctype = (Label)gvPensionDefaulter.Rows[r.RowIndex].Cells[0].FindControl("lblCuType");
            Label cno = (Label)gvPensionDefaulter.Rows[r.RowIndex].Cells[1].FindControl("lblCuNo");
            Label cnumber = (Label)gvPensionDefaulter.Rows[r.RowIndex].Cells[2].FindControl("lblCuNumber");
            Label mmno = (Label)gvPensionDefaulter.Rows[r.RowIndex].Cells[3].FindControl("lblMemNo");
            Label actype = (Label)gvPensionDefaulter.Rows[r.RowIndex].Cells[4].FindControl("lblAccType");
            Label acno = (Label)gvPensionDefaulter.Rows[r.RowIndex].Cells[5].FindControl("lblAccNo");
            Label mmname = (Label)gvPensionDefaulter.Rows[r.RowIndex].Cells[6].FindControl("lblMemName");
          ...
          "click", @"<script>window.open('CSPensionDefaulterDetailReport.aspx','_blank');</script>", false);


            //Page.ClientScript.RegisterStartupScript(
            //this.GetType(), "OpenWindow", "window.open('CSPensionDefaulterDetailReport.aspx','_newtab');", true);
        ...
        protected void BtnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (hdnMsg.Text == "1")
                {
                    ...
                    SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.REPORT_FILE_NAME_KEY, "rptCSPensionDefaulterList");
