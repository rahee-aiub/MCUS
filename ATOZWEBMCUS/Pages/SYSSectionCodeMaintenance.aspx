<%@ Page Title="SectionCodeMaintenance" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="SYSSectionCodeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.SYSSectionCodeMaintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Section Code Maintenance
                    </th>
                </tr>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblcode" runat="server" Text="Section Code:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    ...
                    <asp:DropDownList ID="ddlSection" runat="server" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Width="316px" AutoPostBack="True"
                        Font-Size="Large" OnSelectedIndexChanged="ddlSection_SelectedIndexChanged">
 ...
 AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" RowStyle-Height="10px" OnRowDataBound="gvDetailInfo_RowDataBound">
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Code" DataField="SectionCode" HeaderStyle-Width="230px" ItemStyle-Width="230px" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField HeaderText="Description" DataField="SectionName"  HeaderStyle-Width="250px" ItemStyle-Width="250px"/>
