<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="CSEditMemberMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSEditMemberMaintenance"
    Title="Untitled Page" %>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtDateOfBirth" runat="server" CssClass="cls text" Width="140px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Height="25px" Font-Size="Large" AutoPostBack="True" OnTextChanged="txtDateOfBirth_TextChanged"></asp:TextBox>
