<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="SYSNationalityCodeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.SYSNationalityCodeMaintenance" Title="NationalityCodeMaintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Nationality Code Maintenance
                    </th>
                </tr>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblcode" runat="server" Text="Nationality Code:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    ...
                    <asp:DropDownList ID="ddlNationality" runat="server" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDescription" runat="server" CssClass="cls text" Width="316px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Height="25px" Font-Size="X-Large" MaxLength="50"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td></td>
 ...
 AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" RowStyle-Height="10px">
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Code" DataField="NationalityCode" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                <asp:BoundField HeaderText="Description" DataField="NationalityDescription" HeaderStyle-Width="380px" ItemStyle-Width="380px"/>
