<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/INVMasterPage.Master" AutoEventWireup="true" CodeBehind="STItemStockRequisitionReport.aspx.cs" Inherits="ATOZWEBMCUS.Pages.STItemStockRequisitionReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Item Stock Requisition Report
                    </th>
                </tr>
            </thead>
            ...
            <tr>
                ...
                <td>
                    &nbsp;<asp:TextBox ID="txtWareHouse" runat="server" CssClass="cls text" BorderColor="#1293D1" BorderStyle="Ridge"
                        Width="100px" Height="25px" Font-Size="Large" TabIndex="0" OnTextChanged="txtWareHouse_TextChanged"></asp:TextBox>

                    <asp:DropDownList ID="ddlWareHouse" runat="server" Height="25px" Width="347px" CssClass="cls text" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large">
                    </asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtReqNo" runat="server" CssClass="cls text" BorderColor="#1293D1" BorderStyle="Ridge"
                        Width="115px" Height="25px" Font-Size="Large" TabIndex="0"></asp:TextBox>
    ...
    <asp:Label ID="lblRecType" runat="server" Font-Size="Large" ForeColor="Red" Visible="false"></asp:Label>
    <asp:Label ID="lblSubHead" runat="server" Font-Size="Large" ForeColor="Red" Visible="false"></asp:Label>
