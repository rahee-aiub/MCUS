<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSInstantOpenMemberMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSInstantOpenMemberMaintenance" %>
...
<%--                    <asp:Label ID="lblCULBMemNo" runat="server" Text="Depositor No:" Font-Size="Large" ForeColor="Red"></asp:Label>--%>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtOpenDate" runat="server" CssClass="cls text" Width="140px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large" OnTextChanged="txtOpenDate_TextChanged" AutoPostBack="True"></asp:TextBox><img src="../Images/calender.png" />
                    &nbsp;&nbsp;
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="BtnSubmit" runat="server" Text="Submit" Font-Size="Large" ForeColor="White"
                        Font-Bold="True" CssClass="button green" Height="27px" Width="100px" OnClientClick="return ValidationBeforeSave()"
    ...
    <asp:Label ID="lblCrNo" runat="server" Text="" Visible="false"></asp:Label>
    ...
    <asp:Label ID="ProgCtrl" runat="server" Text="" Visible="false"></asp:Label>
