<%@ Page Language="C#" MasterPageFile="~/MasterPages/INVMasterPage.Master" AutoEventWireup="true" CodeBehind="STBalanceTakeOn.aspx.cs" Inherits="ATOZWEBMCUS.Pages.STBalanceTakeOn" Title="Stock Balance Take On" %>
  ...
  <br />
    ...
    <div align="center">
        <table class="style1">
            ...
            <tr>
                <td>
                    <asp:Label ID="Label3" runat="server" Text="Date:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="lblDate" runat="server" Text="" Font-Size="Large" ForeColor="Black"></asp:Label>
                </td>
            </tr>

             <tr>
                <td>
                    <asp:Label ID="Label2" runat="server" Text="Warehouse:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlWarehouse" runat="server" Height="30px" Width="316px" 
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlGroup" runat="server" Height="30px" Width="316px" 
                        Font-Size="Large"  BorderColor="#1293D1" BorderStyle="Ridge" AutoPostBack="True" OnSelectedIndexChanged="ddlGroup_SelectedIndexChanged">
                    </asp:DropDownList>
             ...
             <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="Category :" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlCategory" runat="server" Height="30px" Width="316px" 
                        Font-Size="Large"  BorderColor="#1293D1" BorderStyle="Ridge">
                        <%--<asp:ListItem Value="0">-Select-</asp:ListItem>--%>
                    </asp:DropDownList>
        ...
        <asp:GridView ID="gvDetails" runat="server" HeaderStyle-BackColor="YellowGreen"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Item Name" HeaderStyle-Width="250px" ItemStyle-Width="250px" ItemStyle-HorizontalAlign="left">
                 ...
                 <asp:TemplateField HeaderText="Balance" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="left">
                    <ItemTemplate>
                        <asp:TextBox ID="txtBalance" runat="server" Font-Bold="true" EnableViewState="true" Width="100px" Height="20" Style="text-align: right" ForeColor="Blue" onkeypress="return IsNumberKey(event)" onFocus="javascript:this.select();" Text='<%#Bind("STKUnitQty")%>'>
                        </asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Avg Cost" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="left">
                    <ItemTemplate>
                        <asp:TextBox ID="txtAvgCost"  runat="server" Font-Bold="true" EnableViewState="true" Width="100px" Height="20" Style="text-align: right" ForeColor="Blue" Text='<%#Bind("STKUnitAvgCost")%>'>
