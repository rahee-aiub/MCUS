...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div align="center">
        <table class="style1">
            ...
            <tr>
                ...
                <td style="background-color: #fce7f9">
                    <asp:Label ID="Label3" runat="server" Text="Misc. Code" Font-Size="Large"
                        ForeColor="Red"></asp:Label>
                </td>
    ...
    <div id="DivGridView" runat="server" align="center" class="grid1_scroll">
        <table class="style1">
            ...
            <tr>
                ...
                <td style="background-color: #fce7f9">
                    <asp:GridView ID="gv99Func" runat="server">
                        <Columns>
    ...
    <div align="center">
        <table class="style1">
            ...
            <tr>
                ...
                <td style="background-color: #fce7f9">
                    <asp:Label ID="lblCreditUnion" runat="server" Text=" Credit Union" Font-Size="Large" Width="180px"
                        ForeColor="Red"></asp:Label>
            ...
            <tr>
                ...
                <td colspan="2" style="background-color: #fce7f9">
                    <asp:Button ID="BtnView" runat="server" Text="Preview / Print" Font-Size="Large" ForeColor="White"
                        Font-Bold="True" CssClass="button green" Height="27px" Width="180px" OnClick="BtnView_Click" />&nbsp;
                                      &nbsp;
