<%@ Page Language="C#" MasterPageFile="~/MasterPages/INVMasterPage.Master" AutoEventWireup="true" CodeBehind="STIssSaleReport.aspx.cs" Inherits="ATOZWEBMCUS.Pages.STIssSaleReport" Title="Issue Sale Report" %>
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">
                        <asp:Label ID="lblRcvPurchaseReport" runat="server" Text="Issue Sale Report"></asp:Label>
                    </th>
                </tr>
