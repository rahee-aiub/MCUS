...
{
    public partial class GLMenuMasterPage : System.Web.UI.MasterPage
    {
        ...
        private void GetMenuData()
        {
            ...
            DataTable table = DataAccessLayer.BLL.CommonManager.Instance.GetDataTableByQuery(strQuery, "A2ZGLMCUS");
