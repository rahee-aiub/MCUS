<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/HRMasterPage.Master" AutoEventWireup="true" CodeBehind="HREmpLeaveMaint.aspx.cs" Inherits="ATOZWEBMCUS.Pages.HREmpLeaveMaint" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <tr>
                ...
                <td>
                     <asp:TextBox ID="txtStartDate" runat="server" CssClass="cls text" BorderColor="#1293D1" BorderStyle="Ridge"
                            Width="150px" Height="25px" Font-Size="Medium" AutoPostBack="True" OnTextChanged="txtStartDate_TextChanged" ></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    &nbsp;&nbsp;&nbsp;
                     <asp:TextBox ID="txtEndDate" runat="server" CssClass="cls text" BorderColor="#1293D1" BorderStyle="Ridge"
                            Width="150px" Height="25px" Font-Size="Medium" AutoPostBack="True" OnTextChanged="txtEndDate_TextChanged" ></asp:TextBox>
    ...
    <div align="center">
        <asp:Button ID="BtnSave" runat="server" Text="Save" Font-Bold="True" Font-Size="Medium"
            ...
            Height="22px" OnClick="BtnSave_Click" />&nbsp;
    ...
    <div align="center" class="grid_scroll">
        <asp:GridView ID="gvDetailInfo" runat="server" HeaderStyle-CssClass="FixedHeader" HeaderStyle-BackColor="YellowGreen"
            ...
            <Columns>             
                <asp:BoundField HeaderText="Start Date" DataField="LStartDate" DataFormatString="{0:dd/MM/yyyy}" HeaderStyle-Width="110px" ItemStyle-Width="110px" />
                <asp:BoundField HeaderText="End Date" DataField="LEndDate" DataFormatString="{0:dd/MM/yyyy}" HeaderStyle-Width="110px" ItemStyle-Width="110px" />
                ...
                <asp:BoundField HeaderText="Balance Days" DataField="LBalance" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="center" />
