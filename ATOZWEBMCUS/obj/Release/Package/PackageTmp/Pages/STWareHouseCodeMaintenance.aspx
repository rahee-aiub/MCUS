<%@ Page Language="C#" MasterPageFile="~/MasterPages/INVMasterPage.Master" AutoEventWireup="true" CodeBehind="STWareHouseCodeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.STWareHouseCodeMaintenance" Title="WareHouse Maintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <br />
    ...
    <div align="center">
        <table class="style1">
            ...
            <tr>
                <td>
                    <asp:Label ID="lblcode" runat="server" Text=" Warehouse Code:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlWase" runat="server" Height="25px" Width="316px" AutoPostBack="True"
                        Font-Size="Large"  BorderColor="#1293D1" BorderStyle="Ridge"
                        onselectedindexchanged="ddlWase_SelectedIndexChanged">
 ...
 AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" RowStyle-Height="10px" OnRowDataBound="gvDetailInfo_RowDataBound">
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Code" DataField="WaseCode" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField HeaderText="Description" DataField="WaseDescription" HeaderStyle-Width="380px" ItemStyle-Width="380px" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Center"/>
    ...
    <asp:Label ID="hdnWaseCode" runat="server" Text="" Visible="false"></asp:Label>
