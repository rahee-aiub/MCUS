<%@ Page Language="C#" MasterPageFile="~/MasterPages/INVMasterPage.Master" AutoEventWireup="true" CodeBehind="STRcvPurchaseReport.aspx.cs" Inherits="ATOZWEBMCUS.Pages.STRcvPurchaseReport" Title="Rcv Purchase Report" %>
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">
                        <asp:Label ID="lblRcvPurchaseReport" runat="server" Text="Rcv Purchase Report"></asp:Label>
                    </th>
                </tr>
            ...
            <tr>
                <td style="background-color: #fce7f9;">
                    <asp:CheckBox ID="chkSupplier" runat="server" Font-Size="Large" ForeColor="Red" Text="   All" Checked="True" AutoPostBack="True" OnCheckedChanged="chkSupplier_CheckedChanged" />
                </td>
                <td style="background-color: #fce7f9;">
                    <asp:Label ID="lblSupplier" runat="server" Text="Supplier:" Font-Size="Large"
                        ForeColor="Red"></asp:Label>
                </td>

                <td style="background-color: #fce7f9;">
                    <asp:DropDownList ID="ddlSupplier" runat="server" Font-Size="Large" Height="25px" Width="465px">
