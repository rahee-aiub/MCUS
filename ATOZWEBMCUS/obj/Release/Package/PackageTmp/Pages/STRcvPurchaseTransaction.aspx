<%@ Page Language="C#" MasterPageFile="~/MasterPages/INVMasterPage.Master" AutoEventWireup="true" CodeBehind="STRcvPurchaseTransaction.aspx.cs" Inherits="ATOZWEBMCUS.Pages.STRcvPurchaseTransaction" Title="Purchase Transaction" %>
            ...
            <table class="style1">
                <tr>
                    <td>
                        <h4>
                            &nbsp;&nbsp;
                            <asp:Label ID="Label8" runat="server" Text="Category" ForeColor="Red"></asp:Label></h4>
                    ...
                    <td>
                        <h4>
                            <asp:Label ID="Label10" runat="server" Text="Item Code" ForeColor="Red"></asp:Label></h4>
                        <asp:TextBox ID="txtItemCode" runat="server" Width="83px" Height="25px" Font-Size="Large"
                            CssClass="cls text" TabIndex="2" AutoPostBack="True" OnTextChanged="txtItemCode_TextChanged"></asp:TextBox>
                    </td>
                    <td>
                        <h4>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="Label11" runat="server" Text="Item Name" ForeColor="Red"></asp:Label></h4>
                    ...
                    <td>
                        <h4>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="Label12" runat="server" Text="Unit" ForeColor="Red"></asp:Label></h4>
                        <asp:DropDownList ID="ddlUnit" runat="server" Height="30px" BorderColor="#1293D1" BorderStyle="Ridge"
                            Width="96px" Font-Size="Large" Enabled="false">
                        </asp:DropDownList>
                    </td>
                    <td>
                        <h4>
                            &nbsp;
                            <asp:Label ID="Label13" runat="server" Text="Quantity" ForeColor="Red"></asp:Label></h4>
                    ...
                    <td>
                        <h4>
                            &nbsp;&nbsp;
                            <asp:Label ID="Label1" runat="server" Text="Unit Price" ForeColor="Red"></asp:Label></h4>
                        <asp:TextBox ID="txtUnitPrice" runat="server" Width="108px" Height="25px" Font-Size="Large" Style="text-align: right" onkeypress="return IsDecimalKey(event)"
                            CssClass="cls text" TabIndex="5" AutoPostBack="True" OnTextChanged="txtUnitPrice_TextChanged"></asp:TextBox>
                    </td>
                    <td>
                        <h4>
                            &nbsp;
                            <asp:Label ID="Label6" runat="server" Text="VAT Amt" ForeColor="Red"></asp:Label></h4>
                        <asp:TextBox ID="txtVatAmt" runat="server" Width="87px" Height="25px" Font-Size="Large" Style="text-align: right" onkeypress="return IsDecimalKey(event)"
                            CssClass="cls text" TabIndex="6" AutoPostBack="true" OnTextChanged="txtVatAmt_TextChanged"></asp:TextBox>
                    </td>
                    <td>
                        <h4>
                            &nbsp;
                            <asp:Label ID="Label18" runat="server" Text="TAX Amt" ForeColor="Red"></asp:Label></h4>
                        <asp:TextBox ID="txtTaxAmt" runat="server" Width="87px" Height="25px" Font-Size="Large" Style="text-align: right" onkeypress="return IsDecimalKey(event)"
                            CssClass="cls text" TabIndex="6" AutoPostBack="true" OnTextChanged="txtTaxAmt_TextChanged"></asp:TextBox>
                    </td>
                    <td>
                        <h4>
                            &nbsp;&nbsp;
                            <asp:Label ID="Label2" runat="server" Text="Total Price" ForeColor="Red"></asp:Label></h4>
                ...
                <asp:GridView ID="gvItemDetails" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ItemUnitPrice" DataFormatString="{0:0,0.00}" HeaderText="Unit Price">
                          ...
                          <asp:BoundField DataField="ItemVATAmt" DataFormatString="{0:0,0.00}" HeaderText="VAT">
                            <HeaderStyle Width="100px" />
                            <ItemStyle HorizontalAlign="Right" Width="125px" />
                        </asp:BoundField>
                          <asp:BoundField DataField="ItemTAXAmt" DataFormatString="{0:0,0.00}" HeaderText="TAX">
                            <HeaderStyle Width="100px" />
                            <ItemStyle HorizontalAlign="Right" Width="125px" />
                        </asp:BoundField>
