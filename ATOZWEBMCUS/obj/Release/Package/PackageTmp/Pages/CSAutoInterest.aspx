<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSAutoInterest.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSAutoInterest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Auto Interest Processing
                    </th>
                </tr>
            </thead>
            ...
            <tr>
                <td></td>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="***** Interest Rate ***** " Font-Size="Large" Width="115px" Height="25px"
                        ForeColor="Red"></asp:Label>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblMonth1" runat="server" Text=" " Font-Size="Large" Width="155px" Height="25px"
                        ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtMonth1" runat="server" CssClass="cls text" Style="text-align: right" Width="80px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" 
                        Font-Size="Medium" MaxLength ="6" onkeypress="return IsDecimalKey(event)"></asp:TextBox>

                    &nbsp;&nbsp;

                    <asp:Label ID="lblMonth4" runat="server" Text=" " Font-Size="Large" Width="155px" Height="25px"
                        ForeColor="Red"></asp:Label>
                    <asp:TextBox ID="txtMonth4" runat="server" CssClass="cls text" Style="text-align: right" Width="80px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Medium" MaxLength ="6" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblMonth2" runat="server" Text=" " Font-Size="Large" Width="155px" Height="25px"
                        ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtMonth2" runat="server" CssClass="cls text" Style="text-align: right" Width="80px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Medium" MaxLength ="6" onkeypress="return IsDecimalKey(event)"></asp:TextBox>

                    &nbsp;&nbsp;

                    <asp:Label ID="lblMonth5" runat="server" Text=" " Font-Size="Large" Width="155px" Height="25px"
                        ForeColor="Red"></asp:Label>
                    <asp:TextBox ID="txtMonth5" runat="server" CssClass="cls text" Style="text-align: right" Width="80px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Medium" MaxLength ="6" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblMonth3" runat="server" Text=" " Font-Size="Large" Width="155px" Height="25px"
                        ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtMonth3" runat="server" CssClass="cls text" Style="text-align: right" Width="80px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Medium" MaxLength ="6" onkeypress="return IsDecimalKey(event)"></asp:TextBox>

                    &nbsp;&nbsp;

                    <asp:Label ID="lblMonth6" runat="server" Text=" " Font-Size="Large" Width="155px" Height="25px"
                        ForeColor="Red"></asp:Label>
                    <asp:TextBox ID="txtMonth6" runat="server" CssClass="cls text" Style="text-align: right" Width="80px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Medium" MaxLength ="6" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
                </td>
            </tr>
            <tr>
     ...
     <%--<div id="Div1" class="grid_scroll" runat="server" align="center" style="height: 264px; overflow: auto; width: 100%;">
          ...
          <asp:GridView ID="gvDetailInfo1" runat="server" HeaderStyle-BackColor="YellowGreen"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Name" DataField="MemName"  HeaderStyle-Width="377px" ItemStyle-Width="350px"/>
                <asp:BoundField HeaderText="Open Dt." DataField="AccOpenDate" DataFormatString="{0:dd/MM/yyyy}" HeaderStyle-Width="102px" ItemStyle-Width="80px" />
                <asp:BoundField HeaderText="July" DataField="AmtJul" DataFormatString="{0:0,0.00}"  HeaderStyle-Width="130px" ItemStyle-Width="130px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right"/>
                <asp:BoundField HeaderText="August" DataField="AmtAug" DataFormatString="{0:0,0.00}" HeaderStyle-Width="130px" ItemStyle-Width="130px"  HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right"/>
                <asp:BoundField HeaderText="September" DataField="AmtSep" DataFormatString="{0:0,0.00}"  HeaderStyle-Width="120px" ItemStyle-Width="130px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right"/>
                <asp:BoundField HeaderText="October" DataField="AmtOct" DataFormatString="{0:0,0.00}"  HeaderStyle-Width="130px" ItemStyle-Width="130px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right"/>
                <asp:BoundField HeaderText="November" DataField="AmtNov" DataFormatString="{0:0,0.00}"  HeaderStyle-Width="120px" ItemStyle-Width="130px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right"/>
                <asp:BoundField HeaderText="December" DataField="AmtDec" DataFormatString="{0:0,0.00}"  HeaderStyle-Width="120px" ItemStyle-Width="130px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right"/>
        ...
        <asp:GridView ID="gvDetailInfo2" runat="server" HeaderStyle-BackColor="YellowGreen"
                AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" OnRowDataBound="gvDetailInfo2_RowDataBound">
                <RowStyle BackColor="#FFF7E7" ForeColor="#8C4510" />
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Name" DataField="MemName"  HeaderStyle-Width="377px" ItemStyle-Width="350px"/>
                <asp:BoundField HeaderText="Open Dt." DataField="AccOpenDate" DataFormatString="{0:dd/MM/yyyy}" HeaderStyle-Width="102px" ItemStyle-Width="80px" />
                <asp:BoundField HeaderText="January" DataField="AmtJan" DataFormatString="{0:0,0.00}"  HeaderStyle-Width="130px" ItemStyle-Width="130px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right"/>
                <asp:BoundField HeaderText="February" DataField="AmtFeb" DataFormatString="{0:0,0.00}" HeaderStyle-Width="130px" ItemStyle-Width="130px"  HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right"/>
                <asp:BoundField HeaderText="March" DataField="AmtMar" DataFormatString="{0:0,0.00}"  HeaderStyle-Width="120px" ItemStyle-Width="130px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right"/>
                <asp:BoundField HeaderText="April" DataField="AmtApr" DataFormatString="{0:0,0.00}"  HeaderStyle-Width="130px" ItemStyle-Width="130px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right"/>
                ...
                <asp:BoundField HeaderText="June" DataField="AmtJun" DataFormatString="{0:0,0.00}"  HeaderStyle-Width="120px" ItemStyle-Width="130px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right"/>
                <asp:BoundField HeaderText="Total Product" DataField="AmtProduct" DataFormatString="{0:0,0.00}"  HeaderStyle-Width="130px" ItemStyle-Width="130px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right"/>
                <asp:BoundField HeaderText="Net Interest" DataField="AmtInterest" DataFormatString="{0:0,0.00}"  HeaderStyle-Width="130px" ItemStyle-Width="130px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right"/>
         ...
         <asp:GridView ID="gvDetailInfo3" runat="server" HeaderStyle-BackColor="YellowGreen"
                AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" OnRowDataBound="gvDetailInfo3_RowDataBound">
                <RowStyle BackColor="#FFF7E7" ForeColor="#8C4510" />
    ...
    <asp:Label ID="lblVPrintFlag" runat="server" Font-Size="Large" ForeColor="Red" Visible="false"></asp:Label>
