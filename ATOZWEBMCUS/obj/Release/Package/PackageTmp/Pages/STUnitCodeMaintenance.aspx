<%@ Page Language="C#" MasterPageFile="~/MasterPages/INVMasterPage.Master" AutoEventWireup="true" CodeBehind="STUnitCodeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.STUnitCodeMaintenance" Title="Unit Code Maintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <br />
    ...
    <div align="center">
        <table class="style1">
            ...
            <tr>
                <td>
                    <asp:Label ID="lblcode" runat="server" Text="Unit Code:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlUnit" runat="server" Height="30px" Width="316px" AutoPostBack="True"
            ...
            <tr>
                <td>
                    <asp:Label ID="lblDescription" runat="server" Text="Unit Name:" Font-Size="Large"
 ...
 AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" RowStyle-Height="10px" OnRowDataBound="gvDetailInfo_RowDataBound">
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Code" DataField="UnitNo" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField HeaderText="Name" DataField="UnitDesc" HeaderStyle-Width="380px" ItemStyle-Width="380px" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="Center"/>
