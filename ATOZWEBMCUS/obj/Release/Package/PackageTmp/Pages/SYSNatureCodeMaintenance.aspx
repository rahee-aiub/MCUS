<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="SYSNatureCodeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.SYSNatureCodeMaintenance" Title="NatureCodeMaintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Nature Code Maintenance
                    </th>
                </tr>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblcode" runat="server" Text="Nature Code:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    ...
                    <asp:DropDownList ID="ddlNature" runat="server" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
 ...
 AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" RowStyle-Height="10px">
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Code" DataField="NatureCode" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField HeaderText="Description" DataField="NatureDescription"  HeaderStyle-Width="380px" ItemStyle-Width="380px"/>
