<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="GLYearEndTransaction.aspx.cs" Inherits="ATOZWEBMCUS.Pages.GLYearEndTransaction" %>
        ...
        <table class="style1">
            ...
            <tr>
                ...
                <td style="background-color: #fce7f9">
                    ...
                    <asp:TextBox ID="txtVchNo" runat="server" TabIndex="1" CssClass="cls text" Width="150px" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge" Font-Size="Large"></asp:TextBox>
        ...
        <div align="center" class="grid_scroll">
            <asp:GridView ID="gvDebitInfo" runat="server" HeaderStyle-CssClass="FixedHeader" HeaderStyle-BackColor="YellowGreen" RowStyle-Height="10px"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Trn Dr.Code" DataField="TrnGLAccNoDr" HeaderStyle-Width="166px" ItemStyle-Width="117px"></asp:BoundField>
 <%--                   <asp:BoundField HeaderText="Trn Cr.Code" DataField="TrnGLAccNoCr" HeaderStyle-Width="172px" ItemStyle-Width="120px"></asp:BoundField>--%>


                    <asp:TemplateField HeaderText="Trn Cr.Code" HeaderStyle-Width="172px" ItemStyle-Width="120px">
                        <ItemTemplate>
                            <asp:Label ID="lblGLAccCr" runat="server" Text='<%# Eval("TrnGLAccNoCr") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>



                    <asp:BoundField HeaderText="Description" DataField="TrnDesc" HeaderStyle-Width="620px" ItemStyle-Width="373px" ItemStyle-HorizontalAlign="left"></asp:BoundField>
                    <asp:BoundField HeaderText="Amount" DataField="GLAmount" DataFormatString="{0:0,0.00}" HeaderStyle-Width="300px" ItemStyle-Width="190px" ItemStyle-HorizontalAlign="Right"></asp:BoundField>

                    <asp:TemplateField HeaderText="TrnType" Visible="false" HeaderStyle-Width="90px" ItemStyle-Width="50px">
                        <ItemTemplate>
                    ...
                    <asp:ButtonField CommandName="Delete" Text="Delete" HeaderStyle-Width="90px" ItemStyle-Width="50px" />
    ...
    <asp:Label ID="GLCodeFlag" runat="server" Text="" Visible="false"></asp:Label>
