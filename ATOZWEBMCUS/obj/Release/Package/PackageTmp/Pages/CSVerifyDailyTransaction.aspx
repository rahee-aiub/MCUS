<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSVerifyDailyTransaction.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSVerifyDailyTransaction" %>
        ...
        <asp:GridView ID="gvCUInfo" runat="server" AutoGenerateColumns="False" EnableModelValidation="True" style="margin-top: 4px" Width="757px" >
         ...
         <asp:Button ID="BtnSelect" runat="server" Text="Select"  Width="68px" CssClass="button green" OnClick="BtnSelect_Click" OnClientClick="ShowPopup('CSViewDailyTransaction.aspx')" />
               ...
               <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Func" Visible="false">
            <ItemTemplate>
                 <asp:Label ID="lblFuncOpt" runat="server" Text='<%# Eval("FuncOpt") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
                
                <asp:TemplateField  HeaderText="Function">
               <ItemTemplate>
                    <asp:Label ID="lblFuncOptDesc" runat="server" Text='<%# Eval("FuncOptDesc") %>'></asp:Label>
               </ItemTemplate>
           </asp:TemplateField>
