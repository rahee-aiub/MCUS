<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="SYSLoanPurposeCodeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.SYSLoanPurposeCodeMaintenance" Title="LoanPurposeCodeMaintenance" %>
...
<br />
    ...
    <div align="center">
        <table class="style1">
            ...
            <tr>
                <td>
                    <asp:Label ID="lblcode" runat="server" Text="Loan Purpose Code:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    ...
                    <asp:DropDownList ID="ddlPurpose" runat="server" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
 ...
 AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" >
            ...
            <Columns>
                 <asp:BoundField HeaderText="Code" DataField="LPurposeCode" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField HeaderText="Description" DataField="LPurposeDescription" HeaderStyle-Width="380px" ItemStyle-Width="380px" />    
              </Columns>
