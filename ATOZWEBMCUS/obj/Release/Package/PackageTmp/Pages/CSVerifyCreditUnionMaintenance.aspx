<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSVerifyCreditUnionMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSVerifyCreditUnionMaintenance" %>
                ...
                <tr>
                    <th colspan="4">
                        <p align="center" style="color: blue">
                            Verify Credit Union Maintenance
                        </p>
                    </th>
                </tr>
            </table>
     ...
     <div id="DivGridViewCancle" runat="server" align="center" style="height: 245px; overflow: auto;
        ...
        <asp:GridView ID="gvCUInfo" runat="server" AutoGenerateColumns="False" EnableModelValidation="True" style="margin-top: 4px" Width="757px" >
           ...
           <asp:Button ID="BtnVerify" runat="server" Text="Verify" OnClick="BtnVerify_Click"  OnClientClick="return VerifyValidation()" Width="68px" CssClass="button green" />
                ...
                <asp:TemplateField HeaderText="Action">
            <ItemTemplate>
           <asp:Button ID="BtnReEdit" runat="server" Text="ReEdit" OnClick="BtnReEdit_Click"  OnClientClick="return ReEditValidation()" Width="68px" CssClass="button highlight" />
            </ItemTemplate>
        </asp:TemplateField>
