<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSGetDepositorNo.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSGetDepositorNo" %>
    ...
    <div align ="center">
           <table class="style1">
                        ...
                        <thead>
                            <tr>
                                <th colspan="3">
                                    <asp:Label ID="lblTransFunction" runat="server" Text="Search Depositor Information"></asp:Label>
                                </th>
                            </tr>
