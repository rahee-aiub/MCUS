<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="SYSProfessionCodeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.SYSProfessionCodeMaintenance" Title="ProfessionCodeMaintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Profession Code Maintenance
                    </th>
                </tr>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblcode" runat="server" Text="Profession Code:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    ...
                    <asp:DropDownList ID="ddlProfession" runat="server" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
 ...
 AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" RowStyle-Height="10px">
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Code" DataField="ProfessionCode" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                <asp:BoundField HeaderText="Description" DataField="ProfessionDescription"  HeaderStyle-Width="380px" ItemStyle-Width="380px"/>
