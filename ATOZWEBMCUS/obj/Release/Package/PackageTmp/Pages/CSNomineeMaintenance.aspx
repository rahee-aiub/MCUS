<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSNomineeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSNomineeMaintenance" Title="Untitled Page" %>
...
AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke"  RowStyle-Height="10px"
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="BtnExit" runat="server" Text="Exit" Font-Size="Large" ForeColor="#FFFFCC"
                         Font-Bold="True" CssClass="button red" OnClick="BtnExit_Click" />
                    <br />
                </td>
            </tr>
        </table>
    ...
    <asp:Label ID="ProgFlag" runat="server" Text="" Visible="false"></asp:Label>
