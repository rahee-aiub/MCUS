<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountDataConversion.aspx.cs" Inherits="ATOZWEBMCUS.Pages.AccountDataConversion" %>
            ...
            <table style="border-style: double; border-color: inherit; border-width: medium; height: 225px;">
                ...
                <tr>
                    <td>
                        ...
                        &nbsp;
                        <asp:Button ID="BtnSearch" runat="server" Text="Search" Font-Size="Large" ForeColor="White" Height="31px" Width="86px"
                Font-Bold="True" CssClass="button green" BackColor="#009933" OnClick="BtnSearch_Click" />
                        &nbsp;&nbsp;&nbsp;
                       <asp:Button ID="BtnDelete" runat="server" Text="Delete" Font-Size="Large" ForeColor="White" Height="31px" Width="86px"
                Font-Bold="True" CssClass="button green" BackColor="#009933" OnClick="BtnDelete_Click" />
 &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
