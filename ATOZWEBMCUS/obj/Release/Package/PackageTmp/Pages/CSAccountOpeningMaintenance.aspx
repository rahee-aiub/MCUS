<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="CSAccountOpeningMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSAccountOpeningMaintenance"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        <%--$(function () {
            $("#<%= txtMatrutiyDate.ClientID %>").datepicker();
    ...
    <div align="center">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtAccType" runat="server" Width="96px" Height="25px" CssClass="border_color"
                        Font-Size="Large" TabIndex="0" AutoPostBack="True" OnTextChanged="txtAccType_TextChanged" ></asp:TextBox>
                    ...
                    &nbsp;&nbsp;
                    <asp:Button ID="btnSearch" runat="server" Text="Search" Width="91px" Font-Size="Large"
            ForeColor="White" Height="31px" Font-Bold="True" TabIndex="0" CssClass="button green" OnClick="btnSearch_Click" />
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtCuNo" runat="server" CssClass="cls text" Width="99px" Height="25px"
                        Font-Size="Large" TabIndex="1" AutoPostBack="true" OnTextChanged="txtCuNo_TextChanged"></asp:TextBox>
                    ...
                    <asp:DropDownList ID="ddlCuNo" runat="server" Height="25px" Width="504px" AutoPostBack="True"
                        Font-Size="Large" TabIndex="1" OnSelectedIndexChanged="ddlCuNo_SelectedIndexChanged">
                        <asp:ListItem Value="0">-Select-</asp:ListItem>
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtMemberNo" runat="server" CssClass="cls text" Width="98px" Height="25px"
                        Font-Size="Large" TabIndex="2" AutoPostBack="true" OnTextChanged="txtMemberNo_TextChanged"></asp:TextBox>
                    ...
                    <asp:DropDownList ID="ddlMemberNo" runat="server" Height="25px" Width="504px" AutoPostBack="True"
                        Font-Size="Large" TabIndex="2" OnSelectedIndexChanged="ddlMemberNo_SelectedIndexChanged">
                        <asp:ListItem Value="0">-Select-</asp:ListItem>
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtOpenDate" runat="server" CssClass="cls text" Width="177px" Height="25px"
                        Font-Size="Large" img src="../Images/calender.png" TabIndex="3"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDepositAmount" runat="server" CssClass="cls text" Width="177px"
                        Height="25px" Font-Size="Large" TabIndex="4" onkeydown="return (event.keyCode !=13);" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtFixedDepositAmount" runat="server" CssClass="cls text" Width="177px"
                        Height="25px" Font-Size="Large" TabIndex="5" onkeydown="return (event.keyCode !=13);" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
            ...
            <tr>
                ...
                <td>             
                    <asp:TextBox ID="txtPeriod" runat="server" CssClass="cls text" Width="177px" Height="25px"
                        ...
                        AutoPostBack="True" TabIndex="6" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlWithdrawalAC" runat="server" Height="25px" Width="180px"
                        AutoPostBack="True" Font-Size="Large" TabIndex="7">
                        <asp:ListItem Value="0">-Select-</asp:ListItem>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtMatruityAmount" runat="server" CssClass="cls text" Width="177px"
                        Height="25px" Font-Size="Large" onkeydown="return (event.keyCode !=13);" TabIndex="10" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:DropDownList ID="ddlInterestWithdraw" runat="server" Height="25px" Width="180px"
                        AutoPostBack="True" Font-Size="Large" TabIndex="11">
                        <asp:ListItem Value="0">-Select-</asp:ListItem>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtFixedMthInt" runat="server" CssClass="cls text" Width="177px"
                        Height="25px" Font-Size="Large" onkeydown="return (event.keyCode !=13);" TabIndex="12" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:DropDownList ID="ddlAutoRenewal" runat="server" Height="25px" Width="180px"
                        AutoPostBack="True" Font-Size="Large" TabIndex="13">
                        <asp:ListItem Value="0">-Select-</asp:ListItem>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtLoanAmount" runat="server" CssClass="cls text" Width="177px"
                        ...
                        OnTextChanged="txtLoanAmount_TextChanged" TabIndex="14" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtNoOfInstallment" runat="server" CssClass="cls text" Width="177px"
                        Height="25px" Font-Size="Large" TabIndex="15" AutoPostBack="True" OnTextChanged="txtNoOfInstallment_TextChanged" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtLastInstallment" runat="server" CssClass="cls text" Width="177px"
                        Height="25px" Font-Size="Large" onkeydown="return (event.keyCode !=13);" TabIndex="17" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtInterestRate" runat="server" CssClass="cls text" Width="177px"
                        Height="25px" Font-Size="Large" TabIndex="18" onkeydown="return (event.keyCode !=13);" onkeypress="return IsDecimalKey(event)"></asp:TextBox>
        ...
        InitialValue="" ValidationGroup="Txtgroup" SetFocusOnError="True"></asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtContractInt" runat="server" CssClass="cls text" Width="177px" Visible="false"
                        Height="25px" Font-Size="Large" onkeydown="return (event.keyCode !=13);" TabIndex="19"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtGracePeriod" runat="server" CssClass="cls text" Width="177px"
                        Height="25px" Font-Size="Large" onkeydown="return (event.keyCode !=13);" TabIndex="20"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtLoaneeACType" runat="server" CssClass="cls text" Width="177px"
                        Height="25px" Font-Size="Large" onkeydown="return (event.keyCode !=13);" TabIndex="21"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtLoaneeMemberNo" runat="server" CssClass="cls text" Width="177px"
                        Height="25px" Font-Size="Large" onkeydown="return (event.keyCode !=13);" TabIndex="22"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtLoanPaymentSchdule" runat="server" CssClass="cls text" Width="177px"
                        Height="25px" Font-Size="Large" onkeydown="return (event.keyCode !=13);" TabIndex="23"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtCertificate" runat="server" CssClass="cls text" Width="428px"
                        Height="25px" Font-Size="Large" onkeydown="return (event.keyCode !=13);" TabIndex="24"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="txtCorrAccNo" runat="server" CssClass="cls text" Width="116px"
                        Height="25px" Font-Size="Large" TabIndex="25"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:DropDownList ID="ddlAutoTransferSaving" runat="server" Height="25px" Width="180px"
                        AutoPostBack="True" Font-Size="Large" TabIndex="26" OnSelectedIndexChanged="ddlAutoTransferSaving_SelectedIndexChanged">
                        <asp:ListItem Value="0">-Select-</asp:ListItem>
                        <asp:ListItem Value="1">Yes</asp:ListItem>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtOldAccNo" runat="server" onkeydown="return (event.keyCode !=13);" CssClass="cls text" Width="243px" Height="25px"
                        Font-Size="Large" TabIndex="27"></asp:TextBox>
                </td>
            </tr>
        </table>
    </div>
