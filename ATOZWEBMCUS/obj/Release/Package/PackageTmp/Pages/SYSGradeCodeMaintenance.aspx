<%@ Page Title="GradeCodeMaintenance" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="SYSGradeCodeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.SYSGradeCodeMaintenance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Grade Code Maintenance
                    </th>
                </tr>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblcode" runat="server" Text="Grade Code:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    ...
                    <asp:DropDownList ID="ddlGrade" runat="server" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Width="316px" AutoPostBack="True"
                        Font-Size="Large" OnSelectedIndexChanged="ddlGrade_SelectedIndexChanged">
 ...
 AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" RowStyle-Height="10px" OnRowDataBound="gvDetailInfo_RowDataBound">
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="Code" DataField="Grade" HeaderStyle-Width="230px" ItemStyle-Width="230px" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField HeaderText="Description" DataField="GradeDesc"  HeaderStyle-Width="250px" ItemStyle-Width="250px"/>
