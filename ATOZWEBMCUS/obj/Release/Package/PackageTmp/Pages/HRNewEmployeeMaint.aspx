<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/HRMasterPage.Master" AutoEventWireup="true" CodeBehind="HRNewEmployeeMaint.aspx.cs" Inherits="ATOZWEBMCUS.Pages.HRNewEmployeeMaint" %>
    ...
    <div align="left">
        ...
        <table style="border: groove">
            <tr>
                <%--<td></td>--%>
                <td>
                    <asp:Label ID="Label7" runat="server" Text="New Employee Master File Maintenance" Font-Size="Large" ForeColor="#336600" BorderColor="#FF99CC" Font-Bold="True" Font-Italic="True" Font-Underline="True"></asp:Label>
            ...
            <tr>
                <td class="auto-style9">
                    <table style="width: 546px">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtEmpID" runat="server" CssClass="cls text" Width="71px" Height="20px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Medium" ToolTip="Enter Code" MaxLength="4" onkeypress="return functionx(event)" AutoPostBack="True" OnTextChanged="txtEmpID_TextChanged"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtEmpName" runat="server" CssClass="cls text" Width="390px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Height="20px" Font-Size="Medium" ToolTip="Enter Name" MaxLength="48"></asp:TextBox>
                                &nbsp;
                            </td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblLastPromotionDt" runat="server" Text="Last Promotion Date:" Width="140px" Font-Size="Medium"
                                    ForeColor="Red"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Label ID="lblSteps" runat="server" Text="Steps:" Font-Size="Medium"
                                    ForeColor="Red"></asp:Label>
                                &nbsp;
                                <asp:TextBox ID="txtStep" runat="server" CssClass="cls text" Width="72px" Height="20px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Medium"></asp:TextBox>
                        ...
                        <tr>
                            <td>
                                <asp:Panel ID="pnlImage" runat="server" Height="223px" Width="242px">
                                    <asp:Image ID="ImgPicture" runat="server" Height="215px" ImageUrl="~/Images/index.jpg" Width="242px" Style="margin-top: 4px" /><br />
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtFName" runat="server" CssClass="cls text" Width="358px" Height="40px" BorderColor="#1293D1" BorderStyle="Ridge"
                                            Font-Size="Medium" MaxLength="33"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtMName" runat="server" CssClass="cls text" Width="358px" Height="40px" BorderColor="#1293D1" BorderStyle="Ridge"
                                            Font-Size="Medium" MaxLength="33"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtSpouseName" runat="server" CssClass="cls text" Width="358px" Height="40px" BorderColor="#1293D1" BorderStyle="Ridge"
                                            Font-Size="Medium" MaxLength="33"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNationalId" runat="server" CssClass="cls text" Width="358px" Height="20px" BorderColor="#1293D1" BorderStyle="Ridge"
                                            Font-Size="Medium" MaxLength="30"></asp:TextBox>
                                    </td>
                                </tr>
                        ...
                        <td>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtHeight" runat="server" BorderColor="#1293D1" BorderStyle="Ridge" CssClass="cls text" Font-Size="Medium" Height="20px" Width="138px" MaxLength="20"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTin" runat="server" BorderColor="#1293D1" BorderStyle="Ridge" CssClass="cls text" Font-Size="Medium" Height="20px" Width="138px" MaxLength="30"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPassportNo" runat="server" CssClass="cls text" Width="185px" BorderColor="#1293D1" BorderStyle="Ridge"
                                            Height="20px" Font-Size="Large" MaxLength="18"></asp:TextBox>&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                ...
                <table style="height: 187px">
                    <tr>
                        <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPreTelNo" runat="server" CssClass="cls text" Width="200px" Height="20px" BorderColor="#1293D1" BorderStyle="Ridge"
                                            Font-Size="Medium" MaxLength="18"></asp:TextBox>
                                        <asp:Label ID="Label1" runat="server" Font-Size="Medium" ForeColor="Red" Text="Division:"></asp:Label>
                                        <asp:DropDownList ID="ddlPreDivision" runat="server" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge" CssClass="cls text" Font-Size="Medium" Height="25px" Width="190px" OnSelectedIndexChanged="ddlPreDivision_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <asp:DropDownList ID="ddlPreUpzila" runat="server" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge" CssClass="cls text" Font-Size="Medium" Height="25px" Width="190px" OnSelectedIndexChanged="ddlPreUpzila_SelectedIndexChanged">
                            </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <asp:DropDownList ID="ddlPreThana" runat="server" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge" CssClass="cls text" Font-Size="Medium" Height="25px" Width="190px">
                            </asp:DropDownList>
                                    </td>
                                </tr>
                        ...
                        <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtEmail" runat="server" CssClass="cls text" Width="200px" Height="20px" BorderColor="#1293D1" BorderStyle="Ridge"
                                            Font-Size="Medium" MaxLength="18"></asp:TextBox>
                                        <asp:Label ID="Label6" runat="server" Font-Size="Medium" ForeColor="Red" Text="Upazila:"></asp:Label>&nbsp; &nbsp;
                            ...
                            <asp:DropDownList ID="ddlPerThana" runat="server" AutoPostBack="True" BorderColor="#1293D1" BorderStyle="Ridge" CssClass="cls text" Font-Size="Medium" Height="25px" Width="190px">
                            </asp:DropDownList>
                                    </td>
                                </tr>
