<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSAutoRenewal.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSAutoRenewal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Auto Renewal Processing
                    </th>
                </tr>
            </thead>
