<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="CSPensionDefaulterReport.aspx.cs" Inherits="ATOZWEBMCUS.Pages.CSPensionDefaulterReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Deposit Defaulter Report
                    </th>
                </tr>
            </thead>
    ...
    <div align="left" class="grid_scroll">
        <asp:GridView ID="gvPensionDefaulter" runat="server" HeaderStyle-CssClass="FixedHeader" HeaderStyle-BackColor="YellowGreen"
            AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" RowStyle-Height="10px" OnRowDataBound="gvPensionDefaulter_RowDataBound">
        ...
        <asp:TemplateField  HeaderText="Due No.Mth." HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center">
               <ItemTemplate>
                    <asp:Label ID="lblDueMonth" runat="server" Width="100px"  Text='<%#String.Format("{0:0,0.00}", Convert.ToDouble(Eval("DueNoDeposit"))) %>'></asp:Label>
               </ItemTemplate>
           </asp:TemplateField>

         <asp:TemplateField  HeaderText="Due Deposit Amt." HeaderStyle-Width="120px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right">
               <ItemTemplate>
                    <asp:Label ID="lblDueDeposit" runat="server" Width="120px"  Text='<%#String.Format("{0:0,0.00}", Convert.ToDouble(Eval("DueDepositAmt"))) %>'></asp:Label>
               </ItemTemplate>
           </asp:TemplateField>
              ...
              <asp:BoundField HeaderText="Mature Date" DataField="AccMatureDate" HeaderStyle-Width="95px" ItemStyle-Width="95px" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center" DataFormatString="{0:dd/MM/yyyy}"/>

                <asp:TemplateField  HeaderText="Deposit Amt." HeaderStyle-Width="120px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right">
               <ItemTemplate>
                    <asp:Label ID="lblDepositAmt" runat="server" Width="120px"  Text='<%#String.Format("{0:0,0.00}", Convert.ToDouble(Eval("AccMonthlyDeposit"))) %>'></asp:Label>
               </ItemTemplate>
           </asp:TemplateField>

           <asp:TemplateField  HeaderText="Period" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center">
               <ItemTemplate>
                    <asp:Label ID="lblPeriod" runat="server" Width="70px" Text='<%# Eval("AccPeriod") %>'></asp:Label>
               </ItemTemplate>
           </asp:TemplateField>

                <asp:TemplateField  HeaderText="Ledger Bal." HeaderStyle-Width="120px" HeaderStyle-HorizontalAlign="right" ItemStyle-HorizontalAlign="right">
               <ItemTemplate>
                    <asp:Label ID="lblLedgerBal" runat="server" Width="120px"  Text='<%#String.Format("{0:0,0.00}", Convert.ToDouble(Eval("AccBalance"))) %>'></asp:Label>
               </ItemTemplate>
           </asp:TemplateField>
