<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="SYSLoanSecurityCodeMaintenance.aspx.cs" Inherits="ATOZWEBMCUS.Pages.SYSLoanSecurityCodeMaintenance" Title="LoanSecurityCodeMaintenance" %>
...
<br />
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">
                  Loan Security Code Maintenance
                    </th>
                </tr>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblcode" runat="server" Text="Loan Security Code:" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    ...
                    <asp:DropDownList ID="ddlSecurity" runat="server" Height="25px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Width="316px" AutoPostBack="True"
                        Font-Size="Large" 
                        onselectedindexchanged="ddlSecurity_SelectedIndexChanged">
 ...
 AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke">
            ...
            <Columns>
                 <asp:BoundField HeaderText="Code" DataField="LSecurityCode" HeaderStyle-Width="100px" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"/>
                <asp:BoundField HeaderText="Description" DataField="LSecurityDescription" HeaderStyle-Width="380px" ItemStyle-Width="380px" />    
              </Columns>
