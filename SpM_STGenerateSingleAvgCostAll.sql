...
/****** Object:  StoredProcedure [dbo].[SpM_STGenerateSingleAvgCostAll]    Script Date: 06/27/2019 12:25:52 PM ******/
SET ANSI_NULLS ON
GO
...
---------- Credit Amount
		    ...
		    UPDATE A2ZSTMST SET A2ZSTMST.CalUnitCost = ((A2ZSTMST.STKUnitQty + A2ZSTMST.STKTPUnitQty) * round((A2ZSTMST.STKUnitAvgCost),2)) WHERE A2ZSTMST.STKUnitAvgCost > 0;;

			 --UPDATE A2ZSTMST SET A2ZSTMST.CalUnitCost = (A2ZSTMST.STKUnitQty * round((A2ZSTMST.STKUnitAvgCost),2)) WHERE A2ZSTMST.STKUnitAvgCost > 0;;
