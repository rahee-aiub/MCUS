...
/****** Object:  StoredProcedure [dbo].[Sp_STGenerateConsolidated]    Script Date: 06/27/2019 4:51:33 PM ******/
SET ANSI_NULLS ON
GO
...
---------------------------------------------------------------------------------------------------------------
	...
	UPDATE A2ZSTCONSOLIDATED SET A2ZSTCONSOLIDATED.STKOpUnitAmt = (STKOpUnitQty * Round((STKOpUnitRate),2))
...
---------- Rcv Unit Cost
			...
			--UPDATE A2ZSTCONSOLIDATED SET A2ZSTCONSOLIDATED.STKRcvUnitRate =  
   --         ISNULL((SELECT STKUnitAvgCost FROM A2ZSTMST
		 --   WHERE A2ZSTCONSOLIDATED.STKItemCode = A2ZSTMST.STKItemCode),0)
   --		    FROM A2ZSTMST,A2ZSTCONSOLIDATED
		 --   WHERE A2ZSTMST.STKItemCode = A2ZSTCONSOLIDATED.STKItemCode AND 
			--A2ZSTCONSOLIDATED.UserId = @UserId;
...
---------- Iss. Unit Cost
			...
			--UPDATE A2ZSTCONSOLIDATED SET A2ZSTCONSOLIDATED.STKIssUnitRate =  
   --         ISNULL((SELECT STKUnitAvgCost FROM A2ZSTMST
		 --   WHERE A2ZSTCONSOLIDATED.STKItemCode = A2ZSTMST.STKItemCode),0)
   --		    FROM A2ZSTMST,A2ZSTCONSOLIDATED
		 --   WHERE A2ZSTMST.STKItemCode = A2ZSTCONSOLIDATED.STKItemCode AND 
	...
	--UPDATE A2ZSTCONSOLIDATED SET A2ZSTCONSOLIDATED.STKCloUnitRate =  
 --   ISNULL((SELECT STKUnitAvgCost FROM A2ZSTMST
	--WHERE A2ZSTCONSOLIDATED.STKItemCode = A2ZSTMST.STKItemCode),0)
 --  	FROM A2ZSTMST,A2ZSTCONSOLIDATED
	--WHERE A2ZSTMST.STKItemCode = A2ZSTCONSOLIDATED.STKItemCode AND 
