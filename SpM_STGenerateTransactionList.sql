...
/****** Object:  StoredProcedure [dbo].[SpM_STGenerateTransactionList]    Script Date: 06/25/2018 9:13:43 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[SpM_STGenerateTransactionList] (@fDate VARCHAR(10),@tDate VARCHAR(10),
	...
	WHILE (@nCount <> 0)
		BEGIN
			 ...
			 SET @strSQL = 'INSERT INTO #WFA2ZSTTRANSACTION (TransactionDate,VchNo,VoucherNo,FuncOpt,FuncOptDesc,ItemGroupNo,ItemGroupDesc,ItemCategoryNo,ItemCategoryDesc,ItemCode,ItemName,ItemUnit,' +
				'ItemUnitDesc,ItemUnitPrice,ItemSellPrice,ItemPurchaseQty,ItemVATAmt,ItemTAXAmt,ItemNetCostPrice,ItemTotalPrice,TransactionType,TransactionTypeDesc,TrnBankCode,TrnBankName,TrnBankChqNo,TransactionNote,TrnAmtDr,TrnAmtCr,' +
